...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Dark Mode compatible for all pages except ones built with Elementor. You can add custom css to make them completely compatible with 2 css classes selectors: edumall-dark-scheme, edumall-light-scheme', 'edumall-child'),
	'section'  => $section,
	'priority' => $priority++,
	'default'  => 'light',
	'choices'  => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'       => esc_html__('Allow User\'s Site Skin', 'edumall-child'),
	'description' => esc_html__('Allows users to choose site skin by themselves in Dashboard Settings page.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => '0',
	'choices'     => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'     => esc_html__('Third Color', 'edumall-child'),
	'section'   => $section,
	'priority'  => $priority++,
	'transport' => 'auto',
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Controls the default color of all text.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'transport'   => 'auto',
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'     => esc_html__('Text Lighten Color', 'edumall-child'),
	'section'   => $section,
	'priority'  => $priority++,
	'transport' => 'auto',
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Controls the default color of all links.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'transport'   => 'auto',
	'choices'     => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Controls the color of heading.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'transport'   => 'auto',
...
Edumall_Kirki::add_field('theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '<div class="big_title">' . esc_html__('Button Color', 'edumall-child') . '</div>',
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '<div class="group_title">' . esc_html__('Button Default', 'edumall-child') . '</div>',
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '<div class="group_title">' . esc_html__('Button Flat', 'edumall-child') . '</div>',
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '<div class="group_title">' . esc_html__('Button Border', 'edumall-child') . '</div>',
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '<div class="big_title">' . esc_html__('Form Color', 'edumall-child') . '</div>',
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Controls the color of form inputs.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'transport'   => 'auto',
	'choices'     => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'       => esc_html__('Focus Color', 'edumall-child'),
	'description' => esc_html__('Controls the color of form inputs when focus.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'transport'   => 'auto',
	'choices'     => array(

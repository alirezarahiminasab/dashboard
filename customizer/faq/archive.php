...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Select header style that displays on faq archive pages.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Select sidebar 1 that will display on faq archive pages.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => 'faq_sidebar',
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Select sidebar 2 that will display on faq archive pages.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => 'none',
	'choices'     => $registered_sidebars,
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Controls the number of faqs display on faq archive page', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => 6,
	'choices'     => array(

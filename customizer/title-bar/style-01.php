...
Edumall_Kirki::add_field('theme', array(
	...
	'default'     => array(
		...
		'background-image'      => EDUMALL_THEME_IMAGE_URI . '/dark-scheme/title-bar-01-bg.jpg',
		'background-repeat'     => 'no-repeat',
		'background-size'       => 'cover',
		'background-attachment' => 'scroll',
		'background-position'   => 'center center',
	...
	'output'      => array(
		array(
			'element' => '.edumall-dark-scheme .page-title-bar-01 .page-title-bar-bg',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'    => array(
		array(
			'element'  => '.edumall-dark-scheme .page-title-bar-01 .page-title-bar-inner .heading',
			'property' => 'color',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.edumall-dark-scheme .page-title-bar-01 .insight_core_breadcrumb li',
			'property' => 'color',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'normal',
			'element'  => '.edumall-dark-scheme .page-title-bar-01 .insight_core_breadcrumb a',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
			'element'  => '.edumall-dark-scheme .page-title-bar-01 .insight_core_breadcrumb a:hover',
			'property' => 'color',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.edumall-dark-scheme .page-title-bar-01 .insight_core_breadcrumb li + li:before',
			'property' => 'color',
		),
	),
));

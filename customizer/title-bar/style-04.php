...
Edumall_Kirki::add_field('theme', array(
	...
	'priority'        => $priority++,
	'default'         => array(
		'background-color'      => Edumall::THIRD_COLOR,
		'background-image'      => '',
	...
	'output'          => array(
		array(
			'element' => '.page-title-bar-04 .page-title-bar-bg',
		),
	),
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.page-title-bar-04 .page-title-bar-bg:before',
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.page-title-bar-04 .insight_core_breadcrumb li + li:before',
			'property' => 'color',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'element' => '.edumall-dark-scheme .page-title-bar-04 .page-title-bar-bg',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.edumall-dark-scheme .page-title-bar-04 .insight_core_breadcrumb li',
			'property' => 'color',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'normal',
			'element'  => '.edumall-dark-scheme .page-title-bar-04 .insight_core_breadcrumb a',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
			'element'  => '.edumall-dark-scheme .page-title-bar-04 .insight_core_breadcrumb a:hover',
			'property' => 'color',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.edumall-dark-scheme .page-title-bar-04 .insight_core_breadcrumb li + li:before',
			'property' => 'color',
		),
	),
));

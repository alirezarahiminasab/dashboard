...
Edumall_Kirki::add_field('theme', array(
	...
	'default'  => 'normal',
	'choices'  => array(
		'normal'   => esc_html__('Normal', 'edumall-child'),
...
Edumall_Kirki::add_field('theme', array(
	...
	'description'     => esc_html__('Controls the background of title bar.', 'edumall-child'),
	'section'         => $section,
	'priority'        => $priority++,
	'default'         => array(
		'background-color'      => '#F8F8F8',
		'background-image'      => EDUMALL_THEME_IMAGE_URI . '/title-bar-08-bg.png',
	...
	'output'          => array(
		array(
			'element' => '.page-title-bar-08 .page-title-bar-bg',
		),
	),
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'       => esc_html__('Background Overlay Color', 'edumall-child'),
	'description' => esc_html__('Controls the background overlay color of title bar.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'transport'   => 'auto',
	'output'      => array(
		array(
			'element'  => '.page-title-bar-08 .page-title-bar-bg:before',
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Controls the border bottom color of the page title bar.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'transport'   => 'auto',
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'     => esc_html__('Margin Bottom', 'edumall-child'),
	'section'   => $section,
	'priority'  => $priority++,
	'transport' => 'auto',
	'choices'   => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '<div class="big_title">' . esc_html__('Heading', 'edumall-child') . '</div>',
));

Edumall_Kirki::add_field('theme', array(
	'type'        => 'kirki_typography',
	'settings'    => $prefix . 'heading_typography',
	'label'       => esc_html__('Font Family', 'edumall-child'),
	'description' => esc_html__('Controls the font family for the page title heading.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'transport'   => 'auto',
	'default'     => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '<div class="big_title">' . esc_html__('Breadcrumb', 'edumall-child') . '</div>',
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Controls the typography for the breadcrumb text.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'transport'   => 'auto',
	'default'     => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Controls the color of text on breadcrumb.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'transport'   => 'auto',
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Controls the color of links on breadcrumb.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'transport'   => 'auto',
	'choices'     => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'       => esc_html__('Separator Color', 'edumall-child'),
	'description' => esc_html__('Controls the color of separator on breadcrumb.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
...
Edumall_Kirki::add_field('theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '<div class="big_title">' . esc_html__('Responsive Options', 'edumall-child') . '</div>',
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '<div class="group_title">' . esc_html__('Medium Device', 'edumall-child') . '</div>',
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'     => esc_html__('Heading Font Size', 'edumall-child'),
	'section'   => $section,
	'priority'  => $priority++,
	'default'   => 34,
	'transport' => 'auto',
...
Edumall_Kirki::add_field('theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '<div class="group_title">' . esc_html__('Small Device', 'edumall-child') . '</div>',
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '<div class="group_title">' . esc_html__('Extra Small Device', 'edumall-child') . '</div>',
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'element' => '.edumall-dark-scheme .page-title-bar-08 .page-title-bar-bg',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'     => esc_html__('Heading Color', 'edumall-child'),
	'section'   => $section,
	'priority'  => $priority++,
	'transport' => 'auto',
	'default'   => '#fff',
	'output'    => array(
		array(
			'element'  => '.edumall-dark-scheme .page-title-bar-08 .page-title-bar-inner .heading',
			'property' => 'color',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.edumall-dark-scheme .page-title-bar-08 .insight_core_breadcrumb li',
			'property' => 'color',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'normal',
			'element'  => '.edumall-dark-scheme .page-title-bar-08 .insight_core_breadcrumb a',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
			'element'  => '.edumall-dark-scheme .page-title-bar-08 .insight_core_breadcrumb a:hover',
			'property' => 'color',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.edumall-dark-scheme .page-title-bar-08 .insight_core_breadcrumb li + li:before',
			'property' => 'color',
		),
	),
));

...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'element' => '.page-title-bar-02 .insight_core_breadcrumb li, .page-title-bar-02 .insight_core_breadcrumb li a',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'priority'    => $priority++,
	'transport'   => 'auto',
	'default'     => Edumall::HEADING_SECONDARY_COLOR,
	'output'      => array(
		array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'default'     => array(
		'normal' => Edumall::TEXT_LIGHTEN_COLOR,
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'element' => '.edumall-dark-scheme .page-title-bar-02 .page-title-bar-bg',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'    => array(
		array(
			'element'  => '.edumall-dark-scheme .page-title-bar-02 .page-title-bar-inner .heading',
			'property' => 'color',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.edumall-dark-scheme .page-title-bar-02 .insight_core_breadcrumb li',
			'property' => 'color',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'normal',
			'element'  => '.edumall-dark-scheme .page-title-bar-02 .insight_core_breadcrumb a',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
			'element'  => '.edumall-dark-scheme .page-title-bar-02 .insight_core_breadcrumb a:hover',
			'property' => 'color',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.edumall-dark-scheme .page-title-bar-02 .insight_core_breadcrumb li + li:before',
			'property' => 'color',
		),
	),
));

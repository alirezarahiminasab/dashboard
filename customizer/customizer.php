...
Edumall_Kirki::add_section('layout', array(
	'title'    => esc_html__('Site Layout & Background', 'edumall-child'),
	'priority' => 10,
));

Edumall_Kirki::add_section('color_', array(
	'title'    => esc_html__('Colors', 'edumall-child'),
	'priority' => 20,
));

Edumall_Kirki::add_section('typography', array(
	'title'    => esc_html__('Typography', 'edumall-child'),
	'priority' => 20,
));

Edumall_Kirki::add_panel('top_bar', array(
	'title'    => esc_html__('Top bar', 'edumall-child'),
	'priority' => 30,
));
...
Edumall_Kirki::add_section('logo', array(
	'title'       => esc_html__('Logo', 'edumall-child'),
	'description' => '<div class="desc">
			<strong class="insight-label insight-label-info">' . esc_html__('IMPORTANT NOTE: ', 'edumall-child') . '</strong>
			<p>' . esc_html__('These settings can be overridden by settings from Page Options Box in separator page.', 'edumall-child') . '</p>
			<p><img src="' . esc_url(EDUMALL_THEME_IMAGE_URI . '/customize/logo-settings.jpg') . '" alt="' . esc_attr__('logo-settings', 'edumall-child') . '"/></p>
		</div>',
	'priority'    => 50,
));

Edumall_Kirki::add_panel('navigation', array(
	'title'    => esc_html__('Navigation', 'edumall-child'),
	'priority' => 60,
));

Edumall_Kirki::add_panel('title_bar', array(
	'title'    => esc_html__('Page Title Bar & Breadcrumb', 'edumall-child'),
	'priority' => 60,
));
...
Edumall_Kirki::add_panel('shop', array(
	'title'    => esc_html__('Shop', 'edumall-child'),
	'priority' => 160,
));

Edumall_Kirki::add_section('contact_info', array(
	'title'    => esc_html__('Contact Info', 'edumall-child'),
	'priority' => 170,
));

Edumall_Kirki::add_section('socials', array(
	'title'    => esc_html__('Social Networks', 'edumall-child'),
	'priority' => 180,
));

Edumall_Kirki::add_section('social_sharing', array(
	'title'    => esc_html__('Social Sharing', 'edumall-child'),
	'priority' => 190,
));

Edumall_Kirki::add_panel('search', array(
	'title'    => esc_html__('Search & Popup Search', 'edumall-child'),
	'priority' => 200,
));

Edumall_Kirki::add_section('error404_page', array(
	'title'    => esc_html__('Error 404 Page', 'edumall-child'),
	'priority' => 210,
));

Edumall_Kirki::add_panel('shortcode', array(
	'title'    => esc_html__('Shortcodes', 'edumall-child'),
	'priority' => 220,
));

Edumall_Kirki::add_section('pre_loader', array(
	'title'    => esc_html__('Pre Loader', 'edumall-child'),
	'priority' => 230,
));
...
Edumall_Kirki::add_section('login', array(
	'title'    => esc_html__('Login', 'edumall-child'),
	'priority' => 250,
));

Edumall_Kirki::add_section('notices', array(
	'title'    => esc_html__('Notices', 'edumall-child'),
	'priority' => 250,
));

Edumall_Kirki::add_section('settings_preset', array(
	'title'    => esc_html__('Preset', 'edumall-child'),
	'priority' => 260,
));

Edumall_Kirki::add_section('performance', array(
	'title'    => esc_html__('Performance', 'edumall-child'),
	'priority' => 270,
));

Edumall_Kirki::add_section('custom_js', array(
	'title'    => esc_html__('Additional JS', 'edumall-child'),
	'priority' => 280,
));
...
require_once EDUMALL_CUSTOMIZER_DIR . '/header/category.php';
...
require_once EDUMALL_CUSTOMIZER_DIR . '/section-login.php';

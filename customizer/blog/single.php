...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Select default header style that displays on all single blog post pages.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => '',
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Select default Title Bar that displays on all single blog post pages.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Enter text that displays on single blog posts. Leave blank to use post title.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => esc_html__('Blog', 'edumall-child'),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Select sidebar 1 that will display on single blog post pages.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Select sidebar 2 that will display on single blog post pages.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => 'none',
	'choices'     => $registered_sidebars,
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'    => esc_html__('Post Layout Preset', 'edumall-child'),
	'section'  => $section,
	'default'  => '-1',
	'priority' => $priority++,
	'multiple' => 0,
	'choices'  => array(
		...
		'left-sidebar'  => array(
			'label'    => esc_html__('Left Sidebar', 'edumall-child'),
			'settings' => array(
		...
		'right-sidebar' => array(
			'label'    => esc_html__('Right Sidebar', 'edumall-child'),
			'settings' => array(
				'post_page_sidebar_1'        => 'blog_sidebar',
		...
		'no-sidebar'    => array(
			'label'    => esc_html__('No Sidebar', 'edumall-child'),
			'settings' => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'    => esc_html__('Featured Image', 'edumall-child'),
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '1',
	'choices'  => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'    => esc_html__('Post Title', 'edumall-child'),
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '1',
	'choices'  => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'    => esc_html__('Post Meta Date', 'edumall-child'),
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '1',
	'choices'  => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'    => esc_html__('View Count', 'edumall-child'),
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '1',
	'choices'  => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'    => esc_html__('Comment Count', 'edumall-child'),
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '1',
	'choices'  => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'    => esc_html__('Author Meta', 'edumall-child'),
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '1',
	'choices'  => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'    => esc_html__('Author Info Box', 'edumall-child'),
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '1',
	'choices'  => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'    => esc_html__('Related Posts', 'edumall-child'),
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '1',
	'choices'  => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'           => esc_html__('Number of related posts item', 'edumall-child'),
	'section'         => $section,
	'priority'        => $priority++,
	'default'         => 5,
	'choices'         => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'    => esc_html__('Comments List/Form', 'edumall-child'),
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '1',
	'choices'  => array(

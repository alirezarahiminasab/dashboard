...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Controls the typography for all dropdown menu items.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'transport'   => 'auto',
	'default'     => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Controls the font size for dropdown menu items.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => 13,
	'transport'   => 'auto',
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Controls the background color for dropdown menu', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'transport'   => 'auto',
	'default'     => '#fff',
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Input valid box-shadow for dropdown menu. For e.g: "0 0 37px rgba(0, 0, 0, .07)"', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'       => esc_html__('Hover Background', 'edumall-child'),
	'description' => esc_html__('Controls the background color when hover for dropdown menu items.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'transport'   => 'auto',
	'output'      => array(
...
Edumall_Kirki::add_field('theme', array(
	'type'        => 'color-alpha',
	'settings'    => $prefix . 'dark_dropdown_bg_color',
	'label'       => esc_html__('Background', 'edumall-child'),
	'description' => esc_html__('Controls the background color for dropdown menu', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	...
	'output'      => array(
		array(
			'element'  => array(
				...
				'.edumall-dark-scheme .primary-menu-sub-visual',
			),
			'property' => 'background-color',
		),
	),
...
Edumall_Kirki::add_field('theme', array(
	'type'        => 'text',
	'settings'    => $prefix . 'dark_dropdown_box_shadow',
	'label'       => esc_html__('Box Shadow', 'edumall-child'),
	'description' => esc_html__('Input valid box-shadow for dropdown menu. For e.g: "0 0 37px rgba(0, 0, 0, .07)"', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
...
Edumall_Kirki::add_field('theme', array(
	'type'        => 'multicolor',
	'settings'    => $prefix . 'dark_dropdown_link_color',
	'label'       => esc_html__('Link Color', 'edumall-child'),
	'description' => esc_html__('Controls the color for dropdown menu items.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	...
	'output'      => array(
		array(
			'choice'   => 'normal',
			'element'  => '.edumall-dark-scheme .page-navigation .children > li > a',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
...
Edumall_Kirki::add_field('theme', array(
	'type'        => 'color-alpha',
	'settings'    => $prefix . 'dark_dropdown_link_hover_bg_color',
	'label'       => esc_html__('Hover Background', 'edumall-child'),
	'description' => esc_html__('Controls the background color when hover for dropdown menu items.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,

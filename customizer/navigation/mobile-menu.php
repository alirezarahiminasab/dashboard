...
Edumall_Kirki::add_field('theme', array(
	...
	'label'       => esc_html__('Breakpoint', 'edumall-child'),
	'description' => esc_html__('Controls the breakpoint of the mobile menu.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'     => esc_html__('Opened Effect', 'edumall-child'),
	'section'   => $section,
	'priority'  => $priority++,
	'transport' => 'postMessage',
	'default'   => EDUMALL_IS_RTL ? 'push-to-right' : 'push-to-left',
	'choices'   => array(
		'slide-to-right' => esc_html__('Slide To Right', 'edumall-child'),
		'slide-to-left'  => esc_html__('Slide To Left', 'edumall-child'),
		'push-to-right'  => esc_html__('Push To Right', 'edumall-child'),
		'push-to-left'   => esc_html__('Push To Left', 'edumall-child'),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'       => esc_html__('Header Background Color', 'edumall-child'),
	'description' => esc_html__('Controls the background color of the mobile menu header.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => '#fff',
	'output'      => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'default'  => 'solid',
	'choices'  => array(
		'solid'    => esc_html__('Classic', 'edumall-child'),
...
Edumall_Kirki::add_field('theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '<div class="big_title">' . esc_html__('Level 1', 'edumall-child') . '</div>',
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Controls the typography for mobile menu items.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'transport'   => 'auto',
	'default'     => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'     => esc_html__('Divider Color', 'edumall-child'),
	'section'   => $section,
	'priority'  => $priority++,
	'transport' => 'auto',
...
Edumall_Kirki::add_field('theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '<div class="big_title">' . esc_html__('Sub Items', 'edumall-child') . '</div>',
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'       => esc_html__('Typography', 'edumall-child'),
	'description' => esc_html__('Controls the typography for mobile menu sub items.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'transport'   => 'auto',
	'default'     => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '<div class="big_title">' . esc_html__('Toggle Button', 'edumall-child') . '</div>',
));

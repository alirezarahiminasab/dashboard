...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-dark .top-bar-01',
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'normal',
			'element'  => '.header-dark .top-bar-01 a',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
			'element'  => '.header-dark .top-bar-01 a:hover, .top-bar-01 a:focus',
			'property' => 'color',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'    => array(
		array(
			'choice'   => 'normal',
			'element'  => '.header-dark .top-bar-01 .info-list .info-icon',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
			'element'  => '.header-dark .top-bar-01 .info-list .info-link:hover .info-icon',
			'property' => 'color',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-light:not(.headroom--not-top) .top-bar-01',
			'property' => 'background-color',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'normal',
			'element'  => '.header-light:not(.headroom--not-top) .top-bar-01 a',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'    => array(
		array(
			'choice'   => 'normal',
			'element'  => '.header-light:not(.headroom--not-top) .top-bar-01 .info-list .info-icon',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
			'element'  => '.header-light:not(.headroom--not-top) .top-bar-01 .info-list .info-link:hover .info-icon',
			'property' => 'color',
		),
	),
));

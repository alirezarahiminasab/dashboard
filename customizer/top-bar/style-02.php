...
Edumall_Kirki::add_field('theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => wp_kses(__('Keep learning with free resources during <span class="font-500">COVID-19.</span> <a href="#" class="link-transition-01 display-inline-block secondary-color-important">Learn more</a>', 'edumall-child'), [
		'a'    => [
			'class' => [],
			'href'  => [],
		],

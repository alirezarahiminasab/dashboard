...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'element' => '.header-08 .menu--primary > ul > li > a',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'   => array(
		array(
			'element' => '.header-08.header-dark .page-header-inner',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		...
		array(
			'choice'   => 'hover',
			'element'  => '.header-08.header-dark .header-icon:hover',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
			'element'  => '.header-08.header-dark .wpml-ls-slot-shortcode_actions:hover > .js-wpml-ls-item-toggle',
			'property' => 'color',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'color',
			'element'  => '.header-08.header-dark .header-icon .badge, .header-08.header-dark .mini-cart .mini-cart-icon:after',
			'property' => 'color',
		),
		array(
			'choice'   => 'background',
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'normal',
			'element'  => '.header-08.header-dark .menu--primary > ul > li > a',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'          => Edumall_Header::instance()->get_search_form_kirki_output('08', 'dark', false),
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'          => Edumall_Header::instance()->get_search_form_kirki_output('08', 'dark', true),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'search_enable',
			'operator' => '==',
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'          => Edumall_Header::instance()->get_button_kirki_output('08', 'dark', false),
	'active_callback' => array(
		array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'          => Edumall_Header::instance()->get_button_kirki_output('08', 'dark', true),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'dark_button_color',
			'operator' => '==',
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'    => array(
		array(
			'choice'   => 'normal',
			'element'  => '.header-08.header-dark .header-social-networks a',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
			'element'  => '.header-08.header-dark .header-social-networks a:hover',
			'property' => 'color',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-08.header-light .page-header-inner',
			'property' => 'border-color',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		...
		array(
			'choice'   => 'hover',
			'element'  => '.header-08.header-light .header-icon:hover',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
			'element'  => '.header-08.header-light .wpml-ls-slot-shortcode_actions:hover > .js-wpml-ls-item-toggle',
			'property' => 'color',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'color',
			'element'  => '.header-08.header-light .header-icon .badge, .header-08.header-light .mini-cart .mini-cart-icon:after',
			'property' => 'color',
		),
		array(
			'choice'   => 'background',
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'normal',
			'element'  => '.header-08.header-light .menu--primary > ul > li > a',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'          => Edumall_Header::instance()->get_button_kirki_output('08', 'light', false),
	'active_callback' => array(
		array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'          => Edumall_Header::instance()->get_button_kirki_output('08', 'light', true),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'light_button_color',
			'operator' => '==',
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'    => array(
		array(
			'choice'   => 'normal',
			'element'  => '.header-08.header-light .header-social-networks a',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
			'element'  => '.header-08.header-light .header-social-networks a:hover',
			'property' => 'color',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'   => array(
		array(
			'element' => '.edumall-dark-scheme .header-08.header-dark .page-header-inner',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			...
			.edumall-dark-scheme .header-08.header-dark .wpml-ls-item-toggle',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
			'element'  => '.edumall-dark-scheme .header-08.header-dark .header-icon:hover',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
			'element'  => '.edumall-dark-scheme .header-08.header-dark .wpml-ls-slot-shortcode_actions:hover > .js-wpml-ls-item-toggle',
			'property' => 'color',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'color',
			'element'  => '.edumall-dark-scheme .header-08.header-dark .header-icon .badge, .edumall-dark-scheme .header-08.header-dark .mini-cart .mini-cart-icon:after',
			'property' => 'color',
		),
		array(
			'choice'   => 'background',
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'normal',
			'element'  => '.edumall-dark-scheme .header-08.header-dark .menu--primary > ul > li > a',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
            ...
            .edumall-dark-scheme .header-08.header-dark .menu--primary > ul > .current-menu-item > a',
			'property' => 'color',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'          => Edumall_Header::instance()->get_search_form_kirki_output('08', 'dark', false, true),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'search_enable',
			'operator' => '==',
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'          => Edumall_Header::instance()->get_search_form_kirki_output('08', 'dark', true, true),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'search_enable',
			'operator' => '==',
...
Edumall_Kirki::add_field('theme', array(
	...
	'output'    => array(
		array(
			'choice'   => 'normal',
			'element'  => '.edumall-dark-scheme .header-08.header-dark .header-social-networks a',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
			'element'  => '.edumall-dark-scheme .header-08.header-dark .header-social-networks a:hover',
			'property' => 'color',
		),
	),
));

...
Edumall_Kirki::add_field('theme', array(
	...
	'label'       => esc_html__('Enable', 'edumall-child'),
	'description' => esc_html__('Enable this option to turn on header sticky feature.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => 1,
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'       => esc_html__('Behaviour', 'edumall-child'),
	'description' => esc_html__('Controls the behaviour of header sticky when you scroll down to page', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => 'both',
	'choices'     => array(
		'both' => esc_html__('Sticky on scroll up/down', 'edumall-child'),
		'up'   => esc_html__('Sticky on scroll up', 'edumall-child'),
		'down' => esc_html__('Sticky on scroll down', 'edumall-child'),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'     => esc_html__('Padding top', 'edumall-child'),
	'section'   => $section,
	'priority'  => $priority++,
	'default'   => 0,
	'transport' => 'auto',
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'     => esc_html__('Padding bottom', 'edumall-child'),
	'section'   => $section,
	'priority'  => $priority++,
	'default'   => 0,
	'transport' => 'auto',
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'    => esc_html__('Logo', 'edumall-child'),
	'section'  => $section,
	'priority' => $priority++,
	'default'  => 'dark',
	'choices'  => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Controls the background of header when sticky.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '<div class="group_title">' . esc_html__('Header Icons', 'edumall-child') . '</div>',
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '<div class="group_title">' . esc_html__('Social Networks', 'edumall-child') . '</div>',
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '<div class="group_title">' . esc_html__('Button', 'edumall-child') . '</div>',
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '<div class="group_title">' . esc_html__('Search Form', 'edumall-child') . '</div>',
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'default'  => sprintf('<div class="desc">
			...
			<p>%2$s</p>
		</div>', esc_html__('NOTE: ', 'edumall-child'), esc_html__('These settings below will control colors of Header Sticky in Dark Mode.', 'edumall-child')),
));

Edumall_Kirki::add_field('theme', array(
	'type'     => 'radio-buttonset',
	'settings' => 'dark_scheme_' . $prefix . 'logo',
	'label'    => esc_html__('Logo', 'edumall-child'),
	'section'  => $section,
	'priority' => $priority++,
	'default'  => 'light',
...
Edumall_Kirki::add_field('theme', array(
	'type'        => 'background',
	'settings'    => 'dark_scheme_' . $prefix . 'background',
	'label'       => esc_html__('Background', 'edumall-child'),
	'description' => esc_html__('Controls the background of header when sticky.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	...
	'output'      => array(
		array(
			'element' => '.edumall-dark-scheme #page-header.headroom--not-top .page-header-inner',
		),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	'type'        => 'multicolor',
	'settings'    => 'dark_scheme_' . $prefix . 'icon_color',
	'label'       => esc_html__('Icon Color', 'edumall-child'),
	'description' => esc_html__('Controls the color of icons on header.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	...
	'output'      => array(
		...
		array(
			'choice'   => 'hover',
			'element'  => '.edumall-dark-scheme .page-header.headroom--not-top .wpml-ls-slot-shortcode_actions:hover > .js-wpml-ls-item-toggle',
			'property' => 'color',
			'suffix'   => '!important',
		),
	),
...
Edumall_Kirki::add_field('theme', array(
	'type'        => 'multicolor',
	'settings'    => 'dark_scheme_' . $prefix . 'icon_badge_color',
	'label'       => esc_html__('Color', 'edumall-child'),
	'description' => esc_html__('Controls the color of icon badge.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	...
	'output'      => array(
		array(
			'choice'   => 'color',
			'element'  => '.edumall-dark-scheme .page-header.headroom--not-top .mini-cart .mini-cart-icon:after, .page-header.headroom--not-top .header-icon .badge',
			'property' => 'color',
			'suffix'   => ' !important',
		),
		array(
...
Edumall_Kirki::add_field('theme', array(
	'type'      => 'multicolor',
	'settings'  => 'dark_scheme_' . $prefix . 'social_networks_color',
	'label'     => esc_html__('Color', 'edumall-child'),
	'section'   => $section,
	'priority'  => $priority++,
	'transport' => 'auto',
	...
	'output'    => array(
		array(
			'choice'   => 'normal',
			'element'  => '.edumall-dark-scheme .page-header.headroom--not-top .header-social-networks a',
			'property' => 'color',
			'suffix'   => ' !important',
		),
		array(
			'choice'   => 'hover',
			'element'  => '.edumall-dark-scheme .page-header.headroom--not-top .header-social-networks a:hover',
			'property' => 'color',
			'suffix'   => ' !important',
		),
	),
...
Edumall_Kirki::add_field('theme', array(
	'type'        => 'multicolor',
	'settings'    => 'dark_scheme_' . $prefix . 'navigation_link_color',
	'label'       => esc_html__('Color', 'edumall-child'),
	'description' => esc_html__('Controls the color for main menu items.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	...
	'output'      => array(
		array(
			'choice'   => 'normal',
			'element'  => '.edumall-dark-scheme .page-header.headroom--not-top .menu--primary > ul > li > a',
			'property' => 'color',
			'suffix'   => ' !important',
		),
		array(
            ...
            .edumall-dark-scheme .page-header.headroom--not-top .menu--primary > ul > .current-menu-item > a',
			'property' => 'color',
			'suffix'   => ' !important',
		),
	),
...
Edumall_Kirki::add_field('theme', array(
	'type'      => 'multicolor',
	'settings'  => 'dark_scheme_' . $prefix . 'search_form_color',
	'label'     => esc_html__('Normal', 'edumall-child'),
	'section'   => $section,
	'priority'  => $priority++,
	'transport' => 'auto',
	...
	'output'    => array(
		array(
			'choice'   => 'color',
			'property' => 'color',
			'element'  => '.edumall-dark-scheme #page-header.headroom--not-top .search-field',
		),
		array(
			'choice'   => 'border',
			'property' => 'border-color',
...
Edumall_Kirki::add_field('theme', array(
	'type'      => 'multicolor',
	'settings'  => 'dark_scheme_' . $prefix . 'search_form_focus_color',
	'label'     => esc_html__('Hover', 'edumall-child'),
	'section'   => $section,
	'priority'  => $priority++,
	'transport' => 'auto',
	...
	'output'    => array(
		array(
			'choice'   => 'color',
			'property' => 'color',
			'element'  => '.edumall-dark-scheme #page-header.headroom--not-top .search-field:focus',
		),
		array(
			'choice'   => 'border',
			'property' => 'border-color',

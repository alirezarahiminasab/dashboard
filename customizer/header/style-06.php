...
Edumall_Kirki::add_field('theme', array(
	...
	'label'    => esc_html__('Contact Info', 'edumall-child'),
	'description' => '<a href="javascript:wp.customize.section( \'contact_info\' ).focus();">' . esc_html__('Edit contact info', 'edumall-child') . '</a>',
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '1',
	'choices'  => array(

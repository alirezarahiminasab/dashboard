...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Select default header style that displays on all single product pages.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => '',
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Select default Title Bar that displays on all single product pages.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Enter text that displays on single product pages. Leave blank to use product title.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => esc_html__('Our Shop', 'edumall-child'),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Select sidebar 1 that will display on single product pages.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Select sidebar 2 that will display on single product pages.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => 'none',
	'choices'     => $registered_sidebars,
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'    => esc_html__('Single Layout Preset', 'edumall-child'),
	'section'  => $section,
	'default'  => '-1',
	'priority' => $priority++,
	'multiple' => 0,
	'choices'  => array(
		...
		'list-left-sidebar'  => array(
			'label'    => esc_html__('List Layout - Left Sidebar', 'edumall-child'),
			'settings' => array(
		...
		'list-right-sidebar' => array(
			'label'    => esc_html__('List Layout - Right Sidebar', 'edumall-child'),
			'settings' => array(
				'product_page_sidebar_1'        => 'single_shop_sidebar',
		...
		'list-no-sidebar'    => array(
			'label'    => esc_html__('List Layout - No Sidebar', 'edumall-child'),
			'settings' => array(
		...
		'tabs-left-sidebar'  => array(
			'label'    => esc_html__('Tabs Layout - Left Sidebar', 'edumall-child'),
			'settings' => array(
				'product_page_sidebar_1'        => 'single_shop_sidebar',
				'product_page_sidebar_position' => 'left',
		...
		'tabs-no-sidebar'    => array(
			'label'    => esc_html__('Tabs Layout - No Sidebar', 'edumall-child'),
			'settings' => array(
				'product_page_sidebar_1'    => 'none',
				'single_product_tabs_style' => 'tabs',
			),
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'    => esc_html__('Layout Style', 'edumall-child'),
	'section'  => $section,
	'priority' => $priority++,
	'default'  => 'slider',
	'choices'  => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'       => esc_html__('Sticky Feature/Details Columns', 'edumall-child'),
	'description' => esc_html__('Turn on to enable sticky of product feature & details columns.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => '1',
	'choices'     => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'    => esc_html__('Tabs Style', 'edumall-child'),
	'section'  => $section,
	'priority' => $priority++,
	'default'  => 'list',
	'choices'  => array(
		'list' => esc_html__('List', 'edumall-child'),
		'tabs' => esc_html__('Tabs', 'edumall-child'),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'       => esc_html__('Custom Attribute', 'edumall-child'),
	'description' => esc_html__('Select a custom attribute that displays on beside product review rating.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => 'book-author',
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'    => esc_html__('Custom Attribute Label', 'edumall-child'),
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '1',
	'choices'  => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Turn on to display the categories.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => '1',
	'choices'     => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Turn on to display the tags.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => '1',
	'choices'     => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'       => esc_html__('Sharing', 'edumall-child'),
	'description' => esc_html__('Turn on to display the sharing.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => '1',
	'choices'     => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'       => esc_html__('Up-sells products', 'edumall-child'),
	'description' => esc_html__('Turn on to display the up-sells products section.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => '0',
	'choices'     => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'       => esc_html__('Related products', 'edumall-child'),
	'description' => esc_html__('Turn on to display the related products section.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => '1',
	'choices'     => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'           => esc_html__('Number related products', 'edumall-child'),
	'section'         => $section,
	'priority'        => $priority++,
	'default'         => 5,
	'choices'         => array(

...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Select default header style that displays on archive product page.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => '',
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Select default Title Bar that displays on all archive product (included cart, checkout, my-account...) pages.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => '',
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Enter text that displays on archive product pages.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Select sidebar 1 that will display on product archive pages.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => 'none',
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Select sidebar 2 that will display on product archive pages.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => 'none',
	'choices'     => $registered_sidebars,
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'    => esc_html__('Shop Layout Preset', 'edumall-child'),
	'section'  => $section,
	'default'  => '-1',
	'priority' => $priority++,
	'multiple' => 0,
	'choices'  => array(
		...
		'left-sidebar'  => array(
			'label'    => esc_html__('Shop Left Sidebar', 'edumall-child'),
			'settings' => array(
		...
		'right-sidebar' => array(
			'label'    => esc_html__('Shop Right Sidebar', 'edumall-child'),
			'settings' => array(
				'product_archive_page_sidebar_1'        => 'shop_sidebar',
...
Edumall_Kirki::add_field('theme', array(
	...
	'default'  => 'boxed',
	'choices'  => array(
		'boxed' => esc_html__('Boxed', 'edumall-child'),
		'wide'  => esc_html__('Wide', 'edumall-child'),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Turn on to show sorting select options that displays above products list.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => '0',
	'choices'     => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Turn on to show filtering button that displays above products list.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => '1',
	'choices'     => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Turn on to show layout switcher button that displays above products list.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => '1',
	'choices'     => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'       => esc_html__('Hover Image', 'edumall-child'),
	'description' => esc_html__('Turn on to show first gallery image when hover', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => '1',
	'choices'     => array(
		'0' => esc_html__('None', 'edumall-child'),
		'1' => esc_html__('Yes', 'edumall-child'),
	),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'       => esc_html__('Quick View', 'edumall-child'),
	'description' => esc_html__('Turn on to display quick view button', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => '0',
	'choices'     => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'       => esc_html__('Compare', 'edumall-child'),
	'description' => esc_html__('Turn on to display compare button', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => '1',
	'choices'     => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'       => esc_html__('Wishlist', 'edumall-child'),
	'description' => esc_html__('Turn on to display love button', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => '1',
	'choices'     => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'    => esc_html__('Hide All Buttons on mobile', 'edumall-child'),
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '1',
	'choices'  => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Controls the number of products display on shop archive page', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => 15,
	'choices'     => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => '<div class="big_title">' . esc_html__('Shop Columns', 'edumall-child') . '</div>',
));

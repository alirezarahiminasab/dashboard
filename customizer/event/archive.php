...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Select header style that displays on event archive pages.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Select default Title Bar that displays on archive event pages.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Enter text that displays on archive event pages.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => esc_html__('Events', 'edumall-child'),
));
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Select sidebar 1 that will display on event archive pages.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Select sidebar 2 that will display on event archive pages.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => 'none',
	'choices'     => $registered_sidebars,
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Select event style that display for event listing page.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => 'grid-01',
	'choices'     => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'description' => esc_html__('Controls the number of products display on events page', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => 12,
	'choices'     => array(
...
Edumall_Kirki::add_field('theme', array(
	...
	'label'       => esc_html__('Filtering Bar', 'edumall-child'),
	'description' => esc_html__('Turn on to show filtering form bar that displays above event list.', 'edumall-child'),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => '0',
	'choices'     => array(

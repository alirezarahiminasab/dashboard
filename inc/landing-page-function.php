...
class LandingPage
{
    ...
    public function get_the_course_price($course_id = null, $format = '-%s')
    {
        ...
        if ($is_purchasable && $price) {
            if (tutor_utils()->has_wc()) {
                ...
                $_regular_price = number_format($product->get_regular_price());

                if ($product && $product->is_on_sale()) :

                    $_sale_price    = number_format($product->get_sale_price());
                    $percentage = round((($_regular_price - $_sale_price) / $_regular_price) * 100, 1); ?>
                    <div class="price">
    ...
    public function get_courses()
    {
        ...
        <div class="home-<?php echo $type ?>-content-slider" data-nav="true">
        ...
        <?php if ($CoursesQuery->post_count > 1) : ?>
            <div class="home-<?php echo $type ?>-content-nav-btn">

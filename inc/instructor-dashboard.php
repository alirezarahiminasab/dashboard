...
class instructorDashboard
{
                    ...
                    <div class="instructor-dropdown-parent">
                        ...
                        <div id="table-dashboard-course-list-<?php echo esc_attr(get_the_ID()); ?>" class="instructor-dropdown-parent-menu">
                            ...
                            <div class="instructor-dropdown-item">
                                ...
                                <a href="<?php echo esc_url(tutor_utils()->get_tutor_dashboard_page_permalink('course/edit-courses/?course_ID=' . get_the_ID())); ?>">
    ...
    public function delete_tag()
    {
        ...
        $instructor_tags = get_user_meta($instructor_id, '_instructor_tags', true);

        $new_instructor_tags = array_diff($instructor_tags, [$tag]);
        $result = update_user_meta($instructor_id, '_instructor_tags', $new_instructor_tags);
...
<?php
    ...
    public function change_course_status()
    {
        ...
        switch ($course_action):
            ...
            case "delete-course":
                ...
                wp_send_json(array('result' => "دوره با موفقیت حذف گردید"));
                break;
        endswitch;
    }
    ...
    {
        $instructor_tags = $_POST['tags'];
        $instructor_username = sanitize_text_field($_POST['username']);
        $instructor_profession = sanitize_text_field($_POST['profession']);
        $instructor_story_text = sanitize_text_field($_POST['storyText']);
        $instructor_picture = sanitize_text_field($_POST['userPicture']);
        $instructor_apply = sanitize_text_field($_POST['becomeInstructor']);
        $instructor_id = !empty($_POST['user_id']) ? sanitize_text_field($_POST['user_id']) : get_current_user_id();

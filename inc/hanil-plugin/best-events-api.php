<?php
/* 
* Best Events Endpoint
*/


add_action('rest_api_init', function () {
    register_rest_route('hanil/v1', '/events/(?P<category_name>[a-zA-Z0-9-]+)', array(
        'methods' => 'GET',
        'callback' => 'get_events_by_category',
    ));
});

function get_events_by_category($data)
{

...
if (!class_exists('Edumall_WP_Widget_Product_Categories_Layered_Nav')) {
	class Edumall_WP_Widget_Product_Categories_Layered_Nav extends Edumall_WC_Widget_Base
	{
		...
		public function __construct()
		{
			...
			$this->widget_name        = esc_html__('[Edumall] Product Categories Layered Nav', 'edumall-child');
			$this->widget_description = esc_html__('Shows categories in a widget which lets you narrow down the list of products when viewing products.', 'edumall-child');
			$this->settings           = array(
				'title'        => array(
					'type'  => 'text',
					'std'   => esc_html__('Filter By Categories', 'edumall-child'),
		...
		protected function layered_nav_dropdown($terms, $taxonomy, $instance, $depth = 0)
		{
			...
			if ($taxonomy !== $this->get_current_taxonomy()) {
				...
				echo '<option value="">' . esc_html__('Any Category', 'edumall-child') . '</option>';

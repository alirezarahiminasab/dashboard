...
if (!class_exists('Edumall_WP_Widget_Product_Rating_Filter')) {
	class Edumall_WP_Widget_Product_Rating_Filter extends Edumall_WC_Widget_Base
	{
		...
		public function __construct()
		{
			...
			$this->widget_name        = esc_html__('[Edumall] Filter Products by Rating', 'edumall-child');
			$this->widget_description = esc_html__('Display a list of star ratings to filter products in your store.', 'edumall-child');

			$this->settings = array(
				'title' => array(
					'type'  => 'text',
					'std'   => esc_html__('Average rating', 'edumall-child'),

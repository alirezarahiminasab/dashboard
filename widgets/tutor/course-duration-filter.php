...
if (!class_exists('Edumall_WP_Widget_Course_Duration_Filter')) {
	class Edumall_WP_Widget_Course_Duration_Filter extends Edumall_Course_Layered_Nav_Base
	{
		...
		public function __construct()
		{
			...
			$this->widget_name        = esc_html__('[Edumall] Course Duration Filter', 'edumall-child');
			$this->widget_description = esc_html__('Shows duration in a widget which lets you narrow down the list of courses when viewing courses.', 'edumall-child');
			$this->settings           = array(
				'title'        => array(
					'type'  => 'text',
					'std'   => esc_html__('Filter by duration', 'edumall-child'),
		...
		protected function layered_nav_list($instance)
		{
			...
			$duration_ranges = array(
				'short'     => esc_html__('Less than 2 hours', 'edumall-child'),
				'medium'    => esc_html__('3 - 6 hours', 'edumall-child'),
				'long'      => esc_html__('7 - 16 hours', 'edumall-child'),
				'extraLong' => esc_html__('17+ Hours', 'edumall-child'),
			);

...
if (!class_exists('Edumall_WP_Widget_Course_Language_Filter')) {
	class Edumall_WP_Widget_Course_Language_Filter extends Edumall_Course_Layered_Nav_Base
	{

		public function __construct()
		{
			$this->widget_id          = 'edumall-wp-widget-course-language-filter';
			$this->widget_cssclass    = 'edumall-wp-widget-course-language-filter edumall-wp-widget-course-filter';
			$this->widget_name        = esc_html__('[Edumall] Course Language Filter', 'edumall-child');
			$this->widget_description = esc_html__('Shows language in a widget which lets you narrow down the list of courses when viewing courses.', 'edumall-child');
			$this->settings           = array(
				'title'        => array(
					'type'  => 'text',
					'std'   => esc_html__('Filter by language', 'edumall-child'),

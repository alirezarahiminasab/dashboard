...
if (!class_exists('Edumall_Event')) {
	class Edumall_Event
	{
		...
		{
			require_once EDUMALL_EVENT_MANAGER_DIR . '/post-type.php';
			...
			Edumall_Event_Post_Type::instance()->initialize();
		...
		{
			return [
				''          => esc_html__('All', 'edumall-child'),
				'happening' => esc_html__('Happening', 'edumall-child'),
				'upcoming'  => esc_html__('Upcoming', 'edumall-child'),
				'expired'   => esc_html__('Expired', 'edumall-child'),
			];
		}
...
?>
			<div class="option_group">
				<p class="form-field">
					<label for="event_meta_short_location"><?php esc_html_e('Short Location', 'edumall-child'); ?></label>
					<input type="text" class="short" name="<?php echo esc_attr($meta_key); ?>" id="event_meta_short_location" value="<?php echo esc_attr($meta_value); ?>">
				</p>
			</div>
		<?php
		}
		...
		?>
			<div class="option_group">
				<p class="form-field">
					<label for="event_meta_place"><?php esc_html_e('Place', 'edumall-child'); ?></label>
					<input type="text" class="short" name="<?php echo esc_attr($meta_key); ?>" id="event_meta_place" value="<?php echo esc_attr($meta_value); ?>">
				</p>
			</div>
		<?php
		}
		...
		?>
			<div class="option_group">
				<p class="form-field">
					<label for="event_meta_phone_number"><?php esc_html_e('Phone Number', 'edumall-child'); ?></label>
					<input type="text" class="short" name="<?php echo esc_attr($meta_key); ?>" id="event_meta_phone_number" value="<?php echo esc_attr($meta_value); ?>">
				</p>
			</div>
		<?php
		}
		...
		?>
			<div class="option_group">
				<p class="form-field">
					<label for="event_meta_website"><?php esc_html_e('Website', 'edumall-child'); ?></label>
					<input type="text" class="short" name="<?php echo esc_attr($meta_key); ?>" id="event_meta_website" value="<?php echo esc_attr($meta_value); ?>">
				</p>
			</div>
		<?php
		}
		...
		{
			$js_vars['l18n']['labels'] = [
				esc_html__('Years', 'edumall-child'),
				esc_html__('Months', 'edumall-child'),
				esc_html__('Weeks', 'edumall-child'),
				esc_html__('Days', 'edumall-child'),
				esc_html__('Hours', 'edumall-child'),
				esc_html__('Mins', 'edumall-child'),
				esc_html__('Secs', 'edumall-child'),
			];

			$js_vars['l18n']['labels1'] = [
				esc_html__('Year', 'edumall-child'),
				esc_html__('Month', 'edumall-child'),
				esc_html__('Week', 'edumall-child'),
				esc_html__('Day', 'edumall-child'),
				esc_html__('Hour', 'edumall-child'),
				esc_html__('Min', 'edumall-child'),
				esc_html__('Sec', 'edumall-child'),
			];

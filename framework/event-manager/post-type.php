...
if (!class_exists('Edumall_Event_Post_Type')) {
	class Edumall_Event_Post_Type extends Edumall_Event
	{
		...
		public function fix_invalid_capability_in_menus()
		{
			...
			add_menu_page(__('Events Manager', 'edumall-child'), __('Events Manager', 'edumall-child'), 'edit_tp_events', 'tp-event-setting', null, 'dashicons-calendar-alt', 4);
			...
			add_submenu_page('tp-event-setting', __('WP Event Users', 'edumall-child'), __('Users', 'edumall-child'), 'manage_options', 'tp-event-users', array(
				'WPEMS_Admin_Users',
				'output',
			));
			add_submenu_page('tp-event-setting', __('WP Event Settings', 'edumall-child'), __('Settings', 'edumall-child'), 'manage_options', 'tp-event-setting', array(

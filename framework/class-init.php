...
class Edumall_Init
{
	...
	public function initialize()
	{
		...
		if (!function_exists('_wp_render_title_tag')) {
			add_action('wp_head', array($this, 'edumall_render_title'));
		}
	}

	function edumall_render_title()
	{
?>
...
<?php
	...
	public function setup()
	{
		 ...
		 */
		load_theme_textdomain('edumall-child', EDUMALL_THEME_DIR . '/languages');

		// This theme uses wp_nav_menu() in one location.
		register_nav_menus(array(
			'primary'    => esc_html__('Primary', 'edumall-child'),
			'off_canvas' => esc_html__('Off Canvas', 'edumall-child'),
			'footer-1'	 => esc_html__('Footer Right Menu', 'edumall-child'),
			'footer-2'	 => esc_html__('Footer Left Menu', 'edumall-child'),
		));
	...
	{
		$info['icon']      = EDUMALL_THEME_URI . '/assets/admin/images/logo.png';
		$info['tf']        = 'https://themeforest.net/item/edumall-lms-education-wordpress-theme/29240444';
		$info['envato_id'] = '29240444';
		$info['docs']      = 'https://document.thememove.com/edumall';
		$info['child']     = 'https://api.thememove.com/update/edumall/edumall-child.zip';
		$info['update']    = 'https://api.thememove.com/update/edumall';
		$info['api']       = 'https://api.thememove.com/update/edumall';
		$info['support']   = 'https://thememove.ticksy.com/';
		$info['faqs']      = 'https://thememove.ticksy.com/articles/';
		$info['desc']      = esc_html__('Thank you for using our theme, please reward it a full five-star &#9733;&#9733;&#9733;&#9733;&#9733; rating.', 'edumall-child');

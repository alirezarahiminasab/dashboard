...
class Edumall_Init {
	...
	public function setup() {
		 ...
		 */
		load_theme_textdomain( 'edumall', EDUMALL_THEME_DIR . '/languages' );

		// This theme uses wp_nav_menu() in one location.
		register_nav_menus( array(
			'primary'    => esc_html__( 'Primary', 'edumall' ),
			'off_canvas' => esc_html__( 'Off Canvas', 'edumall' ),
		) );
	...
	function core_info( $info ) {
		...
		$info['desc']      = esc_html__( 'Thank you for using our theme, please reward it a full five-star &#9733;&#9733;&#9733;&#9733;&#9733; rating.', 'edumall' );

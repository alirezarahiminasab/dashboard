	...
	class Edumall_Header
	{
		...
		public function get_type()
		{
			return array(
				...
				'04' => esc_html__('Style 04', 'edumall-child'),
				'05' => esc_html__('Style 05', 'edumall-child'),
				'06' => esc_html__('Style 06', 'edumall-child'),
				'07' => esc_html__('Style 07', 'edumall-child'),
				'08' => esc_html__('Style 08', 'edumall-child'),
			);
		}
		...
		public function get_list($default_option = false, $default_text = '')
		{
			...
			if ($default_option === true) {
				if ($default_text === '') {
					$default_text = esc_html__('Default', 'edumall-child');
				}
		...
		{
			return array(
				'flat'         => esc_attr__('Flat', 'edumall-child'),
				'border'       => esc_attr__('Border', 'edumall-child'),
				'thick-border' => esc_attr__('Thick Border', 'edumall-child'),
			);
		}
		...
		?>
			<?php if ($button_link !== '' && $button_text !== '') : ?>
				...
				<div class="header-buttons">
					<a class="<?php echo esc_attr($header_button_classes); ?>" href="<?php echo esc_url($button_link); ?>" <?php if ('1' === $button_link_target) : ?> target="_blank" <?php endif; ?> <?php if (!empty($button_link_rel)) : ?> rel="<?php echo esc_attr($button_link_rel); ?>" <?php endif; ?>>
						<?php echo '' . $button_content_html; ?>
					</a>
					<a class="<?php echo esc_attr($sticky_button_classes); ?>" href="<?php echo esc_url($button_link); ?>" <?php if ('1' === $button_link_target) : ?> target="_blank" <?php endif; ?> <?php if (!empty($button_link_rel)) : ?> rel="<?php echo esc_attr($button_link_rel); ?>" <?php endif; ?>>
						<?php echo '' . $button_content_html; ?>
					</a>
				</div>
<?php endif;

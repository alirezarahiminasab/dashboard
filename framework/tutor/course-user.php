...
if ( ! class_exists( 'Edumall_Course_User' ) ) {
	class Edumall_Course_User {
		...
		public function initialize() {
			...
			add_filter( 'edumall_login_url', [ $this, 'update_login_url' ], 20 );
			add_filter( 'edumall_register_url', [ $this, 'update_register_url' ], 20 );
		...
		public function update_login_url( $url ) {
			return tutor_utils()->get_tutor_dashboard_page_permalink();
		}

		public function update_register_url( $url ) {
			$url_arg = array(
			...
			return add_query_arg( $url_arg, tutor_utils()->student_register_url() );
		}

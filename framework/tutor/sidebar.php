	...
	class Edumall_Tutor_Sidebar
	{
		...
		public function register_sidebars()
		{
			...
			register_sidebar(array_merge($default_args, [
				...
				'name'        => esc_html__('Course Top Filters', 'edumall-child'),
				'description' => esc_html__('This sidebar displays above course list on course listing page.', 'edumall-child'),
			]));

			register_sidebar(array_merge($default_args, [
				'id'          => 'course_sidebar_filters',
				'name'        => esc_html__('Course Sidebar Filters', 'edumall-child'),
				'description' => esc_html__('This sidebar displays below Sidebar 1 on course listing page.', 'edumall-child'),
			]));

			register_sidebar(array_merge($default_args, [
				'id'          => 'course_sidebar',
				'name'        => esc_html__('Course Listing Sidebar', 'edumall-child'),
				'description' => esc_html__('Add widgets displays on course listing pages.', 'edumall-child'),
			]));

			register_sidebar(array_merge($default_args, [
				'id'          => 'course_single_sidebar',
				'name'        => esc_html__('Single Course Sidebar', 'edumall-child'),
				'description' => esc_html__('Add widgets displays on single course pages.', 'edumall-child'),
			]));
		}

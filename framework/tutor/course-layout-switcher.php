...
?>
			<form id="archive-layout-switcher" class="archive-layout-switcher">
				...
				$id = uniqid('switcher-');
				?>
				<div class="archive-layout-switcher-label heading"><?php esc_html_e('See', 'edumall-child'); ?></div>
				<label class="<?php echo esc_attr($switcher_grid_classes); ?>" for="<?php echo esc_attr($id . '-grid') ?>">
...
<?php
		...
		{
			if (
				'1' === Edumall::setting('course_archive_layout_switcher')

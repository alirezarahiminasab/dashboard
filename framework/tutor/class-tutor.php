...
if ( ! class_exists( 'Edumall_Tutor' ) ) {
	class Edumall_Tutor {
		...
		public function get_google_meet_type() {
			return 'tutor-google-meet';
		}
		...
		public function is_student_registration_page() {
			$student_register_page = (int) tutor_utils()->get_option( 'student_register_page' );

			return $this->is_the_page_id( $student_register_page );
		}

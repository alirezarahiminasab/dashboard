...
if (!class_exists('Edumall_Tutor_Course_Review')) {
	class Edumall_Tutor_Course_Review
	{
		...
		public function add_review($course_id, $rating, $review)
		{
			...
			if (empty($rating)) {
				return new WP_Error('failed', esc_html__('Please select a rating', 'edumall-child'));
			}

			if (empty($course_id)) {
				return new WP_Error('failed', esc_html__('Please select a course', 'edumall-child'));
			}

			if (empty($review)) {
				return new WP_Error('failed', esc_html__('Please input your review', 'edumall-child'));
			}
			...
			if (!Edumall_Tutor::instance()->has_enrolled_content_access('course', $course_id)) {
				return new WP_Error('failed', esc_html__('Access Denied', 'edumall-child'));
			}
		...
		public function update_review($review_id, $rating, $review)
		{
			...
			return new WP_Error('failed', esc_html__('Can\'t update review', 'edumall-child'));
		}

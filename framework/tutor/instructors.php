...
if (!class_exists('Edumall_Tutor_Instructors')) {
	class Edumall_Tutor_Instructors
	{
		...
		public function add_instructor_setting($setting)
		{
			...
			$cpts = array(
				'faq'      => __('FAQs', 'edumall-child'),
				'tp_event' => __('Events', 'edumall-child'),
			);
			...
			$new_setting_fields = [
				[
					...
					'type'        => 'toggle_switch',
					'label'       => __('Become Instructor Immediately', 'edumall-child'),
					'label_title' => '',
					'default'     => 'off',
					'desc'        => __('Enabling this feature will make user become Instructor immediately without review from Admin.', 'edumall-child'),
				],
				[
					'key'     => 'instructor_manage_cpt',
					'type'    => 'checkbox_horizontal',
					'label'   => __('Manage Custom Post Type', 'edumall-child'),
					'options' => $cpts,
					'desc'    => __('Allows instructors manage custom post types.', 'edumall-child'),
				],
				[
					'key'     => 'instructor_listing_page',
					'type'    => 'select',
					'label'   => __('Instructor Listing Page', 'edumall-child'),
					'default' => '0',
					'options' => $pages,
					'desc'    => __('This page will be used to show all approved instructors', 'edumall-child'),
				],
				[
					'key'     => 'instructors_per_page',
					'type'    => 'number',
					'label'   => __('Pagination', 'edumall-child'),
					'default' => '12',
					'desc'    => __('Number of instructors you would like displayed "per page" in the pagination', 'edumall-child'),
				],
			];

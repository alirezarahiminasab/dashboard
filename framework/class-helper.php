	...
	class Edumall_Helper
	{
		...
		function __construct()
		{
			self::$preloader_style = array(
				'rotating-plane'  => esc_attr__('Rotating Plane', 'edumall-child'),
				'double-bounce'   => esc_attr__('Double Bounce', 'edumall-child'),
				'three-bounce'    => esc_attr__('Three Bounce', 'edumall-child'),
				'wave'            => esc_attr__('Wave', 'edumall-child'),
				'wandering-cubes' => esc_attr__('Wandering Cubes', 'edumall-child'),
				'pulse'           => esc_attr__('Pulse', 'edumall-child'),
				'chasing-dots'    => esc_attr__('Chasing dots', 'edumall-child'),
				'circle'          => esc_attr__('Circle', 'edumall-child'),
				'cube-grid'       => esc_attr__('Cube Grid', 'edumall-child'),
				'fading-circle'   => esc_attr__('Fading Circle', 'edumall-child'),
				'folding-cube'    => esc_attr__('Folding Cube', 'edumall-child'),
				'gif-image'       => esc_attr__('Gif Image', 'edumall-child'),
			);
		}
		...
		{
			$list = self::$preloader_style + array('random' => esc_attr__('Random', 'edumall-child'));
		...
		public static function get_list_revslider()
		{
			global $wpdb;
			$revsliders = array(
				'' => esc_attr__('Select a slider', 'edumall-child'),
			);
		...
		public static function get_registered_sidebars($default_option = false, $empty_option = true)
		{
			...
			if ($empty_option === true) {
				$sidebars['none'] = esc_html__('No Sidebar', 'edumall-child');
			}
			if ($default_option === true) {
				$sidebars['default'] = esc_html__('Default', 'edumall-child');
			}
		...
		public static function get_list_sidebar_positions($default = false)
		{
			...
			if ($default === true) {
				$positions['default'] = esc_html__('Default', 'edumall-child');
			}
		 ...
		 * @param int|float $value2 Total number
		 *
		 * @return int
		 */
		...
		{
			if (defined('EDUMALL_LIVE_SITE') && true === EDUMALL_LIVE_SITE) {
				return true;
			}
			...
			if ('live-edumall.thememove.com' === $host) {
				return true;
			}
		...
		public static function get_user_social_networks_support()
		{
			$user_socials = array(
				'twitter'   => array(
					'label'        => esc_html__('Twitter', 'edumall-child'),
					'icon_classes' => 'fab fa-twitter',
					'placeholder'  => 'https://twitter.com/username',
				),
				'facebook'  => array(
					'label'        => esc_html__('Facebook', 'edumall-child'),
					'icon_classes' => 'fab fa-facebook-f',
					'placeholder'  => 'https://facebook.com/username',
				),
				'instagram' => array(
					'label'        => esc_html__('Instagram', 'edumall-child'),
					'icon_classes' => 'fab fa-instagram',
					'placeholder'  => 'https://instagram.com/username',
				),
				'linkedin'  => array(
					'label'        => esc_html__('Linkedin', 'edumall-child'),
					'icon_classes' => 'fab fa-linkedin',
					'placeholder'  => 'https://linkedin.com/username',
				),
				'pinterest' => array(
					'label'        => esc_html__('Pinterest', 'edumall-child'),
					'icon_classes' => 'fab fa-pinterest',
					'placeholder'  => 'https://pinterest.com/username',
				),
				'youtube'   => array(
					'label'        => esc_html__('Youtube', 'edumall-child'),
					'icon_classes' => 'fab fa-youtube',
					'placeholder'  => 'https://youtube.com',
				),
				'github'    => array(
					'label'        => esc_html__('Github', 'edumall-child'),
		...
		{
			$options = [
				0 => esc_html__('Select a page', 'edumall-child'),
			];

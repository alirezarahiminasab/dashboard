	...
	class Edumall_Top_Bar
	{
		...
		public function get_type()
		{
			return array(
				...
				'05' => esc_html__('05', 'edumall-child'),
			);
		}
		...
		{
			$list = [
				'widget'            => esc_html__('Widget', 'edumall-child'),
				'text'              => esc_html__('Text', 'edumall-child'),
				'language_switcher' => esc_html__('Language Switcher', 'edumall-child'),
				'info_list'         => esc_html__('Info List', 'edumall-child'),
				'user_links'        => esc_html__('User Links', 'edumall-child'),
				'social_links'      => esc_html__('Social Links', 'edumall-child'),
			];
...
?>
		...
		?>
			<?php if ($button_link !== '' && $button_text !== '') : ?>
				<a class="<?php echo esc_attr($button_classes); ?>" href="<?php echo esc_url($button_link); ?>" <?php if ($button_link_target === '1') : ?> target="_blank" <?php endif; ?>>

...
class Edumall {
	...
	public static function is_dark_version() {
	...
	public static function menu_mobile_primary() {
		...
		if ( EDUMALL_IS_RTL ) {
			$mobile_menu = preg_replace( $pattern, '<ul id="mobile-menu-primary" class="menu__container mobile-menu-primary-rtl">', $edumall_primary_menu );
		} else {
			$mobile_menu = preg_replace( $pattern, '<ul id="mobile-menu-primary" class="menu__container">', $edumall_primary_menu );
		}
	...
	public static function branding_logo( $reverse_scheme = null ) {
		...
		if ( 'dark' === Edumall_Global::instance()->get_site_skin() ) {
			$sticky_logo_skin = Edumall::setting( 'dark_scheme_header_sticky_logo' );
		} else {
		...
		if ( 'dark' === Edumall_Global::instance()->get_site_skin() ) {
			$header_logo_skin = 'dark' === $header_logo_skin ? 'light' : 'dark';
		}

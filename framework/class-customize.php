	...
	class Edumall_Customize
	{
		...
		function field_social_networks_enable($args = array())
		{
			$defaults = array(
				...
				'description' => '<a href="javascript:wp.customize.section( \'socials\' ).focus();">' . esc_html__('Edit social network links', 'edumall-child') . '</a>',
				'default'     => '0',
				'choices'     => array(
		...
		function field_social_sharing_enable($args = array())
		{
			$defaults = array(
				...
				'description' => '<a href="javascript:wp.customize.section( \'social_sharing\' ).focus();">' . esc_html__('Edit social sharing list', 'edumall-child') . '</a>',
				'choices'     => array(
					'0' => esc_html__('Hide', 'edumall-child'),
					'1' => esc_html__('Show', 'edumall-child'),
				),
		...
		function field_language_switcher_enable($args = array())
		{
			$defaults = array(
				'type'        => 'radio-buttonset',
				'label'       => esc_html__('Language Switcher', 'edumall-child'),
				'description' => '',
				'choices'     => array(
					'0' => esc_html__('Hide', 'edumall-child'),
					'1' => esc_html__('Show', 'edumall-child'),

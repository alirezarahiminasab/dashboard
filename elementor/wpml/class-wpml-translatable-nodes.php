	...
	public function get_translatable_node()
	{
		...
		$widgets['tm-heading'] = [
			'fields' => [
				[
					'field'       => 'title',
					'type'        => esc_html__('Modern Heading: Primary', 'edumall-child'),
					'editor_type' => 'AREA',
				],
				'title_link' => [
					'field'       => 'url',
					'type'        => esc_html__('Modern Heading: Link', 'edumall-child'),
					'editor_type' => 'LINE',
				],
				[
					'field'       => 'description',
					'type'        => esc_html__('Modern Heading: Description', 'edumall-child'),
					'editor_type' => 'AREA',
				],
				[
					'field'       => 'sub_title_text',
					'type'        => esc_html__('Modern Heading: Secondary', 'edumall-child'),
					'editor_type' => 'AREA',
				],
			],
		];
		...
		$widgets['tm-button'] = [
			'fields' => [
				[
					'field'       => 'text',
					'type'        => esc_html__('Button: Text', 'edumall-child'),
					'editor_type' => 'LINE',
				],
				[
					'field'       => 'badge_text',
					'type'        => esc_html__('Button: Badge', 'edumall-child'),
					'editor_type' => 'LINE',
				],
				'link' => [
					'field'       => 'url',
					'type'        => esc_html__('Button: Link', 'edumall-child'),
					'editor_type' => 'LINK',
				],
			],
		];
		...
		$widgets['tm-banner'] = [
			'fields' => [
				[
					'field'       => 'title_text',
					'type'        => esc_html__('Banner: Title', 'edumall-child'),
					'editor_type' => 'LINE',
				],
				'link' => [
					'field'       => 'url',
					'type'        => esc_html__('Banner: Link', 'edumall-child'),
					'editor_type' => 'LINK',
				],
			],
		];
		...
		$widgets['tm-circle-progress-chart'] = [
			'fields' => [
				[
					...
					'type'        => esc_html__('Circle Chart: Text', 'edumall-child'),
					'editor_type' => 'LINE',
				],
			],
		];
		...
		$widgets['tm-flip-box'] = [
			'fields' => [
				[
					'field'       => 'title_text_a',
					'type'        => esc_html__('Flip Box: Front Title', 'edumall-child'),
					'editor_type' => 'LINE',
				],
				[
					'field'       => 'description_text_a',
					'type'        => esc_html__('Flip Box: Front Description', 'edumall-child'),
					'editor_type' => 'AREA',
				],
				[
					'field'       => 'title_text_b',
					'type'        => esc_html__('Flip Box: Back Title', 'edumall-child'),
					'editor_type' => 'LINE',
				],
				[
					'field'       => 'description_text_b',
					'type'        => esc_html__('Flip Box: Back Description', 'edumall-child'),
					'editor_type' => 'AREA',
				],
				[
					'field'       => 'button_text',
					'type'        => esc_html__('Flip Box: Button Text', 'edumall-child'),
					'editor_type' => 'LINE',
				],
				'link' => [
					'field'       => 'url',
					'type'        => esc_html__('Flip Box: Link', 'edumall-child'),
					'editor_type' => 'LINK',
				],
			],
		];
		...
		$widgets['tm-icon'] = [
			'fields' => [
				'link' => [
					'field'       => 'url',
					'type'        => esc_html__('Icon: Link', 'edumall-child'),
					'editor_type' => 'LINK',
				],
			],
		];
		...
		$widgets['tm-icon-box'] = [
			'fields' => [
				[
					'field'       => 'title_text',
					'type'        => esc_html__('Icon Box: Title', 'edumall-child'),
					'editor_type' => 'AREA',
				],
				[
					'field'       => 'description_text',
					'type'        => esc_html__('Icon Box: Description', 'edumall-child'),
					'editor_type' => 'AREA',
				],
				'link'        => [
					'field'       => 'url',
					'type'        => esc_html__('Icon Box: Link', 'edumall-child'),
					'editor_type' => 'LINK',
				],
				[
					'field'       => 'button_text',
					'type'        => esc_html__('Icon Box: Button', 'edumall-child'),
					'editor_type' => 'LINE',
				],
				'button_link' => [
					'field'       => 'url',
					'type'        => esc_html__('Icon Box: Button Link', 'edumall-child'),
					'editor_type' => 'LINK',
				],
			],
		];
		...
		$widgets['tm-image-box'] = [
			'fields' => [
				[
					'field'       => 'title_text',
					'type'        => esc_html__('Image Box: Title', 'edumall-child'),
					'editor_type' => 'AREA',
				],
				[
					'field'       => 'description_text',
					'type'        => esc_html__('Image Box: Content', 'edumall-child'),
					'editor_type' => 'AREA',
				],
				'link' => [
					'field'       => 'url',
					'type'        => esc_html__('Image Box: Link', 'edumall-child'),
					'editor_type' => 'LINK',
				],
				[
					'field'       => 'button_text',
					'type'        => esc_html__('Image Box: Button', 'edumall-child'),
					'editor_type' => 'LINE',
				],
			],
		];
		...
		$widgets['tm-popup-video'] = [
			'fields' => [
				[
					'field'       => 'video_text',
					'type'        => esc_html__('Popup Video: Text', 'edumall-child'),
					'editor_type' => 'AREA',
				],
				'video_url' => [
					'field'       => 'url',
					'type'        => esc_html__('Popup Video: Link', 'edumall-child'),
					'editor_type' => 'LINK',
				],
				[
					'field'       => 'poster_caption',
					'type'        => esc_html__('Popup Video: Caption', 'edumall-child'),
					'editor_type' => 'AREA',
				],
			],
		];
		...
		$widgets['tm-pricing-table'] = [
			'fields'            => [
				[
					'field'       => 'heading',
					'type'        => esc_html__('Pricing Table: Heading', 'edumall-child'),
					'editor_type' => 'LINE',
				],
				[
					'field'       => 'sub_heading',
					'type'        => esc_html__('Pricing Table: Description', 'edumall-child'),
					'editor_type' => 'LINE',
				],
				[
					'field'       => 'currency',
					'type'        => esc_html__('Pricing Table: Currency', 'edumall-child'),
					'editor_type' => 'LINE',
				],
				[
					'field'       => 'price',
					'type'        => esc_html__('Pricing Table: Price', 'edumall-child'),
					'editor_type' => 'LINE',
				],
				[
					'field'       => 'period',
					'type'        => esc_html__('Pricing Table: Period', 'edumall-child'),
					'editor_type' => 'LINE',
				],
				[
					'field'       => 'button_text',
					'type'        => esc_html__('Pricing Table: Button', 'edumall-child'),
					'editor_type' => 'LINE',
				],
				'button_link' => [
					'field'       => 'url',
					'type'        => esc_html__('Pricing Table: Button Link', 'edumall-child'),
					'editor_type' => 'LINK',
				],
			],
		...
		$widgets['tm-team-member'] = [
			'fields' => [
				[
					'field'       => 'name',
					'type'        => esc_html__('Team Member: Name', 'edumall-child'),
					'editor_type' => 'LINE',
				],
				[
					'field'       => 'content',
					'type'        => esc_html__('Team Member: Content', 'edumall-child'),
					'editor_type' => 'AREA',
				],
				[
					'field'       => 'position',
					'type'        => esc_html__('Team Member: Position', 'edumall-child'),
					'editor_type' => 'LINE',
				],
				'profile' => [
					'field'       => 'url',
					'type'        => esc_html__('Team Member: Profile', 'edumall-child'),
					'editor_type' => 'LINK',
				],
			],
		];

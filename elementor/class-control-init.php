...
class Control_Init
{
	...
	{
		require_once EDUMALL_ELEMENTOR_DIR . '/class-font-awesome-pro.php';
		require_once EDUMALL_ELEMENTOR_DIR . '/class-font-elementor.php';
	...
	public function add_custom_shape_divider($additional_shapes)
	{
		$additional_shapes['center-curve'] = [
			'title'        => esc_html__('Curve Alt', 'edumall-child'),
			'has_negative' => true,
			'height_only'  => true,
		...
		$additional_shapes['tilt-curve'] = [
			'title'       => esc_html__('Tile Curve', 'edumall-child'),
			'has_flip'    => true,
			'height_only' => true,
		...
		$additional_shapes['mountain-alt'] = [
			'title'       => esc_html__('Mountain Alt', 'edumall-child'),
			'has_flip'    => true,
			'height_only' => true,
	...
	{
		$animations['By Edumall'] = [
			'edumallFadeInUp' => 'Edumall - Fade In Up',
		];
	...
	public function init_controls($controls_manager)
	{
		...
		require_once EDUMALL_ELEMENTOR_DIR . '/controls/control-autocomplete.php';

		require_once EDUMALL_ELEMENTOR_DIR . '/controls/group-control-text-gradient.php';
		require_once EDUMALL_ELEMENTOR_DIR . '/controls/group-control-text-stroke.php';
		require_once EDUMALL_ELEMENTOR_DIR . '/controls/group-control-advanced-border.php';
		require_once EDUMALL_ELEMENTOR_DIR . '/controls/group-control-button.php';
		require_once EDUMALL_ELEMENTOR_DIR . '/controls/group-control-tooltip.php';

...
class Widget_Shapes extends Base
{
	...
	{
		return esc_html__('Modern Shapes', 'edumall-child');
	}
	...
	private function add_content_section()
	{
		...
		$this->add_control('type', [
			...
			'options'      => [
				...
				'border-circle' => esc_html__('Border Circle', 'edumall-child'),
				'rectangle'     => esc_html__('Rectangle', 'edumall-child'),
				'three-lines'   => esc_html__('3 Lines', 'edumall-child'),
				'distortion'    => esc_html__('Distortion', 'edumall-child'),
				'distortion-02' => esc_html__('Distortion 02', 'edumall-child'),
				'distortion-03' => esc_html__('Distortion 03', 'edumall-child'),
				'distortion-04' => esc_html__('Distortion 04', 'edumall-child'),
				'distortion-05' => esc_html__('Distortion 05', 'edumall-child'),
			],
			'default'      => 'circle',
		...
		$this->add_control('shape_position_hr', [
			'label'     => esc_html__('Rotating - Positioning', 'edumall-child'),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		]);

		$this->add_control('shape_flip_x', [
			'label'     => esc_html__('Flip Horizontally', 'edumall-child'),
			...
			'options'   => [
				...
				'-1' => [
					'title' => esc_html__('Yes', 'edumall-child'),
		...
		$this->add_control('shape_flip_y', [
			'label'     => esc_html__('Flip Vertical', 'edumall-child'),
			'type'      => Controls_Manager::CHOOSE,
			'toggle'    => false,
			'options'   => [
				'1'  => [

...
class Widget_Social_Networks extends Base
{
	...
	{
		return esc_html__('Social Networks', 'edumall-child');
	}
	...
	private function add_content_section()
	{
		...
		$this->add_control('style', [
			...
			'options' => [
				'icons'              => esc_html__('Icons', 'edumall-child'),
				'large-icons'        => esc_html__('Large Icons', 'edumall-child'),
				'flat-rounded-icon'  => esc_html__('Flat Rounded Icon', 'edumall-child'),
				'solid-rounded-icon' => esc_html__('Solid Rounded Icon', 'edumall-child'),
				'icon-title'         => esc_html__('Icon + Title', 'edumall-child'),
		...
		$this->add_control('layout', [
			...
			'type'    => Controls_Manager::SELECT,
			'options' => [
				'inline'      => esc_html__('Inline', 'edumall-child'),
				'list'        => esc_html__('List', 'edumall-child'),
				'two-columns' => esc_html__('2 Columns', 'edumall-child'),
			],
			'default' => 'inline',
		]);
		...
		$this->add_control('items', [
			...
			'default'     => [
				...
				[
					'title' => esc_html__('Linkedin', 'edumall-child'),
					'link'  => [
						'url'         => '#',
						'is_external' => true,
						'nofollow'    => true,
	...
	private function add_style_section()
	{
		...
		$this->add_control('items_vertical_spacing', [
			'label'      => esc_html__('Items Vertical Spacing', 'edumall-child'),

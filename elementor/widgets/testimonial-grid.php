...
class Widget_Testimonial_Grid extends Base
{
	...
	{
		return esc_html__('Testimonial Masonry', 'edumall-child');
	}
	...
	private function add_layout_section()
	{
		...
		$this->add_control('layout', [
			...
			'options'      => [
				'image-inline'  => esc_html__('Image Inline', 'edumall-child'),
				'image-stacked' => esc_html__('Image Stacked', 'edumall-child'),
				'image-above'   => esc_html__('Image Above', 'edumall-child'),
			],
		...
		$this->add_control('image_position', [
			...
			'options'      => [
				'above'  => [
					'title' => esc_html__('Above', 'edumall-child'),
					'icon'  => 'eicon-v-align-top',
				],
				'below'  => [
					'title' => esc_html__('Below', 'edumall-child'),
	...
	private function add_content_section()
	{
		...
		$repeater->add_control('avatar', [
			'label' => esc_html__('Avatar', 'edumall-child'),
			'type'  => Controls_Manager::MEDIA,
		]);

		$repeater->add_control('name', [
			'label'   => esc_html__('Name', 'edumall-child'),
			'type'    => Controls_Manager::TEXT,
			'default' => esc_html__('John Doe', 'edumall-child'),
		]);

		$repeater->add_control('position', [
			'label'   => esc_html__('Position', 'edumall-child'),
			'type'    => Controls_Manager::TEXT,
			'default' => esc_html__('CEO', 'edumall-child'),
		]);

		$repeater->add_control('rating', [
			'label' => esc_html__('Rating', 'edumall-child'),
			'type'  => Controls_Manager::NUMBER,
			'min'   => 0,
			'max'   => 5,
			'step'  => 0.1,
		...
		$this->add_control('items', [
			...
			'default'     => [
				[
					...
					'name'      => esc_html__('Frankie Kao', 'edumall-child'),
					'position'  => esc_html__('CEO', 'edumall-child'),
				],
				[
					'thumbnail' => ['url' => $placeholder_image_src],
					'content'   => esc_html__('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'edumall-child'),
		...
		$this->add_group_control(Group_Control_Image_Size::get_type(), [
			...
			'fields_options' => [
				'size' => [
					'label' => esc_html__('Thumbnail Size', 'edumall-child'),
				],
			],
		]);
		...
		$this->add_group_control(Group_Control_Image_Size::get_type(), [
			...
			'fields_options' => [
				'size' => [
					'label' => esc_html__('Avatar Size', 'edumall-child'),
				],
			],
		]);

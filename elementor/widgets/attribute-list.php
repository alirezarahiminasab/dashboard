...
class Widget_Attribute_List extends Base
{
	...
	{
		return esc_html__('Attribute List', 'edumall-child');
	}
	...
	protected function register_controls()
	{
		...
		$repeater->add_control('name', [
			...
			'default'     => esc_html__('Name', 'edumall-child'),
			'label_block' => true,
		]);

		$repeater->add_control('value', [
			'label' => esc_html__('Value', 'edumall-child'),
		...
		$this->add_control('items', [
			...
			'default'     => [
				[
					'name'  => esc_html__('Attribute #1', 'edumall-child'),
					'value' => esc_html__('Value #1', 'edumall-child'),
				],
				[
					'name'  => esc_html__('Attribute #2', 'edumall-child'),
					'value' => esc_html__('Value #2', 'edumall-child'),
				],
			],
			'title_field' => '{{{ name }}}',
		]);
				...
				<div class="list">
					...
					?>
							<div class="item">
								...
								<div class="value"><?php echo wp_kses($attribute['value'], 'edumall-default'); ?></div>
							</div>
					<?php
						}
					}

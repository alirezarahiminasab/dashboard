...
class Widget_Timeline extends Base
{
	...
	{
		return esc_html__('Timeline', 'edumall-child');
	}
	...
	protected function register_controls()
	{
		...
		$this->add_control('items', [
			...
			'default'     => [
				[
					'title'       => esc_html__('Step #1', 'edumall-child'),
					'description' => esc_html__('Suspe ndisse suscipit sagittis leo sit met condimentum estibulum issim Lorem ipsum dolor sit amet, consectetur cium', 'edumall-child'),
				],
				[
					'title'       => esc_html__('Step #2', 'edumall-child'),
					'description' => esc_html__('Suspe ndisse suscipit sagittis leo sit met condimentum estibulum issim Lorem ipsum dolor sit amet, consectetur cium', 'edumall-child'),
				],
				[
					'title'       => esc_html__('Step #3', 'edumall-child'),
					'description' => esc_html__('Suspe ndisse suscipit sagittis leo sit met condimentum estibulum issim Lorem ipsum dolor sit amet, consectetur cium', 'edumall-child'),
				],
				[
					'title'       => esc_html__('Step #4', 'edumall-child'),
					'description' => esc_html__('Suspe ndisse suscipit sagittis leo sit met condimentum estibulum issim Lorem ipsum dolor sit amet, consectetur cium', 'edumall-child'),
				],
			],
			'title_field' => '{{{ title }}}',
	...
	protected function render()
	{
		...
		$this->add_render_attribute('wrapper', 'class', 'edumall-timeline style-01');
?>
		<div <?php $this->print_attributes_string('wrapper'); ?>>
			<div class="timeline-line"></div>
			<?php if ($settings['items'] && count($settings['items']) > 0) { ?>
				<div class="timeline-list edumall-entrance-animation-queue">

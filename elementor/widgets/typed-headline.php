...
class Widget_Typed_Headline extends Base {
	...
	public function get_title() {
		return esc_html__( 'Typed Headline', 'edumall' );
	}
	...
	private function add_content_section() {
		...
		$this->add_control( 'before_text', [
			'label'       => esc_html__( 'Before Text', 'edumall' ),
			...
			'default'     => esc_html__( 'This page is', 'edumall' ),
			'placeholder' => esc_html__( 'Enter your headline', 'edumall' ),
			'label_block' => true,
			'separator'   => 'before',
		] );
		...
		$this->add_control( 'text', [
			...
			'placeholder'        => esc_html__( 'Enter each word in a separate line', 'edumall' ),
			'separator'          => 'none',
			'default'            => "Better\nBigger\nFaster",
		...
		$this->add_control( 'after_text', [
			...
			'placeholder' => __( 'Enter your headline', 'edumall' ),
			'label_block' => true,
			'separator'   => 'none',
		] );
	...
	private function add_headline_style_section() {
		$this->start_controls_section( 'headline_style_section', [
			'label' => esc_html__( 'Headline', 'edumall' ),
			'tab'   => Controls_Manager::TAB_STYLE,
		] );
		...
		$this->add_control( 'animated_text_heading', [
			'label'     => esc_html__( 'Animated Text', 'edumall' ),

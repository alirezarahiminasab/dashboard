...
class Widget_Typed_Headline extends Base
{
	...
	public function __construct($data = [], $args = null)
	{
		...
		wp_register_script('typed', EDUMALL_THEME_URI . '/assets/libs/typed/typed.min.js', array(), null, true);

		wp_register_script('edumall-widget-typed-headline', EDUMALL_ELEMENTOR_URI . '/assets/js/widgets/widget-typed-headline.js', array(
			'elementor-frontend',
			'typed',
		), null, true);
	}
	...
	{
		return esc_html__('Typed Headline', 'edumall-child');
	}
	...
	{
		return ['edumall-widget-typed-headline'];
	}
	...
	private function add_content_section()
	{
		...
		$this->add_control('before_text', [
			'label'       => esc_html__('Before Text', 'edumall-child'),
			...
			'default'     => esc_html__('This page is', 'edumall-child'),
			'placeholder' => esc_html__('Enter your headline', 'edumall-child'),
			'label_block' => true,
			'separator'   => 'before',
		]);
		...
		$this->add_control('text', [
			...
			'placeholder'        => esc_html__('Enter each word in a separate line', 'edumall-child'),
			'separator'          => 'none',
			'default'            => "Better\nBigger\nFaster",
		...
		$this->add_control('after_text', [
			'label'       => __('After Text', 'edumall-child'),
			'type'        => Controls_Manager::TEXT,
			'dynamic'     => [
				'active'     => true,
				'categories' => [
			...
			'placeholder' => __('Enter your headline', 'edumall-child'),
			'label_block' => true,
			'separator'   => 'none',
		]);
	...
	private function add_headline_style_section()
	{
		$this->start_controls_section('headline_style_section', [
			'label' => esc_html__('Headline', 'edumall-child'),
			'tab'   => Controls_Manager::TAB_STYLE,
		]);
		...
		$this->add_group_control(Group_Control_Typography::get_type(), [
			...
			'selector' => '{{WRAPPER}} .edumall-headline',
		]);
		...
		$this->add_control('blend_mode', [
			...
			'selectors' => [
				'{{WRAPPER}} .edumall-headline' => 'mix-blend-mode: {{VALUE}}',
			],
			'separator' => 'none',
		]);
		...
		$this->add_control('animated_text_heading', [
			'label'     => esc_html__('Animated Text', 'edumall-child'),
	...
	protected function render()
	{
		...
		$this->add_render_attribute('headline', 'class', 'edumall-headline');
?>

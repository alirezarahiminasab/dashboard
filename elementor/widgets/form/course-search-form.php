...
class Widget_Course_Search_Form extends Base
{
	...
	{
		return esc_html__('Course Search Form', 'edumall-child');
	}
	...
	private function add_content_section()
	{
		...
		$this->add_control('search_field_placeholder', [
			'label'       => esc_html__('Placeholder Text', 'edumall-child'),
	...
	private function add_field_style_section()
	{
		$this->start_controls_section('form_field_style_section', [
			'label' => esc_html__('Field', 'edumall-child'),
		...
		$this->start_controls_tab('field_colors_focus_tab', [
			'label' => esc_html__('Focus', 'edumall-child'),
		]);
	...
	protected function render()
	{
		...
		$placeholder_text = !empty($settings['search_field_placeholder']) ? $settings['search_field_placeholder'] : esc_attr_x('What do you want to learn?', 'placeholder', 'edumall-child');
		...
		$this->add_render_attribute('input', [
			...
			'type'        => 'search',
			'name'        => 'filter_name',
			'title'       => esc_attr__('Search', 'edumall-child'),
			'value'       => '',
		]);

		$form_action = get_post_type_archive_link(\Edumall_Tutor::instance()->get_course_type());
?>
		<form class="course-search-form" role="search" method="get" action="<?php echo esc_url($form_action); ?>">
			<label class="screen-reader-text"><?php esc_html_e('Search for:', 'edumall-child'); ?></label>
			<input <?php $this->print_render_attribute_string('input'); ?> />
			<button type="submit" class="search-submit">
				<span class="search-btn-icon far fa-search"></span>
				<span class="search-btn-text">
					<?php echo esc_html_x('Search', 'submit button', 'edumall-child'); ?>
				</span>
			</button>
		</form>
<?php

...
class Widget_Mailchimp_Form extends Form_Base
{
	...
	{
		return esc_html__('Mailchimp Form', 'edumall-child');
	}
	...
	private function add_content_section()
	{
		...
		$this->add_control('form_id', [
			'label'       => esc_html__('Form Id', 'edumall-child'),
			'description' => esc_html__('Input the id of form. Leave blank to show default form.', 'edumall-child'),

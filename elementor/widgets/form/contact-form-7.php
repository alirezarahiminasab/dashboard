...
class Widget_Contact_Form_7 extends Form_Base
{
	...
	{
		return esc_html__('Contact Form 7', 'edumall-child');
	}
	...
	private function get_form_list()
	{
		...
		if ($cf7) {
			...
			$forms[0] = esc_html__('No contact forms found', 'edumall-child');
		}
	...
	private function add_content_section()
	{
		...
		$this->add_control('form_id', [
			'label'   => esc_html__('Select Form', 'edumall-child'),
		...
		$this->add_control('style', [
			...
			'default'      => '01',
			'prefix_class' => 'edumall-contact-form-style-',
		]);
	...
	private function add_form_style_section()
	{
		$this->start_controls_section('form_style_section', [
			'label' => esc_html__('Form', 'edumall-child'),
		...
		$this->add_control(
			'column_gap',
			[
				'label'     => esc_html__('Columns Gap', 'edumall-child'),
		...
		$this->add_control(
			'row_gap',
			[
				'label'     => esc_html__('Rows Gap', 'edumall-child'),
				'type'      => Controls_Manager::SLIDER,
				'default'   => [
					'size' => 20,
				],
				...
				'selectors' => [
					'{{WRAPPER}} .form-item, {{WRAPPER}} .form-group' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function render()
	{
		...
		$this->add_render_attribute('box', 'class', 'edumall-contact-form-7');
?>

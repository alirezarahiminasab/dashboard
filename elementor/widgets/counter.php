...
class Widget_Counter extends Base
{
	...
	{
		return esc_html__('Modern Counter', 'edumall-child');
	}
	...
	private function add_content_section()
	{
		$this->start_controls_section('counter_section', [
			'label' => esc_html__('Counter', 'edumall-child'),
		]);
		...
		$this->add_control('number_heading', [
			'label'     => esc_html__('Number', 'edumall-child'),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		]);

		$this->add_control('starting_number', [
			'label'   => esc_html__('Starting Number', 'edumall-child'),
		...
		$this->add_control('ending_number', [
			'label'   => esc_html__('Ending Number', 'edumall-child'),
			'type'    => Controls_Manager::NUMBER,
			'default' => 100,
			'dynamic' => [
				'active' => true,
		...
		$this->add_control('prefix', [
			'label'       => esc_html__('Number Prefix', 'edumall-child'),
		...
		$this->add_control('suffix', [
			'label'       => esc_html__('Number Suffix', 'edumall-child'),
			'type'        => Controls_Manager::TEXT,
			'dynamic'     => [
				'active' => true,
			],
			'default'     => '',
			'placeholder' => esc_html__('Plus', 'edumall-child'),
		]);

		$this->add_control('duration', [
			'label'   => esc_html__('Animation Duration', 'edumall-child'),
			'type'    => Controls_Manager::NUMBER,
			'default' => 2000,
			'min'     => 100,
			'step'    => 100,
		...
		$this->add_control('thousand_separator', [
			'label'     => esc_html__('Thousand Separator', 'edumall-child'),
		...
		$this->add_control('thousand_separator_char', [
			'label'     => esc_html__('Separator', 'edumall-child'),
			'type'      => Controls_Manager::SELECT,
			'condition' => [
		...
		$this->add_control('title_text', [
			...
			'placeholder' => esc_html__('Cool Number', 'edumall-child'),
			'separator'   => 'before',
		]);

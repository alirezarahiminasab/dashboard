...
class Widget_Client_Logo extends Static_Grid
{
	...
	{
		return esc_html__('Client Logo', 'edumall-child');
	}
	...
	protected function register_controls()
	{
		...
		$this->add_control('hover', [
			'label'   => esc_html__('Hover Type', 'edumall-child'),
			'type'    => Controls_Manager::SELECT,
			'options' => [
				''          => esc_html__('None', 'edumall-child'),
				'grayscale' => esc_html__('Grayscale to normal', 'edumall-child'),
				'opacity'   => esc_html__('Opacity to normal', 'edumall-child'),
				'faded'     => esc_html__('Normal to opacity', 'edumall-child'),
			],
			'default' => '',
		]);
...
?>
		<div class="item">
			...
			<?php if (!empty($item['link']['url'])) { ?>
				...
				<div class="image">
					<img src="<?php echo esc_url($item['logo']['url']); ?>" alt="<?php esc_attr_e('Client Logo', 'edumall-child'); ?>">
				</div>

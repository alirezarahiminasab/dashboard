...
class Widget_Modern_Slider extends Carousel_Base
{
	...
	{
		return esc_html__('Modern Slider', 'edumall-child');
	}
...
?>
	...
	private function add_content_section()
	{
		...
		$this->add_control('layers_animation', [
			'label' => esc_html__('Layers Animation', 'edumall-child'),
		...
		$repeater->add_control('sub_title_heading', [
			'label'     => esc_html__('Sub Title', 'edumall-child'),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		]);
		...
		$repeater->add_control('sub_title', [
			...
			'placeholder' => esc_html__('Enter your sub title', 'edumall-child'),
			'default'     => '',
		]);
		...
		$repeater->add_control('background_animation', [
			'label'       => esc_html__('Background Animation', 'edumall-child'),
			'label_block' => true,
			'type'        => Controls_Manager::SELECT,
			'default'     => '',
			'options'     => [
				''          => esc_html__('None', 'edumall-child'),
				'ken-burns' => esc_html__('Ken Burns', 'edumall-child'),
			],
		]);
		...
		$repeater->add_group_control(Group_Control_Typography::get_type(), [
			...
			'label'    => esc_html__('Highlight Words Typography', 'edumall-child'),
			'selector' => '{{WRAPPER}} {{CURRENT_ITEM}} .title mark',
		]);

		$repeater->add_control('title_mark_color', [
			'label'     => esc_html__('Highlight Words Color', 'edumall-child'),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
		...
		$repeater->add_control('button_text_border_color', [
			'label'     => esc_html__('Line Color', 'edumall-child'),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
		...
		$repeater->add_control('button_hover_style_heading', [
			'label'     => esc_html__('Button Hover', 'edumall-child'),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		]);
	...
	protected function print_slides(array $settings)
	{
		foreach ($settings['slides'] as $slide) :
			...
			$this->add_render_attribute($item_key, 'class', [
				...
				'edumall-slide-bg-animation-' . $slide['background_animation'],
			]);
									...
									<?php if ('' !== $slide['sub_title']) : ?>
										...
										<div class="slide-layer-wrap sub-title-wrap">
											<div class="slide-layer">
												<h4 class="sub-title"><?php echo wp_kses($slide['sub_title'], 'edumall-default'); ?></h4>
											</div>
										</div>

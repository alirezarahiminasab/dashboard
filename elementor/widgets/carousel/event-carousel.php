...
class Widget_Event_Carousel extends Posts_Carousel_Base
{
	...
	{
		return esc_html__('Event Carousel', 'edumall-child');
	}
	...
	private function add_layout_section()
	{
		...
		$this->add_control('style', [
			...
			'options' => [
				'grid-01' => esc_html__('Grid 01', 'edumall-child'),
				'grid-02' => esc_html__('Grid 02', 'edumall-child'),
			],
			'default' => 'grid-01',
		]);
	...
	private function add_caption_style_section()
	{
		...
		$this->add_control('date_style_heading', [
			'label'     => esc_html__('Date Time', 'edumall-child'),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		]);

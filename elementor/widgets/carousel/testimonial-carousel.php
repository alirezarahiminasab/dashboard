...
class Widget_Testimonial_Carousel extends Static_Carousel
{
	...
	{
		return esc_html__('Testimonial Carousel', 'edumall-child');
	}
	...
	private function add_layout_section()
	{
		...
		$this->add_control('layout', [
			...
			'options'      => [
				...
				'image-top'     => esc_html__('Image Top Overlap', 'edumall-child'),
				'image-top-02'  => esc_html__('Image Top', 'edumall-child'),
				'image-above'   => esc_html__('Image Above', 'edumall-child'),
				'image-left'    => esc_html__('Image Left', 'edumall-child'),
			],
			'render_type'  => 'template',
			'prefix_class' => 'layout-',
		]);
		...
		$this->add_control('image_position', [
			'label'        => esc_html__('Info Position', 'edumall-child'),
		...
		$this->add_control('cite_layout', [
			'label'        => esc_html__('Cite Layout', 'edumall-child'),
			'label_block'  => false,
			'type'         => Controls_Manager::CHOOSE,
			'default'      => 'block',
			'options'      => [
	...
	private function add_content_style_section()
	{
		...
		$this->add_control('quote_icon_heading', [
			'label'     => esc_html__('Quote Icon', 'edumall-child'),
...
?>
	...
	?>
		<div class="tm-swiper tm-slider-widget edumall-testimonial-pagination style-01 edumall-thumbs-swiper" data-lg-items="3" data-lg-gutter="30" data-slide-to-clicked-slide="1" data-centered="1" data-loop="1" data-looped-slides="<?php echo esc_attr($this->slider_looped_slides); ?>">

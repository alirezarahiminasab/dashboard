...
class Widget_Popup_Video extends Base
{
	...
	{
		return esc_html__('Popup Video', 'edumall-child');
	}
	...
	private function add_video_section()
	{
		...
		$this->add_control('video_type', [
			...
			'default' => 'external',
			'options' => [
				'external' => esc_html__('External', 'edumall-child'),
				'hosted'   => esc_html__('Self Hosted', 'edumall-child'),
			],
		]);

		$this->add_control('hosted_url', [
			'label'      => esc_html__('Choose File', 'edumall-child'),
		...
		$this->add_control('video_url', [
			'label'       => esc_html__('Video Url', 'edumall-child'),
			'description' => esc_html__('Input Youtube video url or Vimeo video url. For e.g: "https://www.youtube.com/watch?v=XHOmBV4js_E"', 'edumall-child'),
		...
		$this->add_control('type', [
			...
			'default' => 'poster',
			'options' => [
				'poster' => esc_html__('Poster', 'edumall-child'),
				'button' => esc_html__('Button', 'edumall-child'),
			],
		]);

		$this->add_control('video_text', [
			'label'         => esc_html__('Video Text', 'edumall-child'),
		...
		$this->add_control('video_text_animate', [
			'label'        => esc_html__('Text Animate', 'edumall-child'),
			'type'         => Controls_Manager::SELECT,
			'options'      => [
				''             => esc_html__('None', 'edumall-child'),
				'animate-line' => esc_html__('Animate Line', 'edumall-child'),
			],
			'default'      => '',
		...
		$this->add_control('position', [
			'label'        => esc_html__('Icon Position', 'edumall-child'),
		...
		$this->add_control('poster', [
			'label'     => esc_html__('Poster Image', 'edumall-child'),
			'type'      => Controls_Manager::MEDIA,
			'default'   => [
		...
		$this->add_control('button_type', [
			'label'     => esc_html__('Button Type', 'edumall-child'),
			'type'      => Controls_Manager::SELECT,
			'default'   => '',
			'options'   => [
				''      => esc_html__('Default', 'edumall-child'),
				'image' => esc_html__('Image', 'edumall-child'),
			],
			'separator' => 'before',
		]);

		$this->add_control('button_image', [
			'label'     => esc_html__('Button Image', 'edumall-child'),
			'type'      => Controls_Manager::MEDIA,
			'default'   => [
		...
		$this->add_control('button_effect', [
			'label'        => esc_html__('Button Effect', 'edumall-child'),
			'type'         => Controls_Manager::SELECT,
			'default'      => '',
			'options'      => [
				''           => esc_html__('None', 'edumall-child'),
				'wave-pulse' => esc_html__('Wave Pulse', 'edumall-child'),
			],
	...
	private function add_button_style_section()
	{
		...
		$this->add_control('button_mask_heading', [
			'label'     => esc_html__('Mask', 'edumall-child'),
		...
		<div <?php $this->print_attributes_string('wrapper'); ?>>
			...
			<?php if ('hosted' === $settings['video_type']) : ?>
				<div <?php $this->print_attributes_string('video-inline') ?>>
					<video class="lg-video-object lg-html5 video-js vjs-default-skin" controls preload="none" src="<?php echo esc_url($video_url); ?>"></video>
				</div>
			<?php endif; ?>
		</div>
	<?php
		...
		<div class="video-button-play">
			...
			<div class="video-play video-play-image">
				<?php echo \Edumall_Image::get_elementor_attachment([
					...
					'attributes' => [
						'alt' => esc_attr__('Play Icon', 'edumall-child'),
					],
				]); ?>
			</div>
		</div>

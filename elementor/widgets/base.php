...
abstract class Base extends Widget_Base
{
	...
	{
		return 'edumall-badge ' . $this->get_icon_part();
	}
	...
	protected function get_render_icon($settings, $icon, $attributes = [], $svg = false, $color_prefix = 'icon')
	{
		...
		if ($svg === true) {
			$background_type = isset($settings["{$color_prefix}_color_type"]) ? $settings["{$color_prefix}_color_type"] : '';
...
<?php
	...
	protected function register_common_button_style_section()
	{
		...
		$this->add_group_control(Group_Control_Box_Shadow::get_type(), [
			...
			'selector' => '{{WRAPPER}} .edumall-box:hover div.tm-button, {{WRAPPER}} a.tm-button:hover',
		]);
		...
		$this->add_group_control(Group_Control_Text_Gradient::get_type(), [
			...
			'selector' => '{{WRAPPER}} .edumall-box:hover div.tm-button .button-text, {{WRAPPER}} a.tm-button:hover .button-text',
		]);
		...
		$this->add_group_control(Group_Control_Text_Gradient::get_type(), [
			...
			'selector'  => '{{WRAPPER}} .edumall-box:hover div.tm-button .button-icon, {{WRAPPER}} a.tm-button:hover .button-icon',
			'condition' => $icon_condition,
		]);

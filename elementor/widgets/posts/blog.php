...
class Widget_Blog extends Posts_Base
{
	...
	{
		return esc_html__('Blog', 'edumall-child');
	}
	...
	private function add_layout_section()
	{
		...
		$this->add_control('layout', [
			...
			'options' => [
				...
				'masonry'           => esc_html__('Masonry', 'edumall-child'),
				'metro'             => esc_html__('Metro', 'edumall-child'),
				'zigzag'            => esc_html__('Zigzag', 'edumall-child'),
				'list-01'           => esc_html__('List - Large Image', 'edumall-child'),
				'list-02'           => esc_html__('List - Left Image', 'edumall-child'),
				'list-03'           => esc_html__('List - Simple', 'edumall-child'),
				'one-left-featured' => esc_html__('1 Left Featured', 'edumall-child'),
			],
			'default' => 'grid',
		]);
		...
		$this->add_control('show_thumbnail', [
			'label'        => esc_html__('Show Thumbnail', 'edumall-child'),
		...
		$this->add_control('metro_image_size_width', [
			'label'     => esc_html__('Image Size', 'edumall-child'),
		...
		$this->add_control('metro_image_ratio', [
			'label'     => esc_html__('Image Ratio', 'edumall-child'),
		...
		$this->add_control('thumbnail_default_size', [
			'label'        => esc_html__('Use Default Thumbnail Size', 'edumall-child'),
			'type'         => Controls_Manager::SWITCHER,
			'default'      => '1',
			'return_value' => '1',
			'separator'    => 'before',
	...
	private function add_banners_section()
	{
		$this->start_controls_section('banners_section', [
			'label'     => esc_html__('Banners', 'edumall-child'),
			'condition' => [
				'layout' => ['masonry'],
			],
		]);
		...
		$banner_repeater->add_control('template_id', [
			'label'        => esc_html__('Choose Template', 'edumall-child'),
		...
		$banner_repeater->add_control('position', [
			'label' => esc_html__('After Post Number', 'edumall-child'),
			'type'  => Controls_Manager::NUMBER,
			'step'  => 1,
		]);
	...
	private function add_caption_popover()
	{
		$this->add_control('show_caption', [
			'label'        => esc_html__('Caption', 'edumall-child'),
			'type'         => Controls_Manager::POPOVER_TOGGLE,
			'label_off'    => esc_html__('Default', 'edumall-child'),
			'label_on'     => esc_html__('Custom', 'edumall-child'),
			'return_value' => 'yes',
			'condition'    => [
		...
		$this->add_control('show_caption_category', [
			'label'     => esc_html__('Category', 'edumall-child'),
			'type'      => Controls_Manager::SWITCHER,
		...
		$this->add_control('show_caption_excerpt', [
			'label'     => esc_html__('Excerpt', 'edumall-child'),
			'type'      => Controls_Manager::SWITCHER,
			'label_on'  => esc_html__('Show', 'edumall-child'),
			'label_off' => esc_html__('Hide', 'edumall-child'),
			'default'   => 'yes',
		...
		$this->add_control('excerpt_length', [
			'label'     => esc_html__('Excerpt Length', 'edumall-child'),
			'type'      => Controls_Manager::NUMBER,
			'min'       => 5,
			'condition' => [
		...
		$this->add_control('show_caption_read_more', [
			'label'     => esc_html__('Read More', 'edumall-child'),
			'type'      => Controls_Manager::SWITCHER,
			'label_on'  => esc_html__('Show', 'edumall-child'),
			'label_off' => esc_html__('Hide', 'edumall-child'),
			'default'   => 'yes',
		...
		$this->add_control('read_more_text', [
			'label'     => esc_html__('Read More Text', 'edumall-child'),
			'type'      => Controls_Manager::TEXT,
			'default'   => esc_html__('Read More', 'edumall-child'),
			'condition' => [
		...
		$this->add_control('show_caption_meta', [
			'label'       => esc_html__('Meta', 'edumall-child'),
			'label_block' => true,
			...
			'options'     => [
				...
				'views'    => esc_html__('View Count', 'edumall-child'),
				'comments' => esc_html__('Comment Count', 'edumall-child'),
			],
		]);
	...
	private function add_overlay_popover()
	{
		$this->add_control('show_overlay', [
			'label'        => esc_html__('Overlay', 'edumall-child'),
			'type'         => Controls_Manager::POPOVER_TOGGLE,
			'label_off'    => esc_html__('Default', 'edumall-child'),
			'label_on'     => esc_html__('Custom', 'edumall-child'),
			'return_value' => 'yes',
		...
		$this->add_control('overlay_style', [
			...
			'type'    => Controls_Manager::SELECT,
			'options' => [
				'float' => esc_html__('Float', 'edumall-child'),
			],
			'default' => 'float',
		]);
		...
		$overlay_meta_repeater->add_control('meta', [
			'label'       => esc_html__('Select Meta', 'edumall-child'),
			'label_block' => true,
			'type'        => Controls_Manager::SELECT,
			'default'     => 'date',
			'options'     => [
				'author'   => esc_html__('Author', 'edumall-child'),
				'date'     => esc_html__('Date', 'edumall-child'),
				'comments' => esc_html__('Comments', 'edumall-child'),
			],
		]);

		$this->add_control('overlay_meta_data', [
			'label'         => esc_html__('Meta Data', 'edumall-child'),
			'type'          => Controls_Manager::REPEATER,
	...
	private function add_grid_section()
	{
		$this->start_controls_section('grid_options_section', [
			'label'     => esc_html__('Grid Options', 'edumall-child'),
			'condition' => [
				'layout' => [
					'grid',
					'masonry',
		...
		$this->add_responsive_control('grid_columns', [
			'label'          => esc_html__('Columns', 'edumall-child'),
			'type'           => Controls_Manager::NUMBER,
			'min'            => 1,
			'max'            => 12,
			'step'           => 1,
		...
		$this->add_responsive_control('grid_gutter', [
			'label'   => esc_html__('Gutter', 'edumall-child'),
			'type'    => Controls_Manager::NUMBER,
			'min'     => 0,
			'max'     => 200,
			'step'    => 1,
		...
		$metro_layout_repeater->add_control('size', [
			'label'   => esc_html__('Item Size', 'edumall-child'),
			'type'    => Controls_Manager::SELECT,
			'default' => '1:1',
		...
		$this->add_control('grid_metro_layout', [
			'label'       => esc_html__('Metro Layout', 'edumall-child'),
			'type'        => Controls_Manager::REPEATER,
	...
	private function add_thumbnail_style_section()
	{
		$this->start_controls_section('thumbnail_style_section', [
			'label' => esc_html__('Thumbnail', 'edumall-child'),
			'tab'   => Controls_Manager::TAB_STYLE,
		]);
	...
	private function add_caption_style_section()
	{
		...
		$this->add_responsive_control('text_align', [
			'label'                => esc_html__('Text Align', 'edumall-child'),

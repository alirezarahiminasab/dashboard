...
class Widget_Course extends Posts_Base
{
	...
	{
		return esc_html__('Courses', 'edumall-child');
	}
	...
	private function add_layout_section()
	{
		...
		$this->add_control('style', [
			...
			'type'    => Controls_Manager::SELECT,
			'options' => [
				'grid-01' => esc_html__('01', 'edumall-child'),
				'grid-02' => esc_html__('02', 'edumall-child'),
			],
			'default' => 'grid-01',
		]);

		$this->add_responsive_control('zigzag_height', [
			'label'     => esc_html__('Zigzag Height', 'edumall-child'),
		...
		$this->add_control('zigzag_reversed', [
			'label'     => esc_html__('Zigzag Reversed?', 'edumall-child'),
	...
	private function add_caption_popover()
	{
		...
		$this->add_control('show_caption_level', [
			'label'     => esc_html__('Instructor', 'edumall-child'),
			'type'      => Controls_Manager::SWITCHER,
		...
		$this->add_control('show_caption_date', [
			'label'     => esc_html__('Date', 'edumall-child'),
			'type'      => Controls_Manager::SWITCHER,
			'label_on'  => esc_html__('Show', 'edumall-child'),
			'label_off' => esc_html__('Hide', 'edumall-child'),
		]);
		...
		$this->add_control('show_caption_meta', [
			...
			'options'     => [
				'lessons'  => esc_html__('Lessons', 'edumall-child'),
				'students' => esc_html__('Students', 'edumall-child'),
				'duration' => esc_html__('Duration', 'edumall-child'),
				'category' => esc_html__('Category', 'edumall-child'),
			],
		]);
		...
		$this->add_control('show_caption_buttons', [
			'label'     => esc_html__('Buttons', 'edumall-child'),
			'type'      => Controls_Manager::SWITCHER,
			'label_on'  => esc_html__('Show', 'edumall-child'),
			'label_off' => esc_html__('Hide', 'edumall-child'),
		]);
		...
		/*$this->add_control( 'purchase_button_text', [
			'label'       => esc_html__( 'Purchase Button', 'edumall-child' ),
			'label_block' => true,
			'description' => esc_html__( 'Custom text for purchase button.', 'edumall-child' ),
	...
	private function add_caption_style_section()
	{
		...
		$this->add_control('caption_colors_hr', [
			'label'     => esc_html__('Colors', 'edumall-child'),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		]);

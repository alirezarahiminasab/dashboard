...
class Widget_Portfolio extends Posts_Base
{
	...
	{
		return esc_html__('Portfolio', 'edumall-child');
	}
	...
	private function add_layout_section()
	{
		...
		$this->add_control('overlay_style', [
			...
			'options' => [
				''              => esc_html__('None', 'edumall-child'),
				'faded'         => esc_html__('Faded 01', 'edumall-child'),
				'faded-02'      => esc_html__('Faded 02', 'edumall-child'),
				'faded-04'      => esc_html__('Faded 04', 'edumall-child'),
				'colored-faded' => esc_html__('Colored Faded', 'edumall-child'),
				'movement'      => esc_html__('Movement', 'edumall-child'),
				'flat'          => esc_html__('Flat', 'edumall-child'),
				'float'         => esc_html__('Float', 'edumall-child'),
				'huge'          => esc_html__('Huge', 'edumall-child'),
			],
			'default' => '',
		]);
		...
		$this->add_control('overlay_colored_faded_info', [
			...
			'raw'             => esc_html__('To choose overlay color & skin for each post item then please edit them & go to Page Options box & select Portfolio tab.', 'edumall-child'),

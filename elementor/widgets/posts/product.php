...
class Widget_Product extends Posts_Base
{
	...
	{
		return esc_html__('Product', 'edumall-child');
	}
	...
	protected function render()
	{
		...
		$this->add_render_attribute('wrapper', 'class', 'edumall-grid-wrapper edumall-product style-grid');
...
<?php
	...
	private function add_caption_style_section()
	{
		...
		$this->add_control('caption_title_heading', [
			'label'     => esc_html__('Product Name', 'edumall-child'),
		...
		$this->add_control('caption_price_heading', [
			'label'     => esc_html__('Product Price', 'edumall-child'),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		]);
		...
		$this->add_group_control(Group_Control_Typography::get_type(), [
			...
			'label'    => esc_html__('Decimals Typography', 'edumall-child'),
		...
		$this->start_controls_tab('caption_regular_price_tab', [
			'label' => esc_html__('Regular', 'edumall-child'),
		]);
		...
		$this->add_control('caption_regular_price_decimals_color', [
			'label'     => esc_html__('Decimals Color', 'edumall-child'),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
		...
		$this->start_controls_tab('caption_sale_price_tab', [
			'label' => esc_html__('Sale', 'edumall-child'),
		]);

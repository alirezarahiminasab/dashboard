...
class Widget_Course_Languages extends Terms_Base
{
	...
	{
		return esc_html__('Course Languages', 'edumall-child');
	}
...
?>
	...
	private function print_grid()
	{
		...
		?>
			<div class="grid-item">
				<a href="<?php echo esc_url($link); ?>" class="edumall-box course-language-wrapper cat-link link-secret">
					...
					<div class="course-language-caption">
						<h5 class="course-language-name">
							<?php printf(esc_html__('%s Courses', 'edumall-child'), $term->name); ?>
						</h5>
						<div class="course-language-info">
							...
							<div class="course-language-count">
								<?php printf(esc_html(_n('%s program', '%s programs', $course_count, 'edumall-child')), number_format_i18n($course_count)); ?>
							</div>
						</div>
					</div>
				</a>
	...
	private function print_metro_grid()
	{
		...
		?>
			<div <?php $this->print_render_attribute_string($item_key); ?>>
				<a href="<?php echo esc_url($link); ?>" class="course-language-wrapper edumall-box cat-link link-secret">

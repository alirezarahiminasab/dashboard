...
class Widget_Course_Category_Cards extends Base
{
	...
	{
		return esc_html__('Course Category Cards', 'edumall-child');
	}
	...
	private function add_layout_section()
	{
		...
		$this->add_control('show_description', [
			'label' => esc_html__('Show Description', 'edumall-child'),
		...
		$this->add_control('categories', [
			'label'       => esc_html__('Select Categories', 'edumall-child'),
	...
	private function card_style_section()
	{
		$this->start_controls_section('card_style_section', [
			'label' => esc_html__('Card', 'edumall-child'),
	...
	private function caption_style_section()
	{
		...
		$this->add_control('cat_name_hr', [
			'label'     => esc_html__('Category Name', 'edumall-child'),
		...
		$this->add_control('cat_description_hr', [
			'label'     => esc_html__('Category Description', 'edumall-child'),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
			'condition' => [
		...
		$this->add_control('cat_name_arrow_color', [
			'label'     => esc_html__('Arrow', 'edumall-child'),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [

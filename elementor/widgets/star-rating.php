...
class Widget_Star_Rating extends Base
{
	...
	{
		return esc_html__('Star Rating', 'edumall-child');
	}
	...
	private function add_content_section()
	{
		...
		$this->add_control('rating_count', [
			'label'   => esc_html__('Rating Count', 'edumall-child'),
			'type'    => Controls_Manager::NUMBER,
			'dynamic' => [
				'active' => true,
			],
		...
		$this->add_control('star_style', [
			'label'   => esc_html__('Star Style', 'edumall-child'),
		...
		<div <?php $this->print_attributes_string('wrapper'); ?>>
			<div class="rating-wrap">
				...
				<?php if (!empty($settings['rating_count'])) : ?>
					<div class="rating-count"><?php printf('(%1$s)', number_format_i18n($settings['rating_count'])); ?></div>
				<?php endif; ?>
			</div>

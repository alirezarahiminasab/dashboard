...
class Widget_Image_Layers extends Base
{
	...
	{
		return esc_html__('Image Layers', 'edumall-child');
	}
	...
	private function add_artboard_section()
	{
		$this->start_controls_section('artboard_section', [
			'label' => esc_html__('Artboard', 'edumall-child'),
		]);
	...
	private function add_layers_section()
	{
		$this->start_controls_section('layers_section', [
			'label' => esc_html__('Layers', 'edumall-child'),
		]);

		$repeater = new Repeater();

		$repeater->add_control('static', [
			'label' => esc_html__('Static Layer', 'edumall-child'),
		...
		$repeater->start_controls_tab('layer_loop_tab', [
			'label' => esc_html__('Loop', 'edumall-child'),
		]);
		...
		$repeater->add_control('loop', [
			...
			'options' => [
				...
				'rotate'          => esc_html__('Rotate', 'edumall-child'),
				'move-horizontal' => esc_html__('Move - Horizontal', 'edumall-child'),
				'move-vertical'   => esc_html__('Move - Vertical', 'edumall-child'),
			],
			'default' => '',
		]);

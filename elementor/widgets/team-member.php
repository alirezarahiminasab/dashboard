...
class Widget_Team_Member extends Base
{
	...
	{
		return esc_html__('Team Member', 'edumall-child');
	}
	...
	private function add_content_section()
	{
		...
		$this->add_control('style', [
			...
			'prefix_class' => 'edumall-team-member-style-',
		]);
		...
		$this->add_control('profile', [
			'label'         => esc_html__('Profile', 'edumall-child'),
		...
		$this->add_control('social_networks', [
			'label'       => esc_html__('Social Networks', 'edumall-child'),
			'type'        => Controls_Manager::REPEATER,
			'fields'      => $repeater->get_controls(),
			'default'     => [
				[
					'title' => esc_html__('Facebook', 'edumall-child'),
					'link'  => [
						'url'         => '#',
						'is_external' => true,
						'nofollow'    => true,
				...
				[
					'title' => esc_html__('Twitter', 'edumall-child'),
					'link'  => [
						'url'         => '#',
						'is_external' => true,
						'nofollow'    => true,
				...
				[
					'title' => esc_html__('Instagram', 'edumall-child'),
					'link'  => [
						'url'         => '#',
						'is_external' => true,
						'nofollow'    => true,
				...
				[
					'title' => esc_html__('Youtube Channel', 'edumall-child'),
					'link'  => [
						'url'         => '#',
						'is_external' => true,
						'nofollow'    => true,
	...
	protected function render()
	{
		...
		$this->add_render_attribute('wrapper', 'class', 'tm-team-member edumall-box');
?>
					...
					<div class="info">
						...
						<?php if ($settings['content'] !== '') : ?>
							<div class="description">
								<?php echo wp_kses($settings['content'], 'edumall-default'); ?>
							</div>
						<?php endif; ?>
					</div>
				<?php endif; ?>

...
class Widget_Tabs extends Base
{
	...
	{
		return esc_html__('Advanced Tabs', 'edumall-child');
	}
	...
	private function add_content_section()
	{
		...
		$repeater->add_control('title', [
			...
			'default'     => esc_html__('Tab Title', 'edumall-child'),
			'label_block' => true,
			'dynamic'     => [
				'active' => true,
			],
		...
		$repeater->add_control('content_type', [
			'label'       => esc_html__('Content Type', 'edumall-child'),
			...
			'options'     => [
				'content'  => [
					'title' => esc_html__('Content', 'edumall-child'),
					'icon'  => 'eicon-edit',
				],
				'template' => [
					'title' => esc_html__('Saved Template', 'edumall-child'),
		...
		$this->add_control('items', [
			...
			'default'     => [
				[
					'title'   => esc_html__('Tab Title #1', 'edumall-child'),
				...
				[
					'title'   => esc_html__('Tab Title #2', 'edumall-child'),
					'content' => esc_html__('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'edumall-child'),
				],
				[
					'title'   => esc_html__('Tab Title #3', 'edumall-child'),
					'content' => esc_html__('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'edumall-child'),
				],
			],
			'title_field' => '{{{ title }}}',
		...
		$this->add_control('type', [
			...
			'default'      => 'horizontal',
			'options'      => [
				'horizontal' => esc_html__('Horizontal', 'edumall-child'),
				'vertical'   => esc_html__('Vertical', 'edumall-child'),
			],
		...
		$this->add_control('nav_position_reversed', [
			'label'     => esc_html__('Nav Position Reversed?', 'edumall-child'),
	...
	private function add_styling_section()
	{
		...
		$this->add_control('nav_width', [
			'label'      => esc_html__('Nav Width', 'edumall-child'),
		...
		$this->add_group_control(Group_Control_Text_Gradient::get_type(), [
			'name'     => 'active_icon',
			'selector' => '{{WRAPPER}} .active > .edumall-tab-title .icon',
		]);
		...
		$this->add_group_control(Group_Control_Text_Gradient::get_type(), [
			'name'     => 'active_title',
			'selector' => '{{WRAPPER}} .active > .edumall-tab-title .nav-tab-title',
		]);
		...
		$this->add_group_control(Group_Control_Text_Gradient::get_type(), [
			...
			'selector' => '{{WRAPPER}} .active > .edumall-tab-title .nav-tab-description',
		]);
		...
		$this->add_group_control(Group_Control_Typography::get_type(), [
			...
			'label'    => esc_html__('Desktop Title Typography', 'edumall-child'),
			'selector' => '{{WRAPPER}} .edumall-desktop-heading',
		]);

		$this->add_group_control(Group_Control_Typography::get_type(), [
			'name'     => 'mobile_title_typography',
			'label'    => esc_html__('Mobile Title Typography', 'edumall-child'),
			'selector' => '{{WRAPPER}} .edumall-mobile-heading',
		]);

		$this->add_group_control(Group_Control_Typography::get_type(), [
			'name'     => 'description_typography',
			'label'    => esc_html__('Description Typography', 'edumall-child'),
			'selector' => '{{WRAPPER}} .nav-tab-description',
		]);
				...
				<a href="javascript:void(0);" class="edumall-tab-title edumall-desktop-heading">
					...
					<div class="nav-tab-heading">
						...
						<?php if (isset($tab['description']) && '' !== $tab['description']) : ?>
							<div class="nav-tab-description"><?php echo wp_kses($tab['description'], $title_kses); ?></div>
						<?php endif; ?>
					</div>
				</a>
			</li>

...
class Widget_Accordion extends Base {
	...
	public function get_title() {
		return esc_html__( 'Modern Accordion/Toggle', 'edumall' );
	}
	...
	private function add_content_section() {
		...
		$this->add_control( 'type', [
			...
			'type'    => Controls_Manager::SELECT,
			'options' => [
				'accordion' => esc_html__( 'Accordion', 'edumall' ),
				'toggle'    => esc_html__( 'Toggle', 'edumall' ),
			],
			'default' => 'accordion',
		] );

		$this->add_control( 'active_first_item', [
			'label'              => esc_html__( 'Active First Item', 'edumall' ),
		...
		$repeater->add_control( 'title', [
			...
			'default'     => esc_html__( 'Accordion Title', 'edumall' ),
			'label_block' => true,
			'dynamic'     => [
				'active' => true,
			],
		...
		$repeater->add_control( 'content', [
			...
			'default' => esc_html__( 'Accordion Content', 'edumall' ),
		] );
		...
		$this->add_control( 'items', [
			...
			'default'     => [
				[
					'title'   => esc_html__( 'Accordion #1', 'edumall' ),
				...
				[
					'title'   => esc_html__( 'Accordion #2', 'edumall' ),
					'content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'edumall' ),
				],
				[
					'title'   => esc_html__( 'Accordion #3', 'edumall' ),
					'content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'edumall' ),
				],
			],
			'title_field' => '{{{ title }}}',
		...
		$this->add_control( 'active_icon', [
			'label'       => esc_html__( 'Active Icon', 'edumall' ),
			'type'        => Controls_Manager::ICONS,
			'default'     => [
				'value'   => 'fa-solid fa-minus-circle',
				'library' => 'fa-solid',
			],
			'recommended' => [
				'fa-solid'   => [
	...
	private function add_icon_style_section() {
		...
		$this->start_controls_tab( 'icon_active_color_tab', [
			'label' => esc_html__( 'Active', 'edumall' ),
		] );
	...
	protected function content_template() {
		...
		view.addRenderAttribute( 'wrapper', 'class', 'edumall-accordion' );
		...
		if ( iconHTML.rendered ) {
			view.addRenderAttribute( 'wrapper', 'class', 'edumall-accordion-icon-' + settings.icon_align);
		}

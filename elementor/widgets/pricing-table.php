...
class Widget_Pricing_Table extends Base
{
	...
	{
		return esc_html__('Modern Pricing', 'edumall-child');
	}
	...
	private function add_header_section()
	{
		$this->start_controls_section('header_section', [
			'label' => esc_html__('Header', 'edumall-child'),
		]);

		$this->add_control('heading', [
			'label'   => esc_html__('Title', 'edumall-child'),
			'type'    => Controls_Manager::TEXT,
			'default' => esc_html__('Enter your title', 'edumall-child'),
		]);
		...
		$this->add_control('heading_tag', [
			'label'   => esc_html__('Heading Tag', 'edumall-child'),
			'type'    => Controls_Manager::SELECT,
			'options' => [
				'h2' => 'H2',
				'h3' => 'H3',
	...
	private function add_pricing_section()
	{
		$this->start_controls_section('pricing_section', [
			'label' => esc_html__('Pricing', 'edumall-child'),
		]);

		$this->add_control('currency', [
			'label'   => esc_html__('Currency', 'edumall-child'),
			'type'    => Controls_Manager::TEXT,
			'default' => '$',
		]);

		$this->add_control('price', [
			'label'   => esc_html__('Price', 'edumall-child'),
			'type'    => Controls_Manager::TEXT,
			'default' => '39.99',
		]);

		$this->add_control('period', [
			'label'   => esc_html__('Period', 'edumall-child'),
			'type'    => Controls_Manager::TEXT,
			'default' => esc_html__('Monthly', 'edumall-child'),
		]);
	...
	private function add_features_section()
	{
		$this->start_controls_section('features_section', [
			'label' => esc_html__('Features', 'edumall-child'),
		]);
	...
	private function add_footer_section()
	{
		$this->start_controls_section('footer_section', [
			'label' => esc_html__('Footer', 'edumall-child'),
		]);
	...
	private function add_ribbon_section()
	{
		$this->start_controls_section('ribbon_section', [
			'label' => esc_html__('Ribbon', 'edumall-child'),
		]);

		$this->add_control('show_ribbon', [
			'label' => esc_html__('Show', 'edumall-child'),
		...
		$this->add_control('ribbon_title', [
			'label'     => esc_html__('Title', 'edumall-child'),
			'type'      => Controls_Manager::TEXT,
			'default'   => esc_html__('Popular', 'edumall-child'),
			'condition' => [
				'show_ribbon' => 'yes',
			],
		]);
	...
	private function add_content_style_section()
	{
		...
		$this->add_group_control(Group_Control_Typography::get_type(), [
			'name'     => 'title',
			'label'    => esc_html__('Title Typography', 'edumall-child'),
		...
		$this->add_control('ribbon_primary_color', [
			'label'     => esc_html__('Primary', 'edumall-child'),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => [
		...
		$this->add_control('ribbon_secondary_color', [
			'label'     => esc_html__('Secondary', 'edumall-child'),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => [

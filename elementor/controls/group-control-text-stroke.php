...
class Group_Control_Text_Stroke extends Group_Control_Base
{
	...
	protected function init_fields()
	{
		...
		// Divider.
		$fields['fill'] = [
			'label'                => esc_html__('Fill', 'edumall-child'),
			'label_block'          => false,
			'type'                 => Controls_Manager::CHOOSE,
			'options'              => array(
				'none'    => [
					'title' => esc_html__('Transparent', 'edumall-child'),
					'icon'  => 'eicon-ban',
				],
				'initial' => [
					'title' => esc_html__('Normal', 'edumall-child'),
			...
			'selectors'            => [
				'{{SELECTOR}}' => '-webkit-text-fill-color: {{VALUE}};',
			],
		];
	...
	protected function get_default_options()
	{
		return [
			'popover' => [
				'starter_title' => _x('Text Stroke', 'Text Stroke Control', 'edumall-child'),
				'starter_name'  => 'enable',
				'starter_value' => 'yes',
				'settings'      => [
					'render_type' => 'ui',

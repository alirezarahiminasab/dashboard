...
class Font_Awesome_Pro
{
	...
	public function replace_font_awesome_pro($settings)
	{
		...
		$icons['fa-regular'] = [
			'name'          => 'fa-regular',
			'label'         => esc_html__('Font Awesome - Regular Pro', 'edumall-child'),
			'url'           => false,
			'enqueue'       => false,
			'prefix'        => 'fa-',
			'displayPrefix' => 'far',
		...
		$icons['fa-solid'] = [
			'name'          => 'fa-solid',
			'label'         => esc_html__('Font Awesome - Solid Pro', 'edumall-child'),
			'url'           => false,
			'enqueue'       => false,
			'prefix'        => 'fa-',
			'displayPrefix' => 'fas',
		...
		$icons['fa-brands'] = [
			'name'          => 'fa-brands',
			'label'         => esc_html__('Font Awesome - Brands Pro', 'edumall-child'),
			'url'           => false,
			'enqueue'       => false,
			'prefix'        => 'fa-',
			'displayPrefix' => 'fab',
		...
		$icons['fa-light'] = [
			'name'          => 'fa-light',
			'label'         => esc_html__('Font Awesome - Light Pro', 'edumall-child'),
			'url'           => false,
			'enqueue'       => false,
			'prefix'        => 'fa-',
			'displayPrefix' => 'fal',
		...
		$icons['fa-duotone'] = [
			'name'          => 'fa-duotone',
			'label'         => esc_html__('Font Awesome - Duotone Pro', 'edumall-child'),
			'url'           => false,
			'enqueue'       => false,
			'prefix'        => 'fa-',
			'displayPrefix' => 'fad',
	...
	{
		wp_enqueue_style('font-awesome-pro', EDUMALL_THEME_URI . '/assets/fonts/awesome/css/fontawesome-all.min.css', null, '5.10.0');
	}
}

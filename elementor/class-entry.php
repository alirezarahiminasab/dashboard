...
final class Entry
{
	 ...
	 */
	const RECOMMENDED_VERSION = '3.7.7';
	...
	public function admin_notice_missing_main_plugin()
	{
		...
		$message = sprintf(
			...
			esc_html__('"%1$s" requires "%2$s" to be installed and activated.', 'edumall-child'),
			'<strong>' . esc_html__('Edumall', 'edumall-child') . '</strong>',
			'<strong>' . esc_html__('Elementor', 'edumall-child') . '</strong>'
		);
	...
	public function admin_notice_minimum_elementor_version()
	{
		...
		$message = sprintf(
			...
			esc_html__('"%1$s" requires "%2$s" version %3$s or greater.', 'edumall-child'),
			'<strong>' . esc_html__('Edumall', 'edumall-child') . '</strong>',
			'<strong>' . esc_html__('Elementor', 'edumall-child') . '</strong>',

...
<div class="entry-speakers border-section">
	<h3 class="entry-event-heading entry-event-heading-speakers"><?php esc_html_e('Our Speakers', 'edumall-child'); ?></h3>
	<div class="tm-swiper tm-slider event-speakers-slider" data-lg-items="5" data-md-items="3" data-sm-items="2" data-lg-gutter="30">
					...
					<?php foreach ($speakers as $speaker) : ?>
						...
						<div class="swiper-slide">
							<div class="speaker-item">
								...
								<div class="speaker-description"><?php echo esc_html($speaker->description); ?></div>
							</div>
						</div>
					<?php endforeach; ?>
				</div>

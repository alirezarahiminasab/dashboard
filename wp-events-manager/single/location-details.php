...
$holder      = get_post_meta(get_the_ID(), 'tp_event_holder', true);
...
<div class="event-location-details">
		...
		<div class="entry-event-location-address">
			...
			<p class="event-google-map-link">
				<a href="<?php echo esc_url('https://www.google.com/maps/search/?api=1&query=' . $location); ?>" class="link-transition-01">
					<?php esc_html_e('+ Google Map', 'edumall-child'); ?><?php /*@todo fix link */ ?>
				</a>
			</p>
		</div>
	<?php endif; ?>
	...
	<?php if (!empty($phone_number)) : ?>
		<div class="entry-event-contact-info entry-event-phone-number">
			<span class="meta-label"><?php esc_html_e('Phone Number', 'edumall-child'); ?></span>
	...
	<?php if (!empty($website)) : ?>
		<div class="entry-event-contact-info entry-event-website">
			<span class="meta-label"><?php esc_html_e('Website', 'edumall-child'); ?></span>
			<span class="meta-value"><?php echo esc_html($website); ?></span>
		</div>
	<?php endif; ?>

	<?php if (!empty($holder)) : ?>
		<div class="entry-event-contact-info entry-event-holder">
			<span class="meta-label"><?php esc_html_e('Holder', 'edumall-child'); ?></span>
			<span class="meta-value"><?php echo esc_html($holder); ?></span>
		</div>
	<?php endif; ?>

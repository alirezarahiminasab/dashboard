...
<article id="tp_event-<?php the_ID(); ?>" <?php post_class('tp_single_event'); ?>>
	...
	<div class="summary entry-summary">
		...
		<div class="entry-header">
			<h3 class="entry-event-heading entry-event-heading-about"><?php esc_html_e('About The Event', 'edumall-child'); ?></h3>
		...
		<div class="entry-event-location border-section">
			<h3 class="entry-event-heading entry-event-heading-location"><?php esc_html_e('Location', 'edumall-child'); ?></h3>

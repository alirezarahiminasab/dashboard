...
<div class="event-meta">
	<div class="meta-item">
		<span class="meta-label"><i class="meta-label-icon fa-light fa-clock"></i></span>
		<span class="meta-value"><?php echo esc_html( $time_start . ' - ' . $time_end ); ?></span>
	</div>
	<div class="meta-item">
		<span class="meta-label"><i class="meta-label-icon fa-light fa-calendar"></i></span>
		<span class="meta-value"><?php echo esc_html( $date_string ); ?></span>
	</div>
	<?php if ( $location ) : ?>
		<div class="meta-item">
			<span class="meta-label"><i class="meta-label-icon fa-light fa-map-marker-alt"></i></span>

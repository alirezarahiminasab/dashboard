...
$button_classes = 'edumall-course-wishlist-btn wishlist-button-02';
...
$button_text            = __('Add to wishlist', 'edumall-child');

if ($is_wishlisted) {
	$button_wrapper_classes = 'added';
	$button_classes         .= ' has-wish-listed';
	$button_text            = __('Remove from wishlist', 'edumall-child');
}

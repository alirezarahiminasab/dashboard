...
$instructor_video = CourseExtend::get_instructor_video_story($user_id)['result'] ? CourseExtend::get_instructor_video_story($user_id)['url'] : '';
...
<div class="tutor-dashboard-header-wrap">
	<div class="tutor-dashboard-header">
		<div class="tutor-dashboard-breadcrumb">
			...
			<img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/arrow-left-white.png' ?>" alt="">
			<p class="item"><?php echo esc_html($full_name); ?></p>
		</div>
		<div class="tutor-dashboard-user-meta">
				...
				<?php if (!$detect->isMobile()) : ?>
					<div class="public-profile-courses">
						...
						<div class="tutor-dashboard-buttons">
							<div class="like">
								<img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/heart-profile.svg' ?>" alt="">
							</div>
							<div class="bookmark" data-type="instructor" data-id="<?php echo $user_id ?>" data-callback="<?php esc_html_e('مربی', 'edumall-child'); ?>">
								<img class="filled <?php echo $bookmark ? 'active' : '' ?>" src="<?php echo get_stylesheet_directory_uri() . '/assets/images/bookmark-filled.svg' ?>" alt="">
								<img class="empty <?php echo !$bookmark ? 'active' : '' ?>" src="<?php echo get_stylesheet_directory_uri() . '/assets/images/bookmark.svg' ?>" alt="">
							</div>
						</div>
					</div>
				<?php endif; ?>
			...
			<?php if (!$detect->isMobile()) : ?>
				<div class="public-profile-meta">
					<div class="public-profile-meta-content">
					<?php endif; ?>

					<div class="public-profile-meta-content-info">
						...
						<div class="public-profile-meta-content-tags">
					...
					<div class="public-profile-video">
						<video preload="metadata" src="<?php echo !empty($instructor_video) ? $instructor_video : '#' ?>" controls></video>

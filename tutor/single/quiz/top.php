...
<div class="tutor-quiz-header">
	...
	<ul class="tutor-quiz-meta">
		...
		<?php if ($total_questions) : ?>
			<li>
				<span class="meta-label"><?php esc_html_e('Questions', 'edumall-child'); ?></span>
		...
		<?php if ($time_limit) : ?>
			...
			$available_time_type = array(
				'seconds' => _n('Second', 'Seconds', $time_limit, 'edumall-child'),
				'minutes' => _n('Minute', 'Minutes', $time_limit, 'edumall-child'),
				'hours'   => _n('Hour', 'Hours', $time_limit, 'edumall-child'),
				'days'    => _n('Day', 'Days', $time_limit, 'edumall-child'),
				'weeks'   => _n('Week', 'Weeks', $time_limit, 'edumall-child'),
			);

			$time_type_str = isset($available_time_type[$time_type]) ? $available_time_type[$time_type] : $time_type;
			?>
			<li>
				<span class="meta-label"><?php esc_html_e('Time', 'edumall-child'); ?></span>
				<span class="meta-value"><?php echo esc_html($time_limit . ' ' . $time_type_str); ?></span>
			</li>
		<?php endif; ?>

		<li>
			<span class="meta-label"><?php esc_html_e('Attempts Allowed', 'edumall-child'); ?></span>
			<span class="meta-value">
				<?php echo 0 === $attempts_allowed ? esc_html__('No limit', 'edumall-child') : $attempts_allowed; ?>
			</span>
		</li>

		<?php if ($attempted_count) : ?>
			<li>
				<span class="meta-label"><?php esc_html_e('Attempted', 'edumall-child'); ?></span>
		...
		<?php if ($attempts_allowed > 0) : ?>
			<li>
				<span class="meta-label"><?php esc_html_e('Attempts Remaining', 'edumall-child'); ?></span>
				<span class="meta-value">
					<?php echo 0 === $attempt_remaining ? esc_html__('No limit', 'edumall-child') : $attempt_remaining; ?>
				</span>
			</li>
		<?php endif; ?>
		...
		<?php if ($passing_grade) : ?>
			<li>
				<span class="meta-label"><?php esc_html_e('Passing Grade', 'edumall-child'); ?></span>
	...
	?>
		<div class="tutor-quiz-btn-grp">
			...
			<button class="tutor-btn tutor-btn-disable-outline tutor-no-hover tutor-btn-md skip-quiz-btn" data-tutor-modal-target="tutor-quiz-skip-to-next">
				<?php esc_html_e('Skip Quiz', 'edumall-child'); ?>
			</button>
						...
						<div class="tutor-modal-body tutor-text-center">
							...
							<div class="tutor-modal-text-wrap">
								<h3 class="tutor-modal-title">
									<?php esc_html_e('Skip This Quiz?', 'edumall-child'); ?>
								</h3>
								<p>
									<?php esc_html_e('Are you sure you want to skip this quiz? Please confirm your choice.', 'edumall-child'); ?>
								</p>
							</div>
							<div class="tutor-modal-btns tutor-btn-group">
								...
								<a class="tutor-btn" href="<?php echo $skip_url; ?>">
									<?php esc_html_e('Yes, Skip This', 'edumall-child'); ?>
								</a>
							</div>
						</div>
					</div>

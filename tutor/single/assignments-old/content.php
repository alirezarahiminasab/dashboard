		...
		<div id="tutor-assignment-wrap" class="tutor-quiz-wrap tutor-course-assignment-details tutor-submit-assignment  tutor-assignment-result-pending">
			<div class="tutor-assignment-information">
				...
				<ul class="tutor-assignment-detail-info tutor-quiz-meta">
					<li>
						<span class="meta-label"><?php esc_html_e('Duration:', 'edumall-child'); ?></span>
						<span class="meta-value">
							<?php echo esc_html($time_duration['value'] ? $time_duration['value'] . ' ' . $time_duration['time'] : __('No limit', 'edumall-child')); ?>
						</span>
					</li>

					<li>
						<span class="meta-label"><?php esc_html_e('Deadline:', 'edumall-child'); ?></span>
						<span class="meta-value">
							<?php
							if ($time_duration['value'] != 0) {
								if ($now > $remaining_time and $is_submitted == false) {
									esc_html_e('Expired', 'edumall-child');
								} else {
									echo esc_html(tutor_assignment_convert_seconds($remaining));
								}
							} else {
								esc_html_e('N\\A', 'edumall-child');
							}
							?>
						</span>
					</li>
					...
					<li>
						<span class="meta-label"><?php esc_html_e('Total Marks:', 'edumall-child'); ?></span>
						<span class="meta-value"><?php echo esc_html($total_mark); ?></span>
					</li>

					<li>
						<span class="meta-label"><?php esc_html_e('Passing Mark:', 'edumall-child'); ?></span>
			...
			*/
						...
						<div class="tutor-quiz-warning-box time-over tutor-d-flex tutor-align-items-center tutor-justify-content-between">
							<div class="flash-info tutor-d-flex tutor-align-items-center">
								...
								<span class="text-regular-caption tutor-color-danger-100">
									<?php esc_html_e('You have missed the submission deadline. Please contact the instructor for more information.', 'edumall-child'); ?>
								</span>
							</div>
						</div>
					</div>
			...
			<?php if (!$is_submitting && !$submitted_assignment) : ?>
				<div class="tutor-assignment-content">
					<h2 class="assignment-section-heading"><?php esc_html_e('Description', 'edumall-child'); ?></h2>
					<?php the_content(); ?>
				</div>
			<?php endif; ?>
			...
			?>
				<div class="tutor-assignment-attachments">
					<h2 class="assignment-section-heading"><?php esc_html_e('Attachments', 'edumall-child'); ?></h2>
					<div class="assignment-attachment-cards">
						...
						?>
							<a class="assignment-attachment-card" href="<?php echo esc_url(wp_get_attachment_url($attachment_id)); ?>" target="_blank" download>
								<div class="tutor-icard-content">
									<div class="text-regular-body color-text-title">
										<?php echo esc_html($attachment_name); ?>
									</div>
									<div class="text-regular-small">
										<?php esc_html_e('Size: ', 'edumall-child'); ?>
			...
			?>
					...
					<form action="" method="post" id="tutor_assignment_submit_form" enctype="multipart/form-data">
						...
						<div class="tutor-assignment-body tutor-pt-32 tutor-pt-sm-40 has-show-more">
							<h2 class="assignment-section-heading">
								<?php esc_html_e('Assignment Submission', 'edumall-child'); ?>
							</h2>
							<div class="text-regular-caption tutor-color-black-60 tutor-pt-16 tutor-pt-sm-32">
								<?php esc_html_e('Assignment answer form', 'edumall-child'); ?>
							</div>
							...
							<?php if ($allowed_upload_files) { ?>
								<div class="tutor-assignment-attachment tutor-mt-32 tutor-py-20 tutor-px-16 tutor-py-sm-32 tutor-px-sm-32">
									<div class="text-regular-caption tutor-color-black-60">
										<?php esc_html_e("Attach assignment files (Max: $allow_to_upload file)", 'edumall-child'); ?>
									</div>
									<div class="tutor-attachment-files tutor-mt-12">
											...
											<form>
												<label for="tutor-assignment-file-upload">
													...
													<a class="tutor-btn tutor-btn-primary tutor-btn-md">
														<?php esc_html_e('Choose file', 'edumall-child'); ?>
													</a>
												</label>
										...
										<div class="tutor-input-type-size">
											<p class="text-regular-small tutor-color-black-60">
												<?php esc_html_e('File Support: ', 'edumall-child'); ?>
												<span class="tutor-color-black">
													<?php esc_html_e('Any standard Image, Document, Presentation, Sheet, PDF or Text file is allowed', 'edumall-child'); ?>
												</span>
											</p>
											<p class="text-regular-small tutor-color-black-60 tutor-mt-7">
												<?php esc_html_e('Total File Size: Max', 'edumall-child'); ?>
												<span class="tutor-color-black">
													<?php echo $file_upload_limit; ?>
													<?php esc_html_e('MB', 'edumall-child'); ?>
												</span>
											</p>
										</div>
									</div>
							...
							<div class="tutor-assignment-submit-btn tutor-mt-60">
								<button type="submit" class="tutor-btn tutor-btn-primary tutor-btn-lg" id="tutor_assignment_submit_btn">
									<?php esc_html_e('Submit Assignment', 'edumall-child'); ?>
								</button>
							</div>
						</div>
					</form>
				...
				<div class="tutor-assignment-description-details tutor-assignment-border-bottom tutor-pb-32 tutor-pb-sm-44">
					<div class="tutor-pt-40 tutor-pt-sm-60 <?php echo esc_attr(strlen($s_content) > 500 ? 'tutor-ad-body has-show-more' : ''); ?>" id="content-section">
						<h2 class="assignment-section-heading"><?php esc_html_e('Description', 'edumall-child'); ?></h2>
						<div class="text-regular-body tutor-color-black-60 tutor-pt-12 tutor-entry-content" id="short-text">
							<?php
						...
						<?php if (strlen($s_content) > 500) : ?>
							<div class="text-regular-body tutor-color-black-60 tutor-pt-12 tutor-entry-content" id="full-text">
								<?php
								echo wp_kses_post($s_content);
								?>
							</div>
							<div class="tutor-show-more-btn tutor-pt-12">
								<button class="tutor-btn tutor-btn-icon tutor-btn-disable-outline tutor-btn-ghost tutor-no-hover tutor-btn-lg" id="showBtn">
									...
									<span class="tutor-color-black"><?php esc_html_e('Show More', 'edumall-child'); ?></span>
								</button>
							</div>
						<?php endif; ?>
					</div>
				...
				<?php if (isset($next_prev_content_id->next_id) && '' !== $next_prev_content_id->next_id) : ?>
					<div class="tutor-assignment-footer tutor-d-flex tutor-justify-content-end tutor-pt-32 tutor-pt-sm-44">
						<a href="<?php echo esc_url(get_permalink($next_prev_content_id->next_id)); ?>" class="tutor-btn tutor-btn-disable-outline tutor-no-hover tutor-btn-lg tutor-mt-md-0 tutor-mt-12">
							<?php esc_html_e('Skip To Next', 'edumall-child'); ?>
						</a>
					</div>
				<?php endif; ?>
				<?php
									...
									<tr>
										<th>
											<span class="text-regular-small tutor-color-black-60">
												<?php esc_html_e('Date', 'edumall-child'); ?>
											</span>
										</th>
										<th>
											<span class="text-regular-small tutor-color-black-60">
												<?php esc_html_e('Total Marks', 'edumall-child'); ?>
											</span>
										</th>
										<th>
											<span class="text-regular-small tutor-color-black-60">
												<?php esc_html_e('Pass Marks', 'edumall-child'); ?>
											</span>
										</th>
										<th>
											<span class="text-regular-small tutor-color-black-60">
												<?php esc_html_e('Earned Marks', 'edumall-child'); ?>
											</span>
										</th>
										<th>
											<span class="text-regular-small tutor-color-black-60">
												<?php esc_html_e('Result', 'edumall-child'); ?>
											</span>
										</th>
									</tr>
								</thead>
									...
									<tr>
										...
										<td data-th="Total Marks" class="total-marks">
											<span class="tutor-fs-7 tutor-fw-medium tutor-color-black">
												<?php esc_html_e($max_mark, 'edumall-child'); ?>
											</span>
										</td>
										<td data-th="Pass Marks" class="pass-marks">
											<span class="tutor-fs-7 tutor-fw-medium tutor-color-black">
												<?php esc_html_e($pass_mark, 'edumall-child'); ?>
											</span>
										</td>
										<td data-th="Earned Marks" class="earned-marks">
											<span class="tutor-fs-7 tutor-fw-medium tutor-color-black">
												<?php esc_html_e($given_mark, 'edumall-child'); ?>
											</span>
										</td>
										<td data-th="Result" class="result">
											...
											?>
													<span class="tutor-badge-label label-success">
														<?php esc_html_e('Passed', 'edumall-child'); ?>
													</span>
												<?php
												} else {
												?>
													<span class="tutor-badge-label label-warning">
														<?php esc_html_e('Failed', 'edumall-child'); ?>
													</span>
											<?php
												}
											}
											...
											?>
												<span class="tutor-badge-label label-danger">
													<?php esc_html_e('Pending', 'edumall-child'); ?>
												</span>
											<?php } ?>
										</td>
									</tr>
					...
					?>
						<div class="tutor-instructor-note tutor-my-32 tutor-py-20 tutor-px-24 tutor-py-sm-32 tutor-px-sm-36">
							<div class="tutor-in-title tutor-fs-6 tutor-fw-medium tutor-color-black">
								<?php esc_html_e('Instructor Note', 'edumall-child'); ?>
							</div>
						...
						<div class="tutor-ar-body tutor-pt-24 tutor-pb-40 tutor-px-16 tutor-px-md-32">
							<div class="tutor-ar-header tutor-d-flex tutor-justify-content-between tutor-align-items-center">
								<div class="tutor-ar-title tutor-fs-6 tutor-fw-medium tutor-color-black">
									<?php esc_html_e('Your Assignment', 'edumall-child'); ?>
								</div>
								<?php
								...
								?>
									<div class="tutor-ar-btn">
										<a href="<?php echo esc_url(add_query_arg('update-assignment', $submitted_assignment->comment_ID)); ?>" class="tutor-btn tutor-btn-tertiary tutor-is-outline tutor-btn-sm">
											<?php esc_html_e('Edit', 'edumall-child'); ?>
										</a>
									</div>
								<?php endif; ?>
							</div>
					...
					<div class="tutor-assignment-description-details tutor-assignment-border-bottom tutor-pb-32 tutor-pb-sm-44">
						<div class="tutor-pt-40 tutor-pt-sm-60 <?php echo esc_attr(strlen($s_content) > 500 ? 'tutor-ad-body has-show-more' : ''); ?>" id="content-section">
							<div class="text-medium-h6 tutor-color-black">
								<?php esc_html_e('Description', 'edumall-child'); ?>
							</div>
							<div class="text-regular-body tutor-color-black-60 tutor-pt-12 tutor-entry-content" id="short-text">
								<?php
								if (strlen($s_content) > 500) {
					...
					<?php if (isset($next_prev_content_id->next_id) && '' !== $next_prev_content_id->next_id) : ?>
						<div class="tutor-assignment-footer tutor-pt-32 tutor-pt-sm-44">
							<a class="tutor-btn tutor-btn-primary tutor-btn-lg" href="<?php echo esc_url(get_the_permalink($next_prev_content_id->next_id)); ?>">
								<?php esc_html_e('Continue Lesson', 'edumall-child'); ?>
							</a>
						</div>
					<?php endif; ?>
				<?php
				...
				?>
					<div class="tutor-assignment-footer tutor-pt-32 tutor-pt-sm-44">
						<div class="tutor-assignment-footer-btn tutor-d-flex tutor-justify-content-between">
							...
							?>
							tutor-btn-lg" id="tutor_assignment_start_btn" <?php
																			if ($time_duration['value'] != 0) {
																				if ($now > $remaining_time) {
																					echo 'disabled';
																				}
																			...
																			?>>
									<?php esc_html_e('Start Assignment Submit', 'edumall-child'); ?>
								</button>
							</form>

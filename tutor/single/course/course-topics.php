						...
						<div class="<?php echo esc_attr( $title_wrap_class ); ?>">
							<h4>
								...
								<?php if ( $topic_summery ) : ?>
									<?php echo "<span class='topic-toggle-description toggle-information-icon'><i class='fa-solid fa-info'></i></span>"; ?>
								<?php endif; ?>
							</h4>
						</div>
						...
						>
							...
							if ( $lessons->have_posts() ) :
								while ( $lessons->have_posts() ) :
									...
									$lesson_icon = $play_time ? 'fa-regular fa-play-circle' : 'fa-regular fa-file-alt';

									if ( $post->post_type === 'tutor_quiz' ) {
										$lesson_icon = 'fa-regular fa-question-circle';
									}
									if ( $post->post_type === 'tutor_assignments' ) {
										$lesson_icon = 'fa-regular fa-file-edit';
									}
									?>
									...
									<div class="tutor-course-lesson">
										<h5>
											...
											if ( $post->post_type === 'tutor_zoom_meeting' ) {
												$lesson_title = '<i class="fa-regular fa-users"></i>';

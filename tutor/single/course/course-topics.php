	...
	<div class="tutor-single-course-segment tutor-course-topics-wrap">
		<div class="tutor-course-topics-header">
			<div class="tutor-course-topics-header-left">
				<h4 class="tutor-segment-title"><?php esc_html_e('سرفصل های دوره', 'edumall-child'); ?></h4>
			</div>
		...
		<div class="tutor-course-topics-contents">
			...
			?>
					<div class="<?php echo esc_attr($topic_wrap_class); ?>">
						...
						<div class="tutor-course-lessons" <?php if ($index > 1) : ?> style="display: none;" <?php endif; ?>>
							<?php
							...
							if ($lessons->have_posts()) :
								while ($lessons->have_posts()) :
									...
									if (isset($video->url)) {
										...
										if ($seconds > 0) {
											$timeString .= ($timeString != '' ? ' ' . esc_html__('and', 'edumall-child') . ' ' : '') . $seconds . ' ' . esc_html__('ثانیه', 'edumall-child');
										}
									}

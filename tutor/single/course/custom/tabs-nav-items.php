...
$course_nav_items = apply_filters('tutor_course/single/enrolled/nav_items', [
	'questions'     => __('Q&A', 'edumall-child'),
	'announcements' => __('Announcements', 'edumall-child'),
]);
?>
<li class="active">
	<a href="#tutor-course-tab-overview"><?php esc_html_e('Overview', 'edumall-child'); ?></a>
</li>
<?php if ($topics->have_posts()) : ?>
	<li>
		<a href="#tutor-course-tab-curriculum"><?php esc_html_e('Curriculum', 'edumall-child'); ?></a>
	</li>
<?php endif; ?>
<?php if ($edumall_course->is_viewable() && !empty($edumall_course->get_attachments())) : ?>
	<li>
		<a href="#tutor-course-tab-resources"><?php esc_html_e('Resources', 'edumall-child'); ?></a>
	</li>
<?php endif; ?>
<?php if ($edumall_course->is_viewable()) : ?>
	<li>
		<a href="#tutor-course-tab-question-and-answer"><?php esc_html_e('Question & Answer', 'edumall-child'); ?></a>
	</li>
<?php endif; ?>
<li>
	<a href="#tutor-course-tab-instructors"><?php esc_html_e('Instructors', 'edumall-child'); ?></a>
</li>
<?php if ($edumall_course->is_viewable()) : ?>
	<li>
		<a href="#tutor-course-tab-announcements"><?php esc_html_e('Announcements', 'edumall-child'); ?></a>
	</li>
<?php endif; ?>
...
<?php if ($edumall_course->get_reviews()) : ?>
	<li>
		<a href="#tutor-course-tab-reviews"><?php esc_html_e('Reviews', 'edumall-child'); ?></a>
	</li>
<?php endif; ?>
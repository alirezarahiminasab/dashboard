	...
	<?php if ('1' !== get_tutor_option('disable_course_level')) { ?>
		<div class="tutor-course-level">
			<span class="meta-label">
				...
				<?php esc_html_e('Level', 'edumall-child'); ?>
			</span>
	...
	if (!empty($course_duration) && !$disable_course_duration) { ?>
		<div class="tutor-course-duration">
			<span class="meta-label">
				...
				<?php esc_html_e('Duration', 'edumall-child') ?>
			</span>
	...
	if ($tutor_lesson_count) : ?>
		<div class="tutor-course-lesson-count">
			<span class="meta-label">
				...
				<?php esc_html_e('Lectures', 'edumall-child'); ?>
			</span>
			<div class="meta-value">
				<?php echo esc_html(sprintf(_n('%s lecture', '%s lectures', $tutor_lesson_count, 'edumall-child'), $tutor_lesson_count)); ?>
			</div>
		</div>
	<?php endif; ?>

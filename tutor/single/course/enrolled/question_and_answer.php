...
<div class="tutor-single-course-segment tutor-question-and-answer-wrap">
	<div class="question-and-answer-title-wrap">
		<div class="tutor-question-top">
			<h4 class="tutor-segment-title"><?php esc_html_e('Question & Answer', 'edumall-child'); ?></h4>

			<?php Edumall_Templates::render_button([
				'link'       => [
					'url' => 'javascript:void(0);',
				],
				'text'       => esc_html__('Ask a new question', 'edumall-child'),
				'size'       => 'xs',
				'attributes' => [
					...
					<div class="tutor-question-wrap">
						...
						<div class="tutor-question-info">
							<div class="tutor-question-meta">
								<h4 class="question-user-name"><a href="<?php echo esc_url($questioner_profile_url); ?>"><?php echo esc_html($question->display_name); ?></a>
								</h4>
								<span class="question-post-date tutor-text-mute"><?php echo esc_html(sprintf(__('%s ago', 'edumall-child'), human_time_diff(strtotime($question->comment_date)))); ?></span>
							</div>
							<div class="tutor-question-content">
								<div class="question-description"><?php echo wpautop(stripslashes($question->comment_content)); ?></div>
							</div>
						</div>
					</div>
							...
							?>
								<div class="<?php echo esc_attr($wrapper_class); ?>">
									<div class="tutor-question-wrap">
										...
										<div class="tutor-question-info">
											<div class="tutor-question-meta">
												<h4 class="question-user-name"><a href="<?php echo esc_url($responder_profile_url); ?>"><?php echo esc_html($answer->display_name); ?></a>
												</h4>
												<span class="question-post-date tutor-text-mute"><?php echo sprintf(__('%s ago', 'edumall-child'), human_time_diff(strtotime($answer->comment_date))); ?></span>
											</div>
											<div class="tutor-question-content">
												<div class="question-description"><?php echo wpautop(stripslashes($answer->comment_content)); ?></div>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="tutor_add_answer_row">
						<div class="tutor_add_answer_wrap" data-question-id="<?php echo esc_attr($question->comment_ID); ?>">
							...
							<?php Edumall_Templates::render_button([
								...
								'text'          => esc_html__('Add an answer', 'edumall-child'),
								'size'          => 'xs',
								'attributes'    => [
									'data-edumall-toggle' => 'modal',
		...
		<div class="modal-content-wrap">
			<div class="modal-content-inner">
				<div class="modal-content-header">
					<h3 class="modal-title"><?php esc_html_e('Ask a Question', 'edumall-child'); ?></h3>
				</div>
						...
						<div class="tutor-form-group">
							<div class="button-group">
								<?php Edumall_Templates::render_button([
									...
									'text'        => esc_html__('Cancel', 'edumall-child'),
								...
								<div class="tm-button-wrapper">
									<button type="submit" class="tutor-button tutor-success tutor_ask_question_btn" name="tutor_question_search_btn"><?php esc_html_e('Post Question', 'edumall-child'); ?> </button>
								</div>
							</div>
						</div>
					</form>
...
<div class="edumall-modal modal-course-qna-reply" id="modal-course-qna-reply">
	...
	<div class="modal-content">
		...
		<div class="modal-content-wrap">
			<div class="modal-content-inner">
				<div class="modal-content-header">
					<h3 class="modal-title"><?php esc_html_e('Add an answer', 'edumall-child'); ?></h3>
				</div>
				...
				<div class="modal-content-body">
					<form method="post" id="tutor-reply-question-form">
						...
						<div class="tutor-form-group">
							<textarea name="answer" cols="30" rows="10" placeholder="<?php esc_attr_e('Write your answer here...', 'edumall-child'); ?>"></textarea>
						</div>
						...
						<div class="tutor-form-group">
							<div class="button-group">
								...
								<div class="tm-button-wrapper">
									<button type="submit" class="tutor-button tutor-success tutor_ask_question_btn" name="tutor_question_search_btn"><?php esc_html_e('Reply', 'edumall-child'); ?> </button>
								</div>
							</div>
						</div>
					</form>

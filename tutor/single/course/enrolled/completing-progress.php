...
<div class="tutor-single-course-segment tutor-course-status">
	<h4 class="tutor-segment-title"><?php esc_html_e('Course Status', 'edumall-child'); ?></h4>
	<div class="tutor-progress-bar-wrap">
		<div class="tutor-progress-bar">
			<div class="tutor-progress-filled primary-background" style="<?php echo '--tutor-progress-left: ' . $completed_count . '%;'; ?>"></div>
		</div>
		<span class="tutor-progress-percent"><?php echo esc_html($completed_count); ?>
			% <?php esc_html_e(' Complete', 'edumall-child') ?></span>
	</div>
</div>

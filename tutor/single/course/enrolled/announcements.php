...
<div class="tutor-single-course-segment tutor-announcements-wrap">
	<h4 class="tutor-segment-title"><?php esc_html_e('Announcements', 'edumall-child'); ?></h4>
	...
	<div class="tutor-announcement-list">
						...
						<div class="announcement-info">
							...
							<div class="announcement-meta">
								<span class="announcement-author">
									<?php echo sprintf(esc_html__('Posted by %s', 'edumall-child'), $announcement->display_name); ?>
								</span>
								<span class="announcement-post-date">
									<?php echo sprintf(esc_html__('%s ago', 'edumall-child'), human_time_diff(strtotime($announcement->post_date))); ?>
								</span>
							</div>
						</div>
					</div>
		...
		<?php } else { ?>
			<div class="tutor-no-announcements">
				<h2><?php esc_html_e('No announcements posted yet.', 'edumall-child'); ?></h2>
				<p>
					<?php esc_html_e('The instructor hasn\'t added any announcements to this course yet. Announcements are used to inform you of updates or additions to the course.', 'edumall-child'); ?>
				</p>
			</div>
		<?php } ?>
	</div>

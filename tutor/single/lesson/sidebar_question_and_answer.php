...
<div class="tutor-queston-and-answer-wrap">
	<div class="tutor_question_answer_wrap">
		...
		?>
			...
			<div class="tutor-lesson-sidebar-emptyqa-wrap">
				...
				<h3><?php esc_html_e('No questions yet', 'edumall-child'); ?></h3>
				<p><?php esc_html_e('Be the first to ask your question! You’ll be able to add details in the next step.', 'edumall-child'); ?></p>
			</div>
	...
	<div class="tutor-add-question-wrap">
		...
		<h3><?php esc_html_e('Ask a new question', 'edumall-child'); ?></h3>
		...
		<form method="post" id="tutor-ask-question-form">
			...
			<div class="tutor-form-group">
				<button type="submit" class="tutor_ask_question_btn tutor-button tutor-success" name="tutor_question_search_btn"><?php esc_html_e('Submit my question', 'edumall-child'); ?></button>
			</div>
		</form>
	</div>

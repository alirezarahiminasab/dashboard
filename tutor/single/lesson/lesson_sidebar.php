	...
	<div id="tutor-lesson-sidebar" class="tutor-lesson-sidebar">
		...
		<div class="tutor-sidebar-tabs-wrap">
			<div class="tutor-tabs-btn-group">
				<a href="#tutor-lesson-sidebar-tab-content" <?php if ($enable_q_and_a_on_course) : ?> class="active" <?php endif; ?>>
					<i class="far fa-book-open"></i>
					<span> <?php esc_html_e('Lesson List', 'edumall-child'); ?></span></a>
				<?php if ($enable_q_and_a_on_course) { ?>
					<a href="#tutor-lesson-sidebar-qa-tab-content">
						<i class="far fa-question-circle"></i>
						<span><?php esc_html_e('Browse Q&A', 'edumall-child'); ?></span>
					</a>
				<?php } ?>
			</div>
			...
			<div class="tutor-sidebar-tabs-content">
				...
				<div id="tutor-lesson-sidebar-tab-content" class="tutor-lesson-sidebar-tab-item">
					...
					?>
							...
							<div class="tutor-topics-in-single-lesson tutor-course-topic tutor-course-topic-<?php echo esc_attr($topic_id); ?>">
								<div class="<?php echo esc_attr($topic_title_class); ?>" tutor-course-single-topic-toggler>
									<h3>
								...
								<div class="tutor-accordion-item-body tutor-lessons-under-topic" style="<?php echo $is_topic_active ? ' display: block;' : 'display: none;'; ?>">
									<?php
									...
									if ($lessons->have_posts()) {
										while ($lessons->have_posts()) : $lessons->the_post(); ?>
											<?php if ($post->post_type === 'tutor_quiz') : ?>
												...
												?>
												<div class="<?php echo esc_attr($wrapper_class); ?>" data-quiz-id="<?php echo esc_attr($quiz->ID); ?>">
													<a href="<?php echo esc_url(get_permalink($quiz->ID)); ?>" class="sidebar-single-quiz-a" data-quiz-id="<?php echo esc_attr($quiz->ID); ?>">
														<i class="far fa-question-circle"></i>
														<span class="lesson_title"><?php echo esc_html($quiz->post_title); ?></span>
											...
											<?php elseif ($post->post_type === 'tutor_assignments') : ?>
												...
												?>
												<div class="<?php echo esc_attr($wrapper_class); ?>" data-assignment-id="<?php echo esc_attr($post->ID); ?>">
													<a href="<?php echo esc_url(get_permalink($post->ID)); ?>" class="sidebar-single-assignment-a" data-assignment-id="<?php echo esc_attr($post->ID); ?>">
														...
														<span class="lesson_title"> <?php echo esc_html($post->post_title); ?> </span>
														<span class="tutor-lesson-right-icons">
											...
											<?php elseif ($post->post_type === 'tutor_zoom_meeting') : ?>
												 ...
												 */
												?>
												<div class="tutor-single-lesson-items zoom-meeting-single-item zoom-meeting-single-item-<?php echo $post->ID; ?> <?php echo ($currentPost->ID === get_the_ID()) ? 'active' : ''; ?>" data-assignment-id="<?php echo $post->ID; ?>">
											...
											<?php else : ?>
												...
												<div class="<?php echo esc_attr($wrapper_class); ?>">
													<a href="<?php the_permalink(); ?>" class="tutor-single-lesson-a" data-lesson-id="<?php echo esc_attr(get_the_ID()); ?>">

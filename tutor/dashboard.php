...
<div class="user-dashboard">
	<?php if (preg_match($dashboard_pattern, $current_url)) : ?>
		<div class="user-dashboard-header-wrap">
			<div class="tutor-dashboard-header">
				...
				<div class="tutor-dashboard-header-enrollment <?php echo $menu_state === 'tutor' || !current_user_can(tutor()->instructor_role) ? 'active' : '' ?>">

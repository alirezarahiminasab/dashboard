...
<div class="course-cat-section featured-courses-slider">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h3 class="archive-section-heading"><?php printf(esc_html__('%sFeatured%s Courses', 'edumall-child'), '<mark>', '</mark>'); ?></h3>
				<div class="course-cat-section-content">
					<div class="tm-swiper tm-slider v-stretch bullets-v-align-below nav-style-01 pagination-style-01 edumall-courses style-carousel-01 edumall-animation-zoom-in" data-lg-items="auto" data-lg-gutter="30" data-sm-gutter="15" data-nav="1" data-pagination="1">

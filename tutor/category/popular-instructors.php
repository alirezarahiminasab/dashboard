...
<div class="course-cat-section popular-instructors">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h3 class="archive-section-heading"><?php printf(esc_html__('%sPopular%s Instructors', 'edumall-child'), '<mark>', '</mark>'); ?></h3>
				<div class="course-cat-section-content">
					<div class="tm-swiper tm-slider v-stretch bullets-v-align-below nav-style-01 pagination-style-01 " data-lg-items="4" data-md-items="2" data-sm-items="1" data-lg-gutter="30" data-sm-gutter="15" data-nav="1" data-pagination="1">
								...
								<div class="swiper-wrapper">
									<?php foreach ($popular_instructors as $instructor) : ?>
										...
										<div class="swiper-slide">
											<a href="<?php echo esc_url($profile_url); ?>" class="popular-instructor-wrapper">
															...
															<div class="popular-instructor-meta">
																...
																<span class="meta-value">
																	...
																	echo esc_html(sprintf(
																		_n('%s course', '%s courses', $total_courses, 'edumall-child'),

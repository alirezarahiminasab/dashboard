...
<div class="course-cat-section popular-topics">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h3 class="archive-section-heading"><?php printf(esc_html__('%sPopular%s Topics', 'edumall-child'), '<mark>', '</mark>'); ?></h3>
				<div class="course-cat-section-content">
					<div class="course-popular-topic-list">
						<?php foreach ($popular_topics as $topic) : ?>
							...
							?>
							<a href="<?php echo esc_url($topic_link); ?>" class="popular-topic-link"><?php echo esc_html($topic->name); ?></a>
						<?php endforeach; ?>
					</div>
				</div>
			</div>

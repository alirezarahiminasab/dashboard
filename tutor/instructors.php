		...
		<div class="row">
			...
			<div id="page-main-content" class="page-main-content">
				...
				<div class="archive-filter-bars row row-xs-center">
					<div class="archive-filter-bar archive-filter-bar-left col-md-6">
						<div class="archive-result-count">
							<?php
							$result_count_html = sprintf(_n('%s instructor', '%s instructors', $total_instructors, 'edumall-child'), '<span class="count">' . number_format_i18n($total_instructors) . '</span>');
							printf(
								wp_kses(
				...
				<?php if (!empty($instructors)) : ?>
					...
					?>
					<div class="<?php echo esc_attr(implode(' ', $wrapper_classes)); ?>" data-grid="<?php echo esc_attr(wp_json_encode($grid_options)); ?>">
						<div class="<?php echo esc_attr(implode(' ', $grid_classes)); ?>">
							...
							<?php foreach ($instructors as $instructor) : ?>
								...
								?>
								<div class="grid-item">
									<a href="<?php echo esc_url($profile_url); ?>" class="loop-instructor-wrapper">

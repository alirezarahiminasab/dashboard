...
<div class="dashboard-content-box">
	<?php if ( $is_instructor ) : ?>
		<div class="tutor-col-auto">
			<label
				...
				<span
					class="tutor-form-toggle-label tutor-form-toggle-<?php echo $view_as == 'student' ? 'checked' : 'unchecked'; ?>"><?php esc_html_e( 'Student', 'edumall' ); ?></span>
				<span class="tutor-form-toggle-control"></span>
				<span
					class="tutor-form-toggle-label tutor-form-toggle-<?php echo $view_as == 'instructor' ? 'checked' : 'unchecked'; ?>"><?php esc_html_e( 'Instructor', 'edumall' ); ?></span>
			</label>
		</div>
	<?php endif; ?>
	...
	<div
		...
		<span class="tutor-fs-7 tutor-fw-normal tutor-color-black-60"><?php esc_html_e( 'Sort By', 'edumall' ); ?>:</span>

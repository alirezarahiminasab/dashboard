...
if (isset($_GET['view_quiz_attempt_id'])) {
	...
	tutor_load_template('dashboard.quiz-attempts.quiz-reviews');
...
<h3><?php esc_html_e('Quiz Attempts', 'edumall-child'); ?></h3>
	...
	<div class="dashboard-quiz-attempt-history dashboard-table-wrapper dashboard-table-responsive">
		<div class="dashboard-table-container">
			<table class="dashboard-table">
				<thead>
					<tr>
						<th class="col-course-info"><?php esc_html_e('Course Info', 'edumall-child'); ?></th>
						<th class="col-student"><?php esc_html_e('Student', 'edumall-child'); ?></th>
						<th class="col-correct-answer"><?php esc_html_e('Correct Answer', 'edumall-child'); ?></th>
						<th class="col-incorrect-answer"><?php esc_html_e('Incorrect Answer', 'edumall-child'); ?></th>
						<th class="col-earned-marks"><?php esc_html_e('Earned Marks', 'edumall-child'); ?></th>
						<th class="col-result"><?php esc_html_e('Result', 'edumall-child'); ?></th>
						<th></th>
				...
				<tbody>
					<?php foreach ($quiz_attempts as $attempt) : ?>
						<?php
						$attempt_action    = add_query_arg(array('view_quiz_attempt_id' => $attempt->attempt_id), tutor()->current_url);
						...
						<tr>
							<td>
								<h3 class="course-title">
									<a href="<?php echo get_the_permalink($attempt->course_id); ?>" target="_blank"><?php echo esc_html(get_the_title($attempt->course_id)); ?></a>
								</h3>
								<div class="dashboard-quiz-attempt-metas">
									...
									<div class="meta-item quiz-attempt-question-count">
										<span class="meta-name"><?php esc_html_e('Question: ', 'edumall-child'); ?></span>
										<span class="meta-value"><?php echo count($answers); ?></span>
									</div>
									<div class="meta-item quiz-attempt-total-marks">
										<span class="meta-name"><?php esc_html_e('Total Marks: ', 'edumall-child'); ?></span>
										<span class="meta-value"><?php echo esc_html($attempt->total_marks); ?></span>
									</div>
								</div>
							</td>
							<td>
								<div class="heading col-heading-mobile"><?php esc_html_e('Student:', 'edumall-child'); ?></div>
								<div class="student">
							...
							?>
							<td>
								<div class="heading col-heading-mobile"><?php esc_html_e('Correct Answer:', 'edumall-child'); ?></div>
								<?php echo esc_html($correct); ?>
							</td>
							<td>
								<div class="heading col-heading-mobile"><?php esc_html_e('Incorrect Answer:', 'edumall-child'); ?></div>
							...
							<td>
								<a href="<?php echo esc_url($attempt_action); ?>" class="link-transition-01 quiz-attempt-detail-link"><?php esc_html_e('Details', 'edumall-child'); ?></a>
							</td>
...
<?php else : ?>
	<div class="dashboard-no-content-found">
		<?php esc_html_e('You have not attempted for any quiz yet.', 'edumall-child'); ?>
	</div>
<?php endif;

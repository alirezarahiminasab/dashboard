...
<?php if (!empty($my_students)) : ?>
    <div class="instructor-students">
        <div class="instructor-students-wrap">
            ...
            <?php else : ?>
                <div class="instructor-students-title">
                    <h3><?php esc_html_e('لیست فراگیران', 'edumall-child'); ?></h3>
                </div>
            <?php endif ?>
            ...
            <div class="instructor-students-table">
                <?php if ($detect->isMobile()) : ?>
                    <p class="instructor-students-table-count">
                        <?php esc_html_e('لیست فراگیران', 'edumall-child'); ?>
                        <?php echo "(" . $total_students . ")" ?>
                    </p>
                    <div class="instructor-students-table-wrap">
                ...
                <?php else : ?>
                    <div class="instructor-students-table-header">
                        <div class="instructor-students-table-header-btn">
                            <span class="instructor-students-table-header-title">
                                <p>
                                    <?php esc_html_e('لیست فراگیران', 'edumall-child'); ?>
                                </p>
                            </span>
                            <span class="instructor-students-table-header-setting">
                                <a class="instructor-students-table-header-button instructor-students-table-header-filter" href="#">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/filter-search.png' ?>" alt="">
                                    <p>
                                        <?php esc_html_e('فیلتر ها', 'edumall-child'); ?>
                                    </p>
                                </a>
                                <span class="instructor-students-table-header-setting-separator"></span>
                                <a class="instructor-students-table-header-button instructor-students-table-header-sort" href="#">
                                    <p>
                                        <?php esc_html_e('مرتب سازی بر اساس', 'edumall-child'); ?>
                                    </p>
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/arrow-down.png' ?>" alt="">
                        ...
                        <div class="instructor-students-table-header-headline">
                            <span>
                                <p>
                                    <?php esc_html_e('نام فراگیر', 'edumall-child'); ?>
                                </p>
                            </span>
                            <span>
                                <p>
                            ...
                            <span>
                                <p>
                                    <?php esc_html_e('استان', 'edumall-child'); ?>
                                </p>
                            </span>
                            <span>
                                <p>
                            ...
                            <span>
                                <p>
                                    <?php esc_html_e('سن', 'edumall-child'); ?>
                                </p>
                            </span>
                        </div>
                    </div>
                    <div class="instructor-students-table-content">
                        <?php foreach ($my_students as $student) : ?>
                            <?php
                            $profile_url             = tutor_utils()->profile_url($student->ID);
                            $enrolled_courses_action = tutor_utils()->get_tutor_dashboard_page_permalink('my-students/enrolled-courses/?student_id=' . $student->ID);

...
<div class="instructor-courses">
    <div class="instructor-courses-wrap">
        <div class="instructor-courses-wrap-setting">
            <?php if (!$detect->isMobile()) : ?>
                <h3 class="instructor-courses-wrap-setting-title"><?php esc_html_e('دوره‌های ایجاد شده', 'edumall-child'); ?></h3>
                <div class="instructor-courses-wrap-setting-buttons">
                <?php endif; ?>
                <?php if (!$detect->isMobile()) : ?>
                    <a class="instructor-courses-wrap-setting-buttons-create" href="<?php echo $profile_url . 'course/course-create/' ?>">
                        <?php esc_html_e('دوره جدید', 'edumall-child'); ?>
                    </a>
                <?php endif; ?>
                    ...
                    <div id="<?php echo $row_id ?>" class="edumall-box instructor-courses-wrap-boxes-course instructor-course-<?php the_ID(); ?>">
                        <div class="instructor-courses-wrap-boxes-course-header">
                            <div class="instructor-dropdown-parent">
                                <?php if (!$detect->isMobile()) : ?>
                                    <div class="instructor-dropdown-parent-status">
                                        <?php
                                ...
                                <div id="table-dashboard-course-list-<?php echo esc_attr($post->ID); ?>" class="instructor-dropdown-parent-menu">
                                    ...
                                    <div class="instructor-dropdown-item">
                                        ...
                                        <a href="<?php echo esc_url(tutor_utils()->get_tutor_dashboard_page_permalink('course/course-edit/?course_ID=' . $post->ID)); ?>" target="_blank">
        ...
        <?php else : ?>
            <div class="instructor-courses-wrap-empty">
                ...
                <a href="<?php echo $profile_url . 'course/course-create/' ?>">
        ...
        <div class="instructor-courses-wrap-create-btn">
            <a href="<?php echo $profile_url . 'course/course-create/' ?>" target="_blank">

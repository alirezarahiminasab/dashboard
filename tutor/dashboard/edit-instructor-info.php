...
<main class="instructor-settings" data-user="<?php echo $user->ID ?>">
    <div class="instructor-settings-wrap">
        <form action="" method="post" enctype="multipart/form-data" class="instructor-settings-form">
                ...
                <div id="instructor_profile_cover_photo_editor">
                    ...
                    <div class="user-edit-buttons <?php echo empty($profile_photo_id) ? '' : "active" ?>">
                        ...
                        <label class="user-edit-buttons-delete">
                            ...
                            <?php else : ?>
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/trash-desktop.svg' ?>" alt="">
                            <?php endif; ?>
                        </label>
                    </div>
            ...
            <?php if (!$detect->isMobile()) : ?>
                <div class="instructor-settings-form-group-wrap">
                <?php endif; ?>
                <div class="instructor-settings-form-group instructor-username">
                    ...
                    <div class="instructor-username-input">
                        <input type="text" id="instructor_profile_username" name="instructor_username" placeholder="مانند:" value="<?php echo $instructor_username ?>" required>
                ...
                <div class="instructor-settings-form-group instructor-profession">
                    ...
                    <input type="text" id="instructor_profile_profession" name="instructor_profession" value="<?php echo esc_attr(get_user_meta($user->ID, '_instructor_profession', true)); ?>" placeholder="مانند: دکتری روانشناسی بالینی" required>
                </div>
                <?php if (!$detect->isMobile()) : ?>
                </div>
            <?php endif; ?>
            ...
            <div class="instructor-settings-form-group instructor-story-text">
                ...
                <textarea cols="50" rows="5" name="instructor_story" id="instructor_story_text" value="<?php echo esc_attr($instructor_story); ?>" placeholder="روایت خود را اینجا بنوسید...." required><?php echo $instructor_story_text ?></textarea>
            ...
            <div class="instructor-settings-form-group instructor-tags">
                ...
                <div class="instructor-tags-input">
                    <input type="text" value="<?php echo esc_attr(get_user_meta($user->ID, 'tags', true)); ?>" placeholder="برچسب خود را بنویسید">
                    <a href="#">افزودن</a>
                </div>
                <div id="instructor_profile_tags" class="instructor-tags-wrap">
                    ...
                    ?>
                            <div class="instructor-tags-wrap-value value-<?php echo $tag ?>">
                                <input type="hidden" name='instructor_tags[]' value="<?php echo  esc_html($tag) ?>">
            ...
            <div class="instructor-settings-form-group instructor-submit-wrap">
                <button type="submit" value="register" class="instructor-button instructor-profile-settings-save"><?php esc_html_e('ذخیره تغییرات', 'edumall-child'); ?></button>
            </div>

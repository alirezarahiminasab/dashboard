...
// $summary_data                         = WithdrawModel::get_withdraw_summary($instructor_id);
$summary_data                         = Edumall_Tutor::instance()->get_withdraw_summary($instructor_id);
...
$available_for_withdraw_formatted    = number_format($summary_data->total_income);
...
<?php if ($detect->isMobile()) : ?>
    <div class="instructor-settings-back">
        ...
        <h3><?php esc_html_e('تسویه حساب', 'edumall-child'); ?></h3>
    </div>
<?php endif; ?>

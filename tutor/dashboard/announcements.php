...
?>
<h3><?php esc_html_e('Announcement', 'edumall-child'); ?></h3>
	...
	<div class="withdraw-page-current-balance new-announcement-wrap">
		<div class="balance-info new-announcement-content">
			...
			<div class="announcement-content-info">
				<h4><?php esc_html_e('Create Announcement', 'edumall-child'); ?></h4>
				<p><?php esc_html_e('Notify all students of your course', 'edumall-child'); ?></p>
			</div>
		</div>
...
<!--Filter-->
<div class="tutor-dashboard-announcement-sorting dashboard-content-box tutor-row tutor-mb-32 tutor-mt-44" style="width: calc(100% + 30px);">
	<div class="tutor-col-12 tutor-col-lg-6 tutor-mt-12 tutor-mt-lg-0">
		<label class="tutor-d-block tutor-mb-12 tutor-form-label">
			<?php esc_html_e('Courses', 'edumall-child'); ?>
		</label>
		<select class="tutor-form-select tutor-form-control-sm tutor-announcement-course-sorting">

			<option value=""><?php esc_html_e('All', 'edumall-child'); ?></option>
			...
			<?php if ($courses) : ?>
				...
				<?php endforeach; ?>
			<?php else : ?>
				<option value=""><?php esc_html_e('No course found', 'edumall-child'); ?></option>
			<?php endif; ?>
		</select>
	</div>

	<div class="tutor-col-6 tutor-col-lg-3 tutor-mt-12 tutor-mt-lg-0">
		<label class="tutor-d-block tutor-mb-12 tutor-form-label"><?php esc_html_e('Sort By', 'edumall-child'); ?></label>
		<select class="tutor-form-select tutor-announcement-order-sorting tutor-form-control-sm" data-search="no">
			<option <?php selected($order_filter, 'ASC'); ?>><?php esc_html_e('ASC', 'edumall-child'); ?></option>
			<option <?php selected($order_filter, 'DESC'); ?>><?php esc_html_e('DESC', 'edumall-child'); ?></option>
		</select>
	</div>

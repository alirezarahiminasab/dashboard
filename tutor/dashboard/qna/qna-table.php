...
$page_key      = 'qna-table';
$table_columns = include tutor()->path . '/views/qna/contexts.php';
				...
				<tr id="<?php echo $row_id; ?>" data-question_id="<?php echo $qna->comment_ID; ?>" class="<?php echo $is_read ? 'is-qna-read' : ''; ?>">
					...
					foreach ($table_columns as $key => $column) {
						switch ($key) {
							case 'checkbox':
					?>
								<td data-th="<?php esc_attr_e('Mark', 'edumall-child'); ?>" class="tutor-shrink">
								...
								<td data-th="<?php echo $column; ?>">
									<div class="td-avatar">
										<div class="tooltip-wrap tutor-qna-badges-wrapper">
											<span data-state-class-0="tutor-icon-msg-important-filled" data-state-class-1="tutor-icon-msg-important-fill-filled" data-action="important" data-state-class-selector="i">
												<i class="<?php echo $is_important ? 'tutor-icon-msg-important-fill-filled' : 'tutor-icon-msg-important-filled'; ?> tutor-icon-20 tutor-cursor-pointer">
												</i>
											</span>
											...
											<span class="tooltip-txt tooltip-right">
												<?php $is_important ? esc_html_e('This conversation is important', 'edumall-child') : esc_html_e('Mark this conversation as important', 'edumall-child'); ?>
											</span>
										</div>
										<img src="<?php echo esc_url(get_avatar_url($qna->user_id)); ?>" alt="<?php echo esc_attr($qna->display_name); ?> - <?php esc_attr_e('Profile Picture', 'edumall-child'); ?>" />
										<div class="">
									...
									<a href="<?php echo add_query_arg(array('question_id' => $qna->comment_ID), tutor()->current_url); ?>">
										<div class="tutor-input-feedback tutor-has-icon tutor-qna-question-col <?php echo $is_read ? 'is-read' : ''; ?>">
											...
											<div class="tutor-qna-desc">
												...
												<div class="">
													<span class="tutor-fs-8 tutor-fw-medium tutor-color-black-60"><?php esc_html_e('Course', 'edumall-child'); ?>
														:</span>
													<span class="tutor-fs-7 tutor-fw-normal tutor-color-black-60"><?php echo $qna->post_title; ?></span>
												</div>
											</div>
										</div>
									</a>
								...
								<td data-th="<?php echo $column; ?>">
									<div class="tooltip-wrap">
										...
										<span class="tooltip-txt tooltip-bottom">
											<?php $is_solved ? esc_html_e('Solved', 'edumall-child') : esc_html_e('Unresolved Yet', 'edumall-child'); ?>
										</span>
									</div>
								</td>
							<?php
								...
								<td data-th="<?php echo $column; ?>" class="tutor-text-right">
									<div class="inline-flex-center td-action-btns">
										<a href="<?php echo add_query_arg(array('question_id' => $qna->comment_ID), tutor()->current_url); ?>" class="tutor-btn tutor-btn-disable-outline tutor-btn-outline-fd tutor-btn-sm">
											<?php esc_html_e('Reply', 'edumall-child'); ?>
										</a>
											...
											<ul id="<?php echo $menu_id; ?>" class="popup-menu">
												<?php if ($context != 'frontend-dashboard-qna-table-student') : ?>
													<li class="tutor-qna-badges tutor-qna-badges-wrapper">
														<a href="#" data-action="archived" data-state-text-selector=".text-regular-body" data-state-class-selector=".color-design-white" data-state-text-0="<?php esc_attr_e('Archive', 'edumall-child'); ?>" data-state-text-1="<?php esc_attr_e('Un-archive', 'edumall-child'); ?>">
															...
															<span class="text-regular-body tutor-color-white">
																<?php $is_archived ? esc_html_e('Un-archive', 'edumall-child') : esc_html_e('Archive', 'edumall-child'); ?>
															</span>
														</a>
													</li>
												<?php endif; ?>
												<li class="tutor-qna-badges tutor-qna-badges-wrapper">
													<a href="#" data-action="read" data-state-text-selector=".text-regular-body" data-state-class-selector=".color-design-white" data-state-text-0="<?php esc_attr_e('Mark as Read', 'edumall-child'); ?>" data-state-text-1="<?php esc_attr_e('Mark as Unread', 'edumall-child'); ?>">
														...
														<span class="text-regular-body tutor-color-white" style="text-align: left;">
															<?php $is_read ? esc_html_e('Mark as Unread', 'edumall-child') : esc_html_e('Mark as read', 'edumall-child'); ?>
														</span>
													</a>
												</li>
												<li>
													<a href="#" data-tutor-modal-target="<?php echo $id_string_delete; ?>">
														...
														<span class="text-regular-body tutor-color-white"><?php esc_html_e('Delete', 'edumall-child'); ?></span>
													</a>
												</li>
											</ul>
										</div>
													...
													<div class="tutor-modal-body tutor-text-center">
														...
														<div class="tutor-modal-text-wrap">
															<h3 class="tutor-modal-title">
																<?php esc_html_e('Delete This Question?', 'edumall-child'); ?>
															</h3>
															<p>
																<?php esc_html_e('All the replies also will be deleted.', 'edumall-child'); ?>
															</p>
														</div>

...
<div class="instructor-setting-content">
    <ul class="instructor-setting-permalinks">
        <?php
        $dashboard_pages = add_instructor_menu_items();
        foreach ($dashboard_pages as $dashboard_key => $dashboard_page) :
            ...
            if (empty($sub_menu)) {
                $menu_link  = $dashboard_key !== "log-out" ? tutils()->get_tutor_dashboard_page_permalink($dashboard_key) : wp_logout_url(home_url());
            }
                ...
                <?php if ($menu_activation) : ?>
                    <?php if (empty($sub_menu)) : ?>
                        <li class="<?php echo esc_attr($li_class . ' ' . $active_class) ?>">
                            <a href="<?php echo esc_url($menu_link); ?>" data-link="<?php echo esc_html($dashboard_key) ?>" data-type="admin">
                    ...
                    <?php else : ?>
                        <li class="<?php echo esc_attr($li_class . ' ' . $active_class) ?> submenu">
                            ...
                            <ul class="tutor-dashboard-sub-menu">
                                ...
                                ?>
                                    <li>
                                        <a href="<?php echo esc_url($sub_menu_link); ?>" data-link="<?php echo esc_html($dashboard_key . '/' . $sub_menu_key); ?>" data-type="admin">

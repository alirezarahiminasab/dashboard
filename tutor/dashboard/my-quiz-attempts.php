...
?>
<h3><?php esc_html_e('My Quiz Attempts', 'edumall-child'); ?></h3>
					...
					<?php foreach ($quiz_attempts as $attempt) : ?>
						...
						<tr>
							...
							<td>
								...
								?>
								<a href="<?php echo esc_url($url); ?>" class="link-transition-01 quiz-attempt-detail-link"><?php esc_html_e('Details', 'edumall-child'); ?></a>
							</td>
...
<?php else : ?>
	<div class="dashboard-no-content-found">
		<?php esc_html_e('You have not attempted any quiz yet.', 'edumall-child'); ?>
	</div>
<?php endif;

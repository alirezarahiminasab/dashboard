...
<div>
	...
	<a class="prev-btn" href="<?php echo esc_url($my_student_page); ?>"><span>&leftarrow;</span><?php esc_html_e('Back to My Student List', 'edumall-child'); ?>
	</a>
</div>
<h3><?php echo esc_html(sprintf(__('My courses get enrolled by %s', 'edumall-child'), $student->display_name)); ?></h3>
	...
	<div class="dashboard-my-student-courses-table dashboard-table-wrapper dashboard-table-responsive">
		<div class="dashboard-table-container">
			<table class="dashboard-table">
				<thead>
					<tr>
						<th class="col-course-info"><?php esc_html_e('Course', 'edumall-child'); ?></th>
						<th class="col-total-lessons"><?php esc_html_e('Total Lessons', 'edumall-child'); ?></th>
						<th class="col-completed-lessons"><?php esc_html_e('Completed Lessons', 'edumall-child'); ?></th>
					</tr>
				</thead>
				...
				<?php foreach ($enrolled_courses as $post) : ?>
					...
					<tr>
						...
						<td class="td-total-lessons">
							<div class="heading col-heading-mobile"><?php esc_html_e('Total Lessons', 'edumall-child'); ?></div>
							<span><?php echo esc_html($total_lessons); ?></span>
						</td>
						<td class="td-completed-lessons">
							<div class="heading col-heading-mobile"><?php esc_html_e('Completed Lessons', 'edumall-child'); ?></div>
...
<?php else : ?>
	<div class="dashboard-no-content-found">
		<?php esc_html_e('This student have not get enroll any your courses yet.', 'edumall-child'); ?>
	</div>
<?php endif; ?>
...
<div class="tutor-dashboard-content-inner">
	...
	<div class="dashboard-content-box withdraw-page-current-balance">
		...
		<div class="current-withdraw-account-wrap withdrawal-preference inline-image-text">
			<span class="fa-regular fa-question-circle primary-color"></span>
			<span>
	            <?php
			...
			<div class="tutor-modal-content tutor-modal-content-white">
				...
				<div class="tutor-modal-body">
					<div class="tutor-py-20 tutor-px-24">
						...
						<div class="tutor-fs-4 tutor-fw-medium tutor-color-black tutor-mb-24"><?php esc_html_e( 'Withdrawal Request', 'edumall' ); ?></div>
						<div class="tutor-fs-6 tutor-color-muted"><?php esc_html_e( 'Please check your transaction notification on your connected withdrawal method', 'edumall' ); ?></div>

						<div class="tutor-row tutor-mt-32">
							<div class="tutor-col">
								<div class="tutor-fs-6 tutor-color-secondary tutor-mb-4"><?php esc_html_e( 'Withdrawable Balance', 'edumall' ); ?></div>
								<div class="tutor-fs-6 tutor-fw-bold tutor-color-black"><?php echo wp_kses_post( $available_for_withdraw_formatted ); ?></div>
							</div>

							<div class="tutor-col">
								<div class="tutor-fs-6 tutor-color-secondary tutor-mb-4"><?php esc_html_e( 'Selected Payment Method', 'edumall' ); ?></div>
					...
					<form id="tutor-earning-withdraw-form" method="post">
						<div class="tutor-py-20 tutor-px-24">
							...
							<label class="tutor-form-label" for="tutor_withdraw_amount"><?php esc_html_e( 'Amount', 'edumall' ); ?></label>
							...
							<div class="tutor-form-help tutor-d-flex tutor-align-center">
								...
								<span><?php echo __( 'Minimum withdraw amount is', 'edumall' ) . ' ' . strip_tags( $formatted_min_withdraw_amount ); ?></span>
							</div>
						...
						<div class="tutor-d-flex tutor-mt-48">
							...
							<div class="tutor-ml-auto">
								<button type="submit" name="withdraw-form-submit" id="tutor-earning-withdraw-btn" class="tutor-btn tutor-btn-primary tutor-modal-btn-edit tutor-ml-16">
									<?php esc_html_e( 'Submit Request', 'edumall' ); ?>
								</button>
							</div>
						</div>
					</form>
								...
								<?php if ( $withdraw_history->status !== 'approved' && isset( $status_message[ $withdraw_history->status ] ) ) : ?>
									<span class="hint--left hint--bounce hint--primary"
									      aria-label="<?php echo esc_attr( $status_message[ $withdraw_history->status ] ); ?>">
                                            <i class="fa-regular fa-question-circle primary-color"></i>
                                        </span>
								<?php endif; ?>
							</td>
						</tr>

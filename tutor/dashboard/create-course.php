...
<form action="" id="tutor-frontend-course-builder" class="tutor-frontend-course-builder" method="post" enctype="multipart/form-data">
					...
					<div class="header-left">
						...
						<?php if ('draft' === $post->post_status || 'auto-draft' === $post->post_status) : ?>
							...
							Edumall_Templates::render_button([
								...
								'text'        => esc_html__('Save', 'edumall-child'),
								'icon'        => 'fal fa-save',
								'style'       => 'thick-border',
							...
							<div id="header-right-inner" class="header-right-inner">
								<div class="header-right-inner-content">
									<?php Edumall_Templates::render_button([
										...
										'text'        => esc_html__('Preview', 'edumall-child'),
										'icon'        => 'fal fa-glasses',
									...
									<div class="form-submit">
										<?php if ($can_publish_course) : ?>
											<button class="tutor-button" type="submit" name="course_submit_btn" value="publish_course"><?php esc_html_e('Publish Course', 'edumall-child'); ?></button>
										<?php else : ?>
											<button class="tutor-button" type="submit" name="course_submit_btn" value="submit_for_review"><?php esc_html_e('Submit for Review', 'edumall-child'); ?></button>
										<?php endif; ?>
									</div>

									<div class="return-dashboard-link">
										<a href="<?php echo tutor_utils()->tutor_dashboard_url(); ?>"> <?php esc_html_e('Exit', 'edumall-child'); ?></a>
									</div>
								</div>
							</div>
						...
						<?php if (current_user_can('tutor_instructor') && !current_user_can('administrator')) : ?>
							<?php if (isset($_COOKIE['course_submit_for_review']) && !$instructor_can_publish) : ?>
								<div class="tutor-alert tutor-alert-info">
									<?php esc_html_e('Your course has been submitted to the admin. It will be published once it has been reviewed by the admins.', 'edumall-child'); ?>
								</div>
							<?php endif; ?>
						<?php endif; ?>
						<!--alert message end -->
						...
						<div class="tutor-course-builder-section tutor-course-builder-info">
							<div class="tutor-course-builder-section-title">
								<span class="tutor-fs-5 tutor-fw-bold tutor-color-secondary">
									...
									<span><?php esc_html_e('Course Info', 'edumall-child'); ?></span>
								</span>
							</div>
							...
							<div class="tutor-course-builder-section-content">
								<div class="tutor-frontend-builder-item-scope">
									<div class="tutor-form-group">
										<label><?php esc_html_e('Course Title', 'edumall-child'); ?></label>
										<input type="text" name="title" value="<?php echo esc_attr(get_the_title()); ?>" placeholder="<?php esc_attr_e('ex. Learn photoshop CS6 from scratch', 'edumall-child'); ?>">
									</div>
								</div> <!--.tutor-frontend-builder-item-scope-->

								<div class="tutor-frontend-builder-item-scope">
									<div class="tutor-form-group">
										<label><?php esc_html_e('Course Slug', 'edumall-child'); ?></label>
										<div id="tutor-course-create-slug-tooltip-wrapper" class="tooltip-wrap tutor-d-block">
											<span class="tooltip-txt tooltip-right tutor-mt-12">
												<?php esc_html_e('255', 'edumall-child'); ?>
											</span>
											<input id="tutor-course-slug" type="text" name="post_name" class="tutor-form-control" placeholder="<?php esc_attr_e('Please enter the course page slug here', 'edumall-child'); ?>" value="<?php echo esc_html($course_slug); ?>" maxlength="255">
											<div class="tutor-fs-7 tutor-has-icon tutor-color-muted tutor-mt-12">
												<?php esc_html_e('Permalink: ', 'edumall-child'); ?>
								...
								<div class="tutor-frontend-builder-item-scope">
									<div class="tutor-form-group">
										<label> <?php esc_html_e('Description', 'edumall-child'); ?></label>
										<?php
								...
								<div class="tutor-frontend-builder-item-scope">
									<div class="tutor-form-group">
										<label>
											<?php esc_html_e('Choose a category', 'edumall-child'); ?>
										</label>
											...
											<div class="tutor-d-flex tutor-mt-20 tutor-course-price-toggle">
												<div class="tutor-form-check tutor-align-center">
													...
													<label for="tutor_input_price_free" class="tutor-fs-6">
														<?php esc_html_e('Free', 'edumall-child'); ?>
													</label>
												</div>
												<div class="tutor-form-check tutor-align-center">
													...
													<label for="tutor_input_price_paid" class="tutor-fs-6">
														<?php esc_html_e('Paid', 'edumall-child'); ?>
													</label>
												</div>
											</div>
										</div>
								...
								<div class="tutor-frontend-builder-item-scope">
									<div class="tutor-form-group">
										<label>
											<?php esc_html_e('Course Thumbnail', 'edumall-child'); ?>
										</label>
							...
							<div class="tutor-form-col-12">
								<div class="tutor-form-group">
									<div class="tutor-form-field tutor-course-builder-btn-group">
										<button type="submit" class="tutor-button btn-save-as-draft" name="course_submit_btn" value="save_course_as_draft"><?php esc_html_e('Save course as draft', 'edumall-child'); ?></button>
										<?php if ($can_publish_course) : ?>
											<button class="tutor-button tutor-success" type="submit" name="course_submit_btn" value="publish_course"><?php esc_html_e('Publish Course', 'edumall-child'); ?></button>
										<?php else : ?>
											<button class="tutor-button tutor-success" type="submit" name="course_submit_btn" value="submit_for_review"><?php esc_html_e('Submit for Review', 'edumall-child'); ?></button>
										<?php endif; ?>
									</div>
								</div>
							</div>
				...
				<div class="col-lg-4">
					<div class="tutor-course-builder-upload-tips tm-sticky-column">
						<h3 class="tutor-course-builder-tips-title">
							<i class="far fa-lightbulb-on"></i><?php esc_html_e('Course Upload Tips', 'edumall-child'); ?>
						</h3>
						<ul>
							<li><?php esc_html_e('Set the Course Price option or make it free.', 'edumall-child'); ?></li>
							<li><?php esc_html_e('Standard size for course thumbnail is 700x430.', 'edumall-child'); ?></li>
							<li><?php esc_html_e('Video section controls the course overview video.', 'edumall-child'); ?></li>
							<li><?php esc_html_e('Course Builder is where you create & organize a course.', 'edumall-child'); ?></li>
							<li><?php esc_html_e('Add Topics in the Course Builder section to create lessons, quizzes, and assignments.', 'edumall-child'); ?></li>
							<li><?php esc_html_e('Prerequisites refers to the fundamental courses to complete before taking this particular course.', 'edumall-child'); ?></li>
							<li><?php esc_html_e('Information from the Additional Data section shows up on the course single page.', 'edumall-child'); ?></li>
							<li><?php esc_html_e('Make Announcements to notify any important notes to all enrolled students at once.', 'edumall-child'); ?></li>
						</ul>
					</div>
				</div>
			</div>

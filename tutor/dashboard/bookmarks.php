...
<div class="bookmarks">
    ...
    <div class="bookmarks-wrap">
        <div class="bookmarks-links">
            <ul>
                <li>
                    <a class="active" href="<?php echo tutor_utils()->get_tutor_dashboard_page_permalink('bookmarks'); ?>">
                        <?php esc_html_e('دوره', 'edumall-child'); ?>
                    </a>
                </li>
                <li>
                    <a href="<?php echo tutor_utils()->get_tutor_dashboard_page_permalink('bookmarks/instructors'); ?>">

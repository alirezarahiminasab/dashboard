...
?>
<h3><?php esc_html_e('Assignments', 'edumall-child'); ?></h3>
	...
	<div class="table-assignments dashboard-table-wrapper dashboard-table-responsive">
		<div class="dashboard-table-container">
			<table class="dashboard-table">
				<thead>
					<tr>
						<th class="col-course-info"><?php esc_html_e('Course Name', 'edumall-child') ?></th>
						<th class="col-total-mark"><?php esc_html_e('Total Mark', 'edumall-child') ?></th>
						<th class="col-total-submit"><?php esc_html_e('Total Submit', 'edumall-child') ?></th>
						...
						<tr>
							<td>
								...
								<h5 class="course-title">
									<a href='<?php echo esc_url($course_url . '?course_id=' . $course_id) ?>'><?php echo esc_html__('Course: ', 'edumall-child') . get_the_title($course_id); ?> </a>
								</h5>
							</td>
							<td>
							...
							<td>
								<div class="heading col-heading-mobile"><?php esc_html_e('Total Submit:', 'edumall-child'); ?></div>
							...
							<td>
								...
								?>
								<a class="<?php echo esc_attr($view_detail_btn_class); ?>" aria-label="<?php esc_attr_e('View Details', 'edumall-child'); ?>" href="<?php echo esc_url($submitted_url . '?assignment=' . $item->ID); ?>">
...
<?php else : ?>
	<div class="dashboard-no-content-found">
		<?php esc_html_e('No assignment available.', 'edumall-child'); ?>
	</div>
<?php endif;

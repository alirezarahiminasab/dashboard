...
<form method="post" id="custom_tutor_update_review_form">
	<div class="tutor-write-review-box tutor-star-rating-container">
		...
		<div class="tutor-form-group">
			<textarea name="review" placeholder="<?php esc_attr_e('Write a review', 'edumall-child'); ?>"><?php echo stripslashes($rating->review); ?></textarea>
		</div>
		<div class="tutor-form-group">
			<button type="submit" class="tutor-button tutor-success"><?php esc_html_e('Update Review', 'edumall-child'); ?></button>
		</div>
	</div>
</form>
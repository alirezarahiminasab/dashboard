...
<div class="tutor-dashboard-content-inner">
	...
	<?php if ($reviews->count) : ?>
		<div class="tutor-dashboard-reviews-wrap">
			<p class="tutor-dashboard-pagination-results-stats">
				<?php
				echo sprintf(esc_html__('Showing results %d to %d out of %d', 'edumall-child'), $offset + 1, min($reviews->count, $offset + 1 + tutor_utils()->count($reviews->results)), $reviews->count);
				?>
			</p>
						...
						<div class="tutor-dashboard-review-header">
							<div class="review-avatar">
								<a href="<?php echo esc_url($profile_url); ?>">
									<?php echo edumall_get_avatar($review->user_id, 70); ?>
								</a>
							</div>
							<div class="tutor-review-user-info">
								...
								<p class="review-date">
									<?php echo sprintf(esc_html__('%s ago', 'edumall-child'), human_time_diff(strtotime($review->comment_date))); ?>
								</p>
							</div>
						</div>
	...
	<?php else : ?>
		<div class="dashboard-no-content-found">
			<?php esc_html_e('You haven\'t received any reviews yet.', 'edumall-child'); ?>
		</div>
	<?php endif; ?>
</div>

	...
	<div class="dashboard-table-wrapper dashboard-table-responsive table-assignments">
		<div class="dashboard-table-container">
			<table class="dashboard-table">
				<thead>
					<tr>
						<th class="col-course-info"><?php esc_html_e('Assignment', 'edumall-child'); ?></th>
				...
				<tbody>
					<?php foreach ($assignments->results as $item) : ?>
						...
						<tr>
							<td>
								<div class="heading col-heading-mobile"><?php esc_html_e('Assignment:', 'edumall-child'); ?></div>
							...
							<td>
								<a class="hint--bounce hint--top-left review-assignment-link" aria-label="<?php esc_attr_e('View submitted', 'edumall-child'); ?>" href="<?php echo esc_url($submitted_url . '?assignment=' . $item->ID); ?>">

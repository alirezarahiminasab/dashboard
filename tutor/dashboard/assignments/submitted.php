...
?>
<h3><?php esc_html_e('Assignment Submitted', 'edumall-child'); ?></h3>
	...
	<div class="dashboard-table-wrapper dashboard-table-responsive table-assignments">
		<div class="dashboard-table-container">
			<table class="dashboard-table">
				<thead>
					<tr>
						<th><?php esc_html_e('Student', 'edumall-child'); ?></th>
						<th><?php esc_html_e('Date & Time', 'edumall-child'); ?></th>
						<th class="col-pass-mark"><?php esc_html_e('Pass Mark', 'edumall-child'); ?></th>
						<th class="col-total-mark"><?php esc_html_e('Total Mark', 'edumall-child'); ?></th>
				...
				<tbody>
					<?php foreach ($assignments_submitted as $assignment) : ?>
						...
						<tr>
							...
							<td>
								<div class="heading col-heading-mobile"><?php esc_html_e('Date & Time:', 'edumall-child'); ?></div>
							...
							<td>
								<div class="heading col-heading-mobile"><?php esc_html_e('Total Mark:', 'edumall-child'); ?></div>
							...
							<td>
								...
								<span class="assignment-status <?php echo esc_attr('assignment-status-' . $status); ?>">
									...
									switch ($status) {
										case 'pass':
											esc_html_e('Pass', 'edumall-child');
											break;
										case 'fail':
											esc_html_e('Fail', 'edumall-child');
											break;
										case 'pending':
											esc_html_e('Pending', 'edumall-child');
											break;
									}
									?>
								</span>
							...
							<td>
								<a class="hint--bounce hint--top-left review-assignment-link" aria-label="<?php esc_attr_e('Review this assignment', 'edumall-child'); ?>" href="<?php echo esc_url($review_url . '?view_assignment=' . $assignment->comment_ID); ?>">
...
<?php else : ?>
	<div class="dashboard-no-content-found">
		<?php esc_html_e('No assignment has been submitted yet.', 'edumall-child'); ?>
	</div>
<?php endif;

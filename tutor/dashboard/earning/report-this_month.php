...
if (!$earning_sum) {
	echo '<div class="dashboard-no-content-found">' . esc_html__('No Earning info available.', 'edumall-child') . '</div>';
		...
		<div class="dashboard-info-card-box">
			<div class="dashboard-info-card-content">
				<span class="dashboard-info-card-heading">
					<?php esc_html_e('My Earning', 'edumall-child'); ?>
				</span>
...
<div class="dashboard-earning-chart">
	<h4 class="chart-title"><?php echo esc_html(sprintf(__('Earning Data for the month of %s', 'edumall-child'), wp_date('F, Y', strtotime($start_date)))); ?></h4>
	<?php tutor_load_template('dashboard.earning.chart-body', compact('chartData', 'statements')); ?>
</div>

<div class="dashboard-earning-chart">
	<h4 class="chart-title"><?php esc_html_e('Sales statements for this period', 'edumall-child'); ?></h4>

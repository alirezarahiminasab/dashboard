...
<div class="tutor-date-range-filter-wrap">
	<?php
	$time_periods = array(
		'last_year'  => esc_html__('Last Year', 'edumall-child'),
		'this_year'  => esc_html__('This Year', 'edumall-child'),
		'last_month' => esc_html__('Last Month', 'edumall-child'),
		'this_month' => esc_html__('This Month', 'edumall-child'),
		'last_week'  => esc_html__('Last Week', 'edumall-child'),
		'this_week'  => esc_html__('This Week', 'edumall-child'),
	);
	?>
	...
	<div class="tutor-date-range-wrap">
		<form action="" class="report-date-range-form" method="get">
			...
			<div class="date-range-input">
				<input type="text" name="date_range_from" class="tutor_report_datepicker" value="<?php echo esc_attr($date_range_from); ?>" autocomplete="off" placeholder="<?php echo date('Y-m-d', strtotime('last sunday midnight')); ?>" />
				<i class="fal fa-calendar"></i>
			</div>

			<div class="date-range-input">
				<input type="text" name="date_range_to" class="tutor_report_datepicker" value="<?php echo esc_attr($date_range_to); ?>" autocomplete="off" placeholder="<?php echo date('Y-m-d'); ?>" />
				<i class="fal fa-calendar"></i>
			</div>

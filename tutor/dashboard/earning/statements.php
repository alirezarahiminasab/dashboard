...
<?php if ($statements->count) : ?>
	<div class="dashboard-earning-chart">
		<p class="tutor-dashboard-pagination-results-stats">
			<?php
			echo sprintf(__('Showing results %d to %d of %d', 'edumall-child'), $offset + 1, min($statements->count, $offset + 1 + tutor_utils()->count($statements->results)), $statements->count);
			?>
		</p>
		...
		<div class="dashboard-earning-statement-table dashboard-table-wrapper dashboard-table-responsive">
			<div class="dashboard-table-container">
				<table class="dashboard-table">
					<thead>
						<tr>
							<th><?php esc_html_e('Course Info', 'edumall-child'); ?></th>
							<th><?php esc_html_e('Earning', 'edumall-child'); ?></th>
							<th><?php esc_html_e('Commission', 'edumall-child'); ?></th>
					...
					<tbody>
						<?php foreach ($statements->results as $statement) : ?>
							<tr>
								<td>
									<div class="heading col-heading-mobile"><?php esc_html_e('Course Info:', 'edumall-child'); ?></div>
									<p class="small-text">
										<span class="statement-order-<?php echo esc_attr($statement->order_status); ?>"><?php echo esc_html($statement->order_status); ?></span>
									...
									<p>
										<strong><?php esc_html_e('Price: ', 'edumall-child'); ?></strong>
										<?php echo tutor_utils()->tutor_price($statement->course_price_total); ?>
									</p>

									<p class="small-text">
										<strong><?php esc_html_e('Order ID', 'edumall-child'); ?>
								...
								<td>
									<div class="heading col-heading-mobile"><?php esc_html_e('Commission:', 'edumall-child'); ?></div>

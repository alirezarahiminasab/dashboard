...
$user_story    = get_user_meta($user_id, '_instructor_story_text', true);
?>

<main class="become-instructor active" data-user="<?php echo $user_id ?>">
        ...
        <form action="" method="post" enctype="multipart/form-data" class="become-instructor-form">
            ...
            <div class="become-instructor-form-group instructor-username">
                ...
                <div class="instructor-username-input">
                    <input type="text" id="instructor_profile_username" name="username" placeholder="مانند:" value="<?php echo $username ?>" required>
            ...
            <div class="become-instructor-form-group instructor-profession">
                ...
                <input type="text" id="instructor_profile_profession" name="profession" value="<?php echo esc_attr(get_user_meta($user_id, '_instructor_profession', true)); ?>" placeholder="مانند: دکتری روانشناسی بالینی" required>
            </div>
            ...
            <div class="become-instructor-form-group instructor-story-text">
                ...
                <textarea cols="50" rows="7" name="story" id="instructor_story_text" value="<?php echo esc_attr(get_user_meta($user_id, '_instructor_story_text', true)); ?>" placeholder="روایت خود را اینجا بنوسید...." required><?php echo $user_story ?></textarea>
            ...
            <div class="become-instructor-form-group instructor-submit-wrap">
                <button type="submit" name="instructor_register_student_btn" value="register" class="instructor-button instructor-profile-settings-save"><?php esc_html_e('شروع تدریس', 'edumall-child'); ?></button>
            </div>

...
?>
<h3><?php esc_html_e('My Profile', 'edumall-child'); ?></h3>

<div class="tutor-dashboard-content-inner">
	<div class="dashboard-profile-info">
		<div class="dashboard-profile-info-item profile-registration-date">
			<div class="heading">
				<?php esc_html_e('Registration Date', 'edumall-child'); ?>
			</div>
			<div class="content">
		...
		<div class="dashboard-profile-info-item profile-first-name">
			<div class="heading">
				<?php esc_html_e('First Name', 'edumall-child'); ?>
			</div>
			<div class="content">
		...
		<div class="dashboard-profile-info-item profile-last-name">
			<div class="heading">
				<?php esc_html_e('Last Name', 'edumall-child'); ?>
			</div>
			<div class="content">
		...
		<div class="dashboard-profile-info-item profile-email">
			<div class="heading">
				<?php esc_html_e('Email', 'edumall-child'); ?>
			</div>
			<div class="content">
		...
		<div class="dashboard-profile-info-item profile-job-title">
			<div class="heading">
				<?php esc_html_e('Job Title', 'edumall-child'); ?>
			</div>
			<div class="content">
		...
		<div class="dashboard-profile-info-item profile-bio">
			<div class="heading">
				<?php esc_html_e('Bio', 'edumall-child'); ?>
			</div>
			<div class="content">

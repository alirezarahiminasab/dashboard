...
?>
    <div class="course-archive-wrap">
        <div class="course-archive-wrap-header">
            <div class="course-archive-wrap-header-sort">
                <div class="course-archive-wrap-header-sort-links">
                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/sort.png' ?>" alt="">
                    <p><?php esc_html_e('مرتب سازی بر اساس', 'edumall-child'); ?></p>
                </div>

                <div class="course-archive-wrap-header-sort-items">
                    <span>
                        <a href=""></a>
                    </span>
                    <span> </span>
            ...
            <div class="course-archive-wrap-header-search">
        ...
        <?php
            ...
            if ((($courses_query->current_post + 1) === 3 || ($courses_query->post_count) < 3) && $detect->isMobile()) :

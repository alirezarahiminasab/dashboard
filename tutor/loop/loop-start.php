...
if ( in_array( $style, [ 'list', 'list-02' ] ) ) {
	...
	$lg_columns = intval( Edumall::setting( 'course_archive_lg_columns', 4 ) );
	$md_columns = Edumall::setting( 'course_archive_md_columns', 2 );
	$sm_columns = Edumall::setting( 'course_archive_sm_columns', 1 );

...
<div class="course-no-result-title">
	<h3 class="primary-heading"><?php esc_html_e('Sorry, we can not find any courses for this search.', 'edumall-child'); ?></h3>
	<h4 class="secondary-heading"><?php esc_html_e('You may want to check Our Hot Courses:', 'edumall-child'); ?></h4>
</div>

						...
						<div class="tutor-single-page-top-bar">
							<div class="tutor-topbar-item tutor-top-bar-course-link">
								...
								<a href="<?php echo esc_url(get_the_permalink($course_id)); ?>" class="tutor-topbar-home-btn">
									<i class="far fa-home"></i><?php esc_html_e('Go to course home', 'edumall-child'); ?>
								</a>
							</div>
						...
						<div class="tutor-zoom-meeting-content">
							...
							<?php else : ?>
								<?php if ($zoom_meeting->is_expired) : ?>
									<div class="tutor-zoom-meeting-expired-msg-wrap">
										...
										<div class="meeting-details-section">
											...
											<div>
												<div>
													<span><?php esc_html_e('Meeting Date', 'edumall-child'); ?>:</span>
													<p><?php echo $zoom_meeting->start_date; ?></p>
												</div>
												<?php if (!empty($meeting_data['host_email'])) : ?>
													<div>
														<span><?php esc_html_e('Host Email', 'edumall-child'); ?>
															:</span>
								...
								<?php else : ?>
									...
									$browser_text = __('Join in Browser', 'edumall-child');

									if (get_current_user_id() == $post->post_author) {
										$browser_url  = $meeting_data['start_url'];
										$browser_text = __('Start Meeting', 'edumall-child');
									}
									?>
									<div class="zoom-meeting-countdown-wrap">
										...
										<div class="tutor-zoom-join-button-wrap">
											<a href="<?php echo esc_url($browser_url); ?>" target="_blank" class="tutor-btn tutor-button-block zoom-meeting-join-in-web"><?php echo esc_html($browser_text); ?></a>
											<a href="<?php echo esc_url($meeting_data['join_url']); ?>" target="_blank" class="tutor-btn tutor-button-block zoom-meeting-join-in-app"><?php esc_html_e('Join in Zoom App', 'edumall-child'); ?></a>
										</div>
									</div>
									<div class="zoom-meeting-content-wrap">
										...
										<div class="meeting-details">
											...
											<div>
												<span><?php esc_html_e('Meeting ID', 'edumall-child'); ?></span>
												<p><?php echo $meeting_data['id']; ?></p>
											</div>
											<div>
												<span><?php esc_html_e('Password', 'edumall-child'); ?></span>
												<p><?php echo $meeting_data['password']; ?></p>
											</div>
											<div>
												<span><?php esc_html_e('Host Email', 'edumall-child'); ?></span>

...
<form method="post" class="tutor-ResetPassword lost_reset_password">
	...
	<input type="hidden" name="reset_key" value="<?php echo esc_attr( Input::get( 'reset_key' ) ); ?>"/>
	<input type="hidden" name="user_id" value="<?php echo esc_attr( Input::get( 'user_id' ) ); ?>"/>

	<div class="form-row">
		<label for="password"><?php esc_html_e( 'Password', 'edumall' ); ?></label>
		<input type="password" name="password" id="password">
	</div>
	<div class="form-row">
		<label for="confirm_password"><?php esc_html_e( 'Confirm Password', 'edumall' ); ?></label>
	...
	<div class="form-row">
		<button type="submit" class="tutor-button tutor-button-primary"
		        value="<?php esc_attr_e( 'Reset password', 'edumall' ); ?>"><?php esc_html_e( 'Reset password', 'edumall' ); ?></button>
	</div>
</form>

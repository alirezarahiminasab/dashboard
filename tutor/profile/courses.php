...
<div class="instructor-profile-courses">
    <div class="instructor-profile-courses-container">
        ...
        <div class="instructor-profile-courses-wrap">
            <div class="instructor-profile-courses-container-wrap <?php echo !$detect->isMobile() ? 'swiper-container' : '' ?>">
                <?php if (!$detect->isMobile()) : ?>
                    ...
                    ?>
                            <div class="course-wrap <?php echo !$detect->isMobile() ? 'swiper-slide' : '' ?>">
            ...
            <?php if ($fc_query->found_posts > 4 && !$detect->isMobile()) : ?>
                <!-- If we need navigation buttons -->
                <div class="instructor-profile-courses-button slider-button-prev">
                    <img class="icon" src="<?php echo get_stylesheet_directory_uri() . '/assets/images/arrow-square-left.png' ?>" alt="">
                </div>
                <div class="instructor-profile-courses-button slider-button-next">

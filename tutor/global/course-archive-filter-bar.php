		...
		<div class="inner">
			...
			<?php if ('1' === Edumall::setting('course_archive_sorting')) : ?>
				<div class="archive-orderby-select">
					...
					?>
					<select class="edumall-nice-select" name="orderby" id="course-sorting-select" data-select="<?php echo esc_attr(wp_json_encode($select_settings)); ?>">
						<?php foreach ($sorting_options as $option_key => $option_name) : ?>
							...
							?>
							<option value="<?php echo esc_attr($option_key); ?>" <?php selected($sort_selected, $option_key); ?> data-url="<?php echo esc_url($link) ?>">

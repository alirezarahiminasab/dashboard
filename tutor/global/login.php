...
$args = array(
	...
	'redirect'                 => home_url(),
	'form_id'                  => 'loginform',
	'label_username'           => __('Username or Email Address', 'edumall-child'),
	'label_password'           => __('Password', 'edumall-child'),
	'label_remember'           => __('Remember me', 'edumall-child'),
	'label_log_in'             => __('Log in', 'edumall-child'),
	'label_create_new_account' => __('Create a new account', 'edumall-child'),
	...
	'wp_lostpassword_label'    => __('Lost your password?', 'edumall-child'),
);
	...
	<div class="form-row login-remember-wrap">
		<div class="row-flex row-middle">
			...
			<div class="col-shrink">
				<a href="<?php echo esc_url($args['wp_lostpassword_url']); ?>" class="link-transition-02 lost-password-link"><?php echo esc_html($args['wp_lostpassword_label']); ?></a>
			</div>
		</div>
	</div>
	<div class="form-row login-submit">
		<input type="submit" name="wp-submit" id="<?php echo esc_attr($args['id_submit']); ?>" class="button button-primary form-submit" value="<?php echo esc_attr($args['label_log_in']); ?>" />
		<input type="hidden" name="redirect_to" value="<?php echo esc_url($args['redirect']); ?>" />
	</div>
	<a href="<?php echo esc_url($register_url); ?>" class="open-popup-register link-transition-01"><?php echo esc_html($args['label_create_new_account']); ?></a>
</form>
...
if ( $rating_count > 0 ) : ?>
	<div class="woocommerce-product-rating">
		<div class="review-rating-average heading-color">
			<span class="rating-average"><?php echo esc_html( Edumall_Helper::number_format_nice_float( $average ) ); ?></span>
			<span class="rating-total">/5</span>
		</div>
		<?php Edumall_Templates::render_rating( $average, [
			'wrapper_class' => 'entry-product-star-rating',
		] ); ?>

		<?php
		$_rating_text = _n( '%s review', '%s reviews', $review_count, 'edumall' );

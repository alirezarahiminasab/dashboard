					...
					<?php if ( have_posts() ) : ?>
						...
						<?php if ( ! is_shop() || $shop_page_display !== 'subcategories' ) : ?>
							<?php if ( wc_get_loop_prop( 'total' ) ) { ?>
								...
								<?php
								$layout = Edumall_Shop_Layout_Switcher::instance()->get_layout();
								...
								if ( 'list' === $layout ) {
									...
									$grid_class = 'edumall-grid grid-sm-1';
									...
									$grid_class = 'edumall-grid';
									$lg_columns = intval( Edumall::setting( 'shop_archive_lg_columns' ) );
									$md_columns = Edumall::setting( 'shop_archive_md_columns' );
									$sm_columns = Edumall::setting( 'shop_archive_sm_columns' );
								...
								>
									<div class="<?php echo esc_attr( $grid_class ); ?>">
										...
										while ( have_posts() ) {
											...
											wc_get_template_part( 'content-product', $layout );
										}
										?>
									</div>
								</div>

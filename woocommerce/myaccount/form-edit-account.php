...
<form class="woocommerce-EditAccountForm edit-account" action=""
	...
	<div class="row form-row ">
		<div class="col-md-6">
			<label for="account_first_name"><?php esc_html_e( 'First name', 'edumall' ); ?>&nbsp;<span
		...
		<div class="col-md-6">
			<label for="account_last_name"><?php esc_html_e( 'Last name', 'edumall' ); ?>&nbsp;<span
					class="required">*</span></label>
	...
	<div class="row form-row">
		<div class="col-md-6">
			<label for="account_display_name"><?php esc_html_e( 'Display name', 'edumall' ); ?>&nbsp;<span
					class="required">*</span></label>
		...
		<div class="col-md-6">
			<label for="account_email"><?php esc_html_e( 'Email address', 'edumall' ); ?>&nbsp;<span
					class="required">*</span></label>
	...
	<fieldset>
		...
		<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
			<label
				for="password_current"><?php esc_html_e( 'Current password', 'edumall' ); ?></label>
			...
			<span><em><?php esc_html_e( 'Leave blank to leave unchanged.', 'edumall' ); ?></em></span>
		</p>
		<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
			<label
				for="password_1"><?php esc_html_e( 'New password', 'edumall' ); ?></label>

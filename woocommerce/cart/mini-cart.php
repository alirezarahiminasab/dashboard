...
<?php if ( ! WC()->cart->is_empty() ) : ?>
	...
	<div class="cart-footer">
		<div class="woocommerce-mini-cart__total total">
			<strong><?php esc_html_e( 'Total', 'edumall' ); ?>:</strong> <?php echo WC()->cart->get_cart_subtotal(); ?>
		</div>
...
<?php else : ?>
	...
	<div class="woocommerce-mini-cart__empty-message">
		<div class="empty-basket">
			<span class="fa-light fa-dolly-flatbed-empty"></span>
		</div>

		<p class="empty-message"><?php esc_html_e( 'Your cart is empty', 'edumall' ); ?></p>
			...
			<p class="return-to-shop">
				<a class="button wc-backward"
				   href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>">
					<?php esc_html_e( 'Browse Shop', 'edumall' ); ?>
				</a>
			</p>
		<?php endif; ?>
	</div>

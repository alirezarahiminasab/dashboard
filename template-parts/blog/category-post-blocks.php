		...
		<div class="container">
			<div class="row">
				<div class="section-col-heading">
					<h3 class="archive-section-heading"><?php printf(esc_html__('%s Articles', 'edumall-child'), $category->name); ?></h3>
					...
					Edumall_Templates::render_button([
						...
						'text'          => esc_html__('View all', 'edumall-child'),
				...
				<div class="section-col-content">
					<div class="home-blog-section-content">
						<div class="tm-swiper tm-slider v-stretch bullets-v-align-below nav-style-01 pagination-style-01 edumall-blog edumall-animation-zoom-in edumall-blog-carousel-01" data-lg-items="auto" data-lg-gutter="0" data-nav="1" data-pagination="1" data-loop="1">

...
<?php if ('none' === $sidebar_status) : ?>
	<div class="entry-header <?php echo '1' === Edumall::setting('single_post_feature_enable') ? 'featured-on' : 'featured-off'; ?>">
...
<article id="post-<?php the_ID(); ?>" <?php post_class('entry-wrapper'); ?>>
	...
	<div class="entry-content">
		...
		the_content(sprintf( /* translators: %s: Name of current post. */
			wp_kses(__('Continue reading %s <span class="meta-nav">&rarr;</span>', 'edumall-child'), array('span' => array('class' => array()))),

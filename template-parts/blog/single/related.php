...
if ($results !== false && $results->have_posts()) : ?>
	<div class="related-posts edumall-blog edumall-animation-zoom-in edumall-blog-caption-style-02">
		<h3 class="related-title">
			<?php esc_html_e('Related Posts', 'edumall-child'); ?>
		</h3>
		<div class="tm-swiper tm-slider v-stretch bullets-v-align-below nav-style-01 pagination-style-01" data-lg-items="auto" data-lg-gutter="30" data-nav="1" data-auto-height="1">

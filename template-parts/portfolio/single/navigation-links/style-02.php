<?php
$args = array(
	'prev_text' => esc_html__('Prev Project', 'edumall-child'),
	'next_text' => esc_html__('Next Project', 'edumall-child'),
);

$args = apply_filters('edumall_portfolio_navigation_links_args', $args);

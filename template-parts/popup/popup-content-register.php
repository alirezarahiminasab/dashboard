		...
		<div class="become-instructor-wrap">
			<form action="" method="post" enctype="multipart/form-data" class="become-instructor-form">
				...
				<div class="become-instructor-form-group instructor-story-text">
					...
					<textarea cols="50" rows="7" name="story" id="instructor_story_text" value="<?php echo esc_attr(get_user_meta($user->ID, '_instructor_story_text', true)); ?>" placeholder="روایت خود را اینجا بنوسید...." required><?php echo $instructor_story_text ?></textarea>

...
<div class="header-category-menu">
	<a href="#" class="header-icon category-menu-toggle">
		...
		<div class="category-toggle-text">
			<?php esc_html_e('Category', 'edumall-child'); ?>
		</div>
	</a>
					...
					<?php if (!empty($sub_categories)) : ?>
						<ul class="children sub-categories">
							<?php if ($show_all_links) : ?>
								<li class="cat-item">
									<a href="<?php echo esc_url(get_term_link($category)); ?>">
										<?php printf(esc_html__('All %s', 'edumall-child'), $category->name); ?>
									</a>
								</li>
							<?php endif; ?>
							...
							<?php foreach ($sub_categories as $sub_category) : ?>
								...
								<li data-id="<?php echo esc_attr($sub_category->term_id); ?>" class="<?php echo esc_attr($current_item_class); ?>">

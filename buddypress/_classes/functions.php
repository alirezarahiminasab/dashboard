 ...
 * @since 2.7.4
 */
function edumall_bp_group_request_user_avatar_full() {
	...
	echo apply_filters( 'bp_group_request_user_avatar_thumb', bp_core_fetch_avatar( array(
		...
		'type'    => 'full',
		'alt'     => sprintf( __( 'Profile picture of %s', 'edumall' ), bp_core_get_user_displayname( $requests_template->request->user_id ) ),
	) ) );
}

...
(function ($) {
  ...
  class CourseManagement {
    ...
    sortCourse = () => {
      ...
      this.elements.userDashboard.on(
        "click",
        ".sort-header-close,.instructor-courses-sort-bg",
        function (e) {
          e.preventDefault();
    ...
    update = () => {
      ...
      $(".instructor-dropdown-parent-icon").on("click", function (e) {
        e.preventDefault();
    ...
    sortCourse($el) {
      ...
      this.elements.userDashboard.on(
        "click",
        ".sort-header-close,.course-statistics-sort-bg",
        function (e) {
          e.preventDefault();
          const tl = gsap.timeline();
  ...
  const courseManagementInit = new CourseManagement();
})(jQuery);

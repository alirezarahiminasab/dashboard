...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    function handleBecomeInstructor() {
      ...
      $(".become-instructor-form")
        .find("#instructor_profile_username")
        .on("input", function (e) {
      ...
      // Handle upload file
      $(".become-instructor-form #instructor_story_video_file").on(
        "change",
        function (e) {
          handleFiles(
            e.target.files,
      ...
      $(".become-instructor-form")
        .find(".instructor-tags-input a")
        .on("click", function (e) {
          e.preventDefault();

          const inputValue = $(".become-instructor-form")
            .find(".instructor-tags-input input")
            .val();
      ...
      $(".become-instructor-form").on("submit", function (e) {
        ...
        const $username = $(
          ".become-instructor-form #instructor_profile_username",
        ).val();
        const $profession = $(
          ".become-instructor-form #instructor_profile_profession",
        ).val();
        const $user_story = $(
          ".become-instructor-form #instructor_story_text",
        ).val();
        const user_picture = $(".become-instructor-form .profile-picture").attr(
          "src",
        );
        const tags = $(
          ".become-instructor-form #instructor_profile_tags .instructor-tags-wrap-value p",
        );
        const tagsArr = [];
    ...
    function resetUploadBox() {
      ...
      $(".become-instructor-form #instructor_story_video_file").val("");
      updateProgressBar(0);
    }

    function getImgData(param) {
      ...
      try {
        reader.onload = function (e) {
          if (
            ...
            $(".become-instructor-form #instructor_profile_area").hide();
            $(".become-instructor-form .user-edit-buttons").css(
              "display",
              "flex",
            );
    ...
    function handleFiles(files, formatBytes, uploadFile, progressBar) {
    ...
    function uploadFile(file, updateProgressBar) {
      const user_id = $(".instructor-settings").data("user");
